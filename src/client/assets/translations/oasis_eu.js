...
module.exports = {
  eu: {
    ...
    searchCasesPlaceholder: "Bilatu hemen: Auzitegiak...",
    ...
    peersReplicatedFeeds: "Erreplikatuak",
    peersOasisId: "Oasis ID",
    peersOasisVersion: "Bertsioa",
    graphos: "Graphos",
    ...
    mentionsSearchPlaceholder: "Bilatu hemen: Aipamenak...",
    privateReminders: "OROIGARRIAK",
    inboxFilterPms: "MPak",
    inboxFilterNotifications: "Jakinarazpenak",
    inboxMarkRead: "Irakurritako gisa markatu",
    inboxMarkUnread: "Irakurri gabeko gisa markatu",
    inboxUnreadChip: "Irakurri gabe",
    inboxMarkAllRead: "Dena irakurritzat markatu",
    inboxDeleteShown: "Dena ezabatu",
    inboxArchive: "Artxibatu",
    inboxUnarchive: "Desartxibatu",
    inboxFilterArchived: "Artxibatuak",
    inboxEarlierMessages: "aurreko mezu",
    inboxSortThread: "Harien arabera",
    inboxSortRecent: "Berrienak lehenik",
    inboxAllBots: "Botak",
    settingsInboxBotsTitle: "Inbox jakinarazpenak",
    settingsInboxBotsDesc: "Aukeratu zein botek jakinaraz diezazuketen Inboxean. Markatu gabeko botak ezkutatu egiten dira eta haien abisuak ez dira zenbatzen.",
    ...
    settings: "Ezarpenak",
    settingsDescription: "Konfiguratu zure sarearen ingurunea.",
    ...
    inboxSearchPlaceholder: "Bilatu hemen: Sarrera-ontzia...",
    ...
    telegramPhoneLabel: "Telefono zenbakia",
    telegramSendCode: "Bidali kodea",
    telegramCodeHelp: "Sartu Telegramek bidali dizun kodea (aplikazioa edo SMS).",
    telegramCodeLabel: "Kodea",
    telegramPasswordHelp: "Kontu honek bi urratseko egiaztapena du. Sartu pasahitza.",
    telegramPasswordLabel: "Pasahitza",
    telegramVerify: "Egiaztatu",
    telegramCancel: "Utzi",
    telegramChats: "Txatak",
    telegramUnread: "Irakurri gabe",
    telegramOpen: "Ireki",
    telegramSend: "Bidali",
    telegramYou: "Zu",
    telegramNoChats: "Oraindik ez dago txatik.",
    telegramNoMessages: "Oraindik ez dago mezurik.",
    telegramComposePlaceholder: "Idatzi mezu bat…",
    telegramChannel: "Kanala",
    telegramGroup: "Taldea",
    telegramPrivate: "Pribatua",
    telegramErrConnect: "Ezin izan da Telegramekin konektatu.",
    telegramErrTimeout: "Telegramek gehiegi tardatu du erantzuten.",
    telegramErrAuth: "Telegram saioa baliogabea edo iraungita. Konektatu berriro.",
    telegramErrFetch: "Ezin izan dira txatak kargatu.",
    telegramErrSend: "Ezin izan da mezua bidali.",
    telegramErrMissing: "API ID, API hash eta telefono zenbakia behar dira.",
    telegramErrCode: "Kode okerra. Saiatu berriro.",
    telegramErrCodeExpired: "Kodea iraungi da. Hasi berriro.",
    telegramErrPassword: "Pasahitz okerra.",
    telegramErrPhone: "Telefono zenbaki baliogabea.",
    telegramErrApi: "API ID edo API hash baliogabea.",
    telegramErrFlood: "Saiakera gehiegi. Itxaron pixka bat eta saiatu berriro.",
    telegramErrNoLogin: "Ez dago saio-hasierarik abian. Hasi berriro.",
    ...
    dateInPastError: "Data ezin da gaur baino lehenagokoa izan",
    ...
    indexes: "Indizeak",
    indexesRebuilt: "Indizeak berreraiki dira",
    indexesRebuildFailed: "Ezin izan dira indizeak berreraiki",
    indexesFiles: "Indize fitxategiak",
    indexesDescription:
    ...
    profileClearnetPodcastsLabel: "Podcastak",
    profileClearnetMarketLabel: "Merkatua",
    profileClearnetFeedLabel: "Jarioa",
    profileClearnetWikiLabel: "Wikiak",
    ...
    walletDescription: "Kudeatu zure ECOin zorroa.",
    walletDate: "Data",
    ...
    walletSend: "Bidali",
    walletPayingTransfer: "Transferra ordaintzen",
    walletCreateTransferLabel: "Kontratua sortu (transferentzia)",
    walletTransferNotifiedNote: "Beste aldeari ordainketa honen berri eman zaio",
    walletTransferCreatedNote: "Ordainketa honen transfer bat (ordainagiria) sortu da",
    walletTransferNoPayeeNote: "Biztanle batek ere ez du helbide hau argitaratu, beraz ez da transferrik sortu",
    walletTransferReceiptConcept: "Zorrotik egindako ordainketa",
    walletPaymentPmText: "ordainketa bat bidali dizu",
    walletPayeeLabel: "Hartzailea",
    walletConceptLabel: "Kontzeptua",
    pmBotBanking: "BankingBot",
    bankingBotUbiPaidTitle: "Zure OBUa jaso duzu.",
    bankingBotPaymentTitle: "Ordainketa bat jaso duzu.",
    bankingBotUbiPaidText: "Zure Oinarrizko Errenta Unibertsala ordaindu da",
    bankUbiPubThisNode: "Nodo honek OBUa ordaintzen du",
    bankUbiPubConnected: "OBUko PUBa",
    bankUbiPubNone: "Oraindik ez dago OBUa iragartzen duen PUBik zure sarean",
    bankUbiAddressPublished: "ECOin helbidea argitaratuta",
    bankUbiAddressMissing: "Argitaratu zure ECOin helbidea OBUa jasotzeko",
    bankUbiClaimedThisMonth: "Hilabete honetan eskatuta",
    bankUbiPubBalance: "PUBaren zorroa OBUrako erabilgarri",
    bankNoPubAddress: "OBUko PUBak ez du oraindik ECOin helbiderik argitaratu.",
    bankUbiTab: "OBU",
    bankDonateEco: "EMAN!",
    donateTooltip: "Eman ECOin",
    bankNoUserAddress: "Biztanle honek ez du ECOin helbiderik partekatzen.",
    bankUbiPubDefault: "Lehenetsia",
    bankUbiPool: "Funtsa",
    bankUbiLastSeen: "Azkenekoz ikusia",
    bankUbiLastPayout: "Azken ekintza",
    bankUbiPaidOut: "Banatua",
    bankRangeToday: "Gaur",
    bankRangeWeek: "Astea",
    bankRangeMonth: "Hilabetea",
    bankRangeYear: "Urtea",
    bankRangeFiveYears: "5 urte",
    bankRangeAll: "Guztia",
    bankChartValueTitle: "ECOin balioaren bilakaera",
    bankChartValueHours: "Denbora baliokidetza (h)",
    bankChartWealthTitle: "ECOin aberastasunaren birbanaketa",
    bankChartDistributed: "Banatutako OBUa (ECO)",
    bankChartTaxes: "Atxikitako zergak (ECO)",
    bankChartNoDataRange: "Ez dago daturik tarte honetan.",
    bankChartNoDataYet: "Oraindik ez dago daturik",
    bankChartPerHour: "orduko",
    bankChartPerDay: "eguneko",
    bankChartPerMonth: "hileko",
    bankTotalUbiDistributed: "Birbanatutako OBU guztira (sarea)",
    bankTotalTaxesWithheld: "Atxikitako zerga guztira (sarea)",
    bankInflationIssuance: "Jaulkipen-tasa (urtekoa, bloke-sariaren arabera)",
    bankRulesEligibilityTitle: "Nork jaso dezake OBUa",
    bankRulesEligibility1: "Profilean argitaratutako ECOin helbide bat (Profila → Sentsoreak → ECOin zorroa).",
    bankRulesEligibility2: "30 egun baino gehiagoko feed bat sarean jarduerarekin: karma zerotik gora.",
    bankRulesEligibility3: "Eskaera bat hilean (epoch), Banking-etik OBUa eskatu botoiarekin. Uneko hilabetea uka daiteke OBUari uko egin botoiarekin.",
    bankRulesEligibility4: "1 ECO-ko oinarria beti ordaintzen da; zergek gainetik dagoen zatia bakarrik murrizten dute eta ez dira inoiz aparte kobratzen.",
    bankRulesEligibility5: "PUBak hurrengo zikloan ordaintzen du eta berretsi dezakezun OBU transferentzia bat argitaratzen du.",
    bankRulesEligibility6: "Helbidea falta bada, feeda gazteegia bada, hilabeteari uko egin badiozu edo PUBak fondorik ez badu, eskaera saltatu eta PUBean erregistratzen da.",
    copyLinkTitle: "Kopiatu esteka",
    linkBoxOasis: "Oasis",
    linkBoxClearnet: "Clearnet",
    bankRefuseUBI: "OBUari uko egin",
    bankUbiRefusedThisMonth: "Hilabete honetako OBUari uko egin diozu.",
    bankingBotUbiAvailableTitle: "Zure OBUa eska dezakezu.",
    bankingBotUbiAvailableText: "Hilabete honetako zure OBUa eskuragarri dago",
    bankingBotConfirmTitle: "Baieztatzeko zain dagoen smart-contract bat duzu",
    bankingBotConfirmText: "Zure berrespenaren zain dauden smart-contract-ak",
    bankChartZoomHint: "Klikatu handitzeko",
    bankChartPoolTitle: "OBUaren funtsa (denboran)",
    bankChartNetworkUbiTitle: "Birbanatutako OBU guztira (sarea)",
    bankChartSupplyTitle: "ECOin zirkulazioko eskaintza (denboran)",
    bankChartInflationTitle: "ECOin inflazioa (denboran)",
    bankChartInflationSeries: "Urteko tasa (%)",
    bankChartPool: "Funts osoa (ECO)",
    bankChartKarmaTitle: "KARMA Scoring (denboran)",
    bankChartFundsTitle: "Zure ECOin funtsak (denboran)",
    bankChartKarma: "Karma",
    bankWalletReady: "ECOin konektatuta",
    bankWalletNotConfigured: "ECOin deskonektatuta",
    transfersPayWithWallet: "ORDAINDU!",
    walletStatus: "Egoera",    
    walletDisconnected: [
      "ECOin ",
    ...
    walletDisconnectButton: "Wallet-a deskonektatu",
    cipher: "Zifratzailea",
    ...
    bookmarkTagsPlaceholder: "Idatzi etiketak komaz bereizita",
    bookmarkLastVisitLabel: "Azken bisita",
    bookmarkSearchPlaceholder: "Bilatu hemen: Laster-markak...",
    ...
    videoSearchPlaceholder: "Bilatu hemen: Bideoak...",
    ...
    documentTagsPlaceholder: "Idatzi etiketak komaz bereizita",
    ...
    documentSearchPlaceholder: "Bilatu hemen: Dokumentuak...",
    ...
    tagsPlaceholder: "Idatzi etiketak komaz bereizita",
    ...
    audioSearchPlaceholder: "Bilatu hemen: Audioak...",
    ...
    favoritesSearchPlaceholder: "Bilatu hemen: Gogokoak...",
    ...
    searchInhabitantsPlaceholder:  "Bilatu hemen: Bizilagunak...",
    ...
    parliamentSeatsGovernment: "Gobernua",
    parliamentSeatsOpposition: "Oposizioa",
    parliamentSeatsAbstention: "Abstentzioa",
    parliamentSeatsQuorum: "Hauteskunde-quoruma",
    parliamentSeatsPass: "Onarpen-atalasea",
    parliamentSeatsByElection: "Hauteskundeen arabera",
    parliamentSeatsByHouses: "LARP etxearen arabera",
    parliamentSeatsSeats: "eserleku",
    parliamentSeatsSeat: "eserleku",
    parliamentSeatsLeader: "Buruzagia",
    parliamentSeatsVotesFor: "botoak honi:",
    parliamentSeatsNoHouse: "Etxerik gabe",
    ...
    parliamentViewReport: "Txostena ikusi",
    ...
    parliamentRulesHemicycle: "Hemizikloak eserleku bat ematen dio biztanle bakoitzari: gobernu-blokea (hautagaitza irabazlearen hautesleak eta buruzagia), oposizio-bloke bat zikloko beste hautagaitza bakoitzeko, eta abstentzioa. Marka etenek hauteskunde-quoruma (erroldaren % 25) eta indarrean dagoen metodoaren onarpen-atalasea erakusten dituzte. \"LARP etxearen arabera\" eserleku berak etxeka koloreztatzen ditu.",
    ...
    podcastButton: "PODCASTA",
    podcastEpisodeButton: "ATALA",
    campaignButton: "KANPAINA",
    logisticsRouteButton: "IBILBIDEA",
    ...
    taskSearchPlaceholder: "Bilatu hemen: Atazak...",
    ...
    eventSearchPlaceholder: "Bilatu hemen: Ekitaldiak...",
    eventPrice: "Prezioa",
    eventStatus: "Egoera",
    ...
    tagsSearchPlaceholder: "Bilatu hemen: Etiketak...",
    ...
    transfersFilterMinePending: "ZAIN",
    transfersFilterMineConfirmed: "SINATUAK",
    ...
    transfersSearchPlaceholder: "Bilatu hemen: Transferentziak...",
    ...
    commentsGoToLast: "Joan azken iruzkinera",
    ...
    dataSearchPlaceholder: "Bilatu hemen: Bat etortzeak...",
    ...
    dataReasonFollowing: "Bizilagun honi laguntzen diozu",
    dataReasonTribe: "Tribu bat partekatzen du zurekin",
    dataReasonPinned: "Finkatu duzun zerbaitekin bat dator",
    dataReasonCv: "Zure CVko gaitasunekin bat dator",
    dataReasonContent: "Argitaratzen duzunarekin lotuta",
    dataReasonRelated: "Zure interesekin lotuta",
    dataReasonAlike: "Zu bezalako bizilagun batek argitaratua",
    dataReasonSupportsYou: "Laguntzen dizu",
    dataReasonMutual: "Elkarren laguntza",
    dataReasonRated: "Sareak ondo baloratua",
    dataReasonNear: "Zure ondoan",
    dataStatPeople: "CVak",
    ...
    pollSearchPlaceholder: "Bilatu hemen: Inkestak...",
    ...
    blogSearchPlaceholder: "Bilatu hemen: Blogak...",
    ...
    forumSearchPlaceholder: "Bilatu hemen: Foroak...",
    ...
    imageSearchPlaceholder: "Bilatu hemen: Irudiak...",
    ...
    feedSearchPlaceholder: "Bilatu hemen: Jarioa...",
    feedTitle:        "Jarioa",
    ...
    typeTop: "TOP",
    typePost:             "BLOGA",
    activityUpdateLabel: "EGUNERAKETA",
    typeTribe:            "TRIBUAK",
    typeLarp: "L.A.R.P.",
    ...
    reportsSearchPlaceholder: "Bilatu hemen: Txostenak...",
    ...
    searchTribesPlaceholder:  "Bilatu hemen: Tribuak...",
    ...
    tribeTagsPlaceholder: "Idatzi etiketak komaz bereizita",
    ...
    subscriptionTitle: "Harpidetzak",
    subscriptionOn: "Harpidetuta",
    subscriptionOff: "Harpidetu gabe",
    subscriptionSubscribe: "Harpidetu",
    subscriptionUnsubscribe: "Harpidetza utzi",
    subscriptionSubscribers: "Harpidedunak",
    pmListLabel: "Nori bidali",
    pmListNone: "— Zerrendarik ez —",
    pmListNoSubscribers: "Harpidedunik ez",
    ...
    agendaSearchPlaceholder: "Bilatu hemen: Agenda...",
    ...
    privateDescription: "Kudeatu zure mezu pribatuak.",
    ...
    bankingDescription: "ECOin ekonomia kolektiboa.",
    ...
    bankYourFundsMonth: "Funtsak guztira",
    bankIndustryBalance: "Industria ekoizpena",
    ...
    bankAddAddressLabel: "Etiketa (aukerakoa)",
    bankAddAddressLabelPlaceholder: "Boben zorroa, Aliceren denda…",
    bankAddAddressUserOptional: "Oasis ID (aukerakoa)",
    bankAddressUnnamed: "Izenik gabeko helbidea",
    ...
    shopSearchPlaceholder: "Bilatu hemen: Dendak...",
    shopUrl: "URL",
    ...
    shopTagsPlaceholder: "Idatzi etiketak komaz bereizita",
    ...
    bankPubsSupply: "PUBen poltsako ECOin hornidura",
    bankHoldingSupply: "UBItik kanpoko ECOin hornidura",
    ...
    bankInflation: "ECOin Inflazioa (urtekoa)",
    bankInflationMonthly: "ECOin Inflazioa (hilekoa)",
    ...
    bankCurrentSupply: "Uneko ECOin hornidura",
    bankingSyncStatus: 'ECOin Egoera',
    bankingSyncStatusSynced: 'Sinkronizatuta',
    bankingSyncStatusOutdated: "Sinkronizatu gabe",
    ...
    walletAddressCopyHint: "Sakatu hautatzeko, gero kopiatu",
    ...
    statsAiExchange: "IA",
    statsPUBs: 'PUBack',
    statsSyncedPeers: "Parekoak",
    statsTotalLabel: "Guztira",
    statsPost: "Mezuak",
    ...
    aiClearHistory: "Garbitu historia",
    aiServerError: "Ezin dut ondo erantzun. Saiatu berriro.",
    aiStatusLoading: "42 eredua kargatzen ari da. Galdetu berriro une batean.",
    aiThinking: "Pentsatzen",
    aiWaiting: "Zain",
    aiStatusMissingModel: "IA eredua ez dago instalatuta: src/AI/oasis-42-1-chat.Q4_K_M.gguf falta da.",
    aiExportFineTuning: "Fine-Tuning esportatu",
    aiFactsTitle: "Zure sareko datuak",
    ...
    marketCreateButton: "Saldu zerbait",
    marketItemType: "Mota",
    ...
    marketItemTagsPlaceholder: "Idatzi etiketak komaz bereizita",
    ...
    marketSearchPlaceholder: "Bilatu hemen: Merkatua...",
    ...
    housingSearchPlaceholder: "Bilatu hemen: Etxebizitza...",
    ...
    jobsSearchPlaceholder: "Bilatu hemen: Lanak...",
    ...
    industrySearchPlaceholder: "Bilatu hemen: Industria...",
    ...
    projectSearchPlaceholder: "Bilatu hemen: Proiektuak...",
    ...
    modulesTotalModulesLabel: "Guztira",
    ...
    modulesBankingDescription: "Altxor komuna kudeatzeko modulua: ECOINen balioa, zergak eta oinarrizko errenta.",
    ...
    errorNoAllocation: "Ez da esleipenik aurkitu erreklamazio honetarako.",
    errorInvalidClaim: "Esleipen hau ezin da erreklamatu.",
    ...
    bankEcoinHours: "ECOin Orduak (1 ECO)",
    mapsLabel: "Mapak",
    mapTitle: "Mapak",
    ...
    mapTagsPlaceholder: "Idatzi etiketak komaz bereizita",
    ...
    mapSearchPlaceholder: "Bilatu hemen: Mapak...",
    ...
    emergenciesTitle: "Larrialdiak",
    modulesEmergenciesLabel: "Larrialdiak",
    modulesEmergenciesDescription: "Sarean larrialdiak jaurti, berretsi eta jarraitzeko modulua.",
    emergenciesDescription: "Sarean larrialdiak jaurti, berretsi eta jarraitzeko modulua.",
    emergencyCreate: "Larrialdia sortu",
    emergencyUpdate: "Eguneratu",
    emergencyDelete: "Ezabatu",
    emergencyTitleLabel: "Izenburua",
    emergencyTitlePlaceholder: "Zer gertatzen ari da?",
    emergencyTextLabel: "Xehetasunak",
    emergencyTextPlaceholder: "Non, noiztik, zer egin...",
    emergencyCategoryLabel: "Kategoria",
    emergencyCategoryWeather: "EGURALDIA",
    emergencyCategoryInfrastructure: "AZPIEGITURA",
    emergencyCategoryHealth: "OSASUNA",
    emergencyCategorySecurity: "SEGURTASUNA",
    emergencyCategoryLost: "GALDUTAKOAK",
    emergencyCategoryNeighborhood: "AUZOA",
    emergencyExpiresLabel: "Iraungitzen da",
    emergencyExpires1d: "Egun 1",
    emergencyExpires3d: "3 egun",
    emergencyExpires7d: "Astebete",
    emergencyExpires30d: "Hilabete 1",
    emergencyExpiresNone: "Zehaztugabea",
    emergencyExpiresKeep: "Mantendu uneko data",
    emergencyTagsLabel: "Etiketak",
    emergencyTagsPlaceholder: "Idatzi etiketak komaz bereizita",
    emergencyFilterAll: "GUZTIAK",
    emergencyFilterMine: "NIREAK",
    emergencyFilterRecent: "AZKENAK",
    emergencySeverityUnverified: "EGIAZTATU GABE",
    emergencySeverityLow: "BAXUA",
    emergencySeverityMedium: "ERTAINA",
    emergencySeverityHigh: "ALTUA",
    emergencyStatusActive: "AKTIBOA",
    emergencyStatusResolved: "KONPONDUA",
    emergencyStatusExpired: "IRAUNGITUA",
    emergencyConfirmations: "Berrespenak",
    emergencyConfirmButton: "Berretsi",
    emergencyConfirmed: "Larrialdi hau berretsi duzu",
    emergencyResolveButton: "Konpondu",
    emergencyReopenButton: "Berriro ireki",
    emergencyGenerateReport: "Txostena sortu",
    emergencyUpdateEdited: "Editatua",
    emergencyLastUpdate: "AZKEN EGUNERAKETA",
    emergencyUpdatesTitle: "Azken eguneraketak:",
    emergencyNoUpdates: "Oraindik ez dago eguneraketarik.",
    emergencyAddUpdate: "Eguneraketa argitaratu",
    emergencyUpdatePlaceholder: "Zer aldatu da?",
    emergencyNoItems: "Ez da larrialdirik aurkitu.",
    emergencyExpiresAt: "Iraungitzen da",
    emergencyBannerLabel: "Larrialdi aktiboa",
    emergencyCreateSectionTitle: "Larrialdia sortu",
    emergencyUpdateSectionTitle: "Larrialdia eguneratu",
    emergencySearchPlaceholder: "Bilatu larrialdietan...",
    typeEmergency: "LARRIALDIAK",
    typeEmergencyConfirm: "LARRIALDI BERRESPENA",
    typeEmergencyUpdate: "LARRIALDI EGUNERAKETA",
    statsEmergency: "Larrialdiak",
    statsEmergencyConfirm: "Larrialdi berrespenak",
    statsEmergencyUpdate: "Larrialdi eguneraketak",
    pmBotEmergencies: "EmergencyBot",
    emergencyBotUpdatedTitle: "Jarraitzen duzun larrialdi batek eguneraketa bat du.",
    emergencyBotResolvedTitle: "Jarraitzen duzun larrialdi bat konpondu da.",
    dataKindEmergencies: "LARRIALDIAK",
    mailingTitle: "Posta-zerrendak",
    modulesMailingLabel: "Posta-zerrendak",
    modulesMailingDescription: "Aurkitu eta kudeatu posta-zerrendak zure sarean.",
    mailingDescription: "Aurkitu eta kudeatu posta-zerrendak zure sarean.",
    mailingCreate: "Posta-zerrenda sortu",
    mailingUpdate: "Eguneratu",
    mailingDelete: "Ezabatu",
    mailingArchive: "Artxibatu",
    mailingActivate: "Aktibatu",
    mailingCreateSectionTitle: "Posta-zerrenda sortu",
    mailingUpdateSectionTitle: "Posta-zerrenda eguneratu",
    mailingTitleLabel: "Izenburua",
    mailingTitlePlaceholder: "Posta-zerrendaren izena",
    mailingDescriptionLabel: "Deskribapena",
    mailingDescriptionPlaceholder: "Zeri buruz da zerrenda hau?",
    mailingTypeLabel: "Posta-zerrenda mota",
    mailingTypeOpen: "IREKIA",
    mailingTypeClosed: "ITXIA",
    mailingStatusLabel: "Egoera",
    mailingStatusActive: "AKTIBOA",
    mailingStatusArchived: "ARTXIBATUA",
    mailingMembersLabel: "Biztanleak gonbidatu",
    mailingMembersPlaceholder: "@id1.ed25519, @id2.ed25519, ...",
    mailingSubscribers: "Harpidedunak",
    mailingTagsLabel: "Etiketak",
    mailingTagsPlaceholder: "Idatzi etiketak komaz bereizita",
    mailingFilterAll: "GUZTIAK",
    mailingFilterMine: "NIREAK",
    mailingFilterSubscribed: "HARPIDETUAK",
    mailingFilterRecent: "AZKENAK",
    mailingHistoryDate: "DATA",
    mailingHistoryThreads: "HARIAK",
    mailingHistoryInhabitants: "BIZTANLEAK",
    mailingHistorySearchPlaceholder: "Bilatu historian...",
    mailingNoMessages: "Oraindik ez dago mezurik.",
    mailingNoItems: "Ez da posta-zerrendarik aurkitu.",
    mailingSearchPlaceholder: "Bilatu posta-zerrendetan...",
    mailingWriteButton: "Mezua idatzi",
    mailingWriteTitle: "Zerrendari idatzi",
    mailingReplyTitle: "Zerrendari erantzun",
    mailingSend: "Bidali",
    mailingTextPlaceholder: "Zure mezua zerrendako partaide guztiei iristen zaie.",
    mailingParticipants: "Partaideak",
    inboxFilterMailing: "Posta-zerrendak",
    mailingReplyPlaceholder: "Zerrendari erantzun...",
    mailingReplyToList: "Zerrendari erantzun",
    typeMailingList: "POSTA-ZERRENDA",
    statsMailingList: "Posta-zerrendak",
    mailingListLabel: "POSTA-ZERRENDA",
    logisticsTitle: "Logistika",
    modulesLogisticsLabel: "Logistika",
    modulesLogisticsDescription: "Aurkitu eta kudeatu plan logistikoak zure sarean.",
    logisticsDescription: "Aurkitu eta kudeatu plan logistikoak zure sarean.",
    logisticsCreate: "Ibilbidea sortu",
    logisticsUpdate: "Eguneratu",
    logisticsDelete: "Ezabatu",
    logisticsClose: "Itxi",
    logisticsReopen: "Berriro ireki",
    logisticsCreateSectionTitle: "Ibilbidea sortu",
    logisticsUpdateSectionTitle: "Ibilbidea eguneratu",
    logisticsTitleLabel: "Izenburua",
    logisticsTitlePlaceholder: "Bidaia merkatura, furgoneta eskuragarri...",
    logisticsKindLabel: "Logistika mota",
    logisticsKindTrip: "BIDAIA",
    logisticsKindShipment: "BIDALKETA",
    logisticsKindTrips: "BIDAIAK",
    logisticsKindShipments: "BIDALKETAK",
    logisticsModeLabel: "Modua",
    logisticsModeOffer: "ESKAINTZEN DUT",
    logisticsModeRequest: "BILA NABIL",
    logisticsModeOffers: "ESKAINTZAK",
    logisticsModeRequests: "ESKAERAK",
    logisticsDescriptionLabel: "Deskribapena",
    logisticsDescriptionPlaceholder: "Elkargunea, zer daramazun, baldintzak...",
    logisticsOriginLabel: "Jatorria",
    logisticsOriginPlaceholder: "Non hasten den",
    logisticsDestinationLabel: "Helmuga",
    logisticsDestinationPlaceholder: "Non amaitzen den",
    logisticsDateLabel: "Data eta ordua",
    logisticsRecurrenceLabel: "Errepikapena",
    logisticsFrequencyLabel: "Maiztasuna",
    logisticsRecurrenceNone: "BAKARRA",
    logisticsRecurrenceDaily: "EGUNEROKOA",
    logisticsRecurrenceWeekly: "ASTEKOA",
    logisticsRecurrenceMonthly: "HILEKOA",
    logisticsSeatsLabel: "Plazak",
    logisticsSizeLabel: "Tamaina",
    logisticsSizePlaceholder: "adib. 2m x 1m",
    logisticsWeightLabel: "Pisua",
    logisticsWeightPlaceholder: "adib. 40kg",
    logisticsPriceFree: "DOAN",
    logisticsPriceEco: "ECO",
    logisticsPriceTime: "DENBORA",
    logisticsPriceLabel: "Prezioa",
    logisticsHours: "h",
    logisticsOrderRefLabel: "Eskaeraren esteka",
    logisticsOrderRefPlaceholder: "entregatu beharreko eskaeraren /shops/... edo /market/...",
    logisticsOrderLink: "Lotutako eskaera",
    logisticsTagsLabel: "Etiketak",
    logisticsTagsPlaceholder: "Idatzi etiketak komaz bereizita",
    logisticsFilterAll: "GUZTIAK",
    logisticsFilterMine: "NIREAK",
    logisticsFilterBooked: "ERRESERBATUAK",
    logisticsFilterRecent: "AZKENAK",
    logisticsFilterHistory: "HISTORIA",
    logisticsFilterTop: "TOP",
    logisticsStatusOpen: "IREKIA",
    logisticsStatusUpcoming: "HURRENGOAK",
    logisticsStatusPast: "IGAROTAKOAK",
    logisticsStatusClosed: "ITXIAK",
    logisticsZoneLabel: "Eremua",
    logisticsSearchPlaceholder: "Bilatu logistikan...",
    logisticsNoItems: "Ez da ibilbiderik aurkitu.",
    logisticsBookingPending: "ZAIN",
    logisticsBookingConfirmed: "BAIEZTATUA",
    logisticsBookingRejected: "BAZTERTUA",
    logisticsBookingCancelled: "BERTAN BEHERA",
    logisticsBookingDelivered: "ENTREGATUA",
    logisticsConfirm: "Baieztatu",
    logisticsReject: "Baztertu",
    logisticsDeliver: "Entregatu",
    logisticsReceiptLabel: "Ordainagiria",
    logisticsReceiptPlaceholder: "Entrega-oharra (aukerakoa)",
    logisticsCancelBooking: "Erreserba bertan behera utzi",
    logisticsBookTitle: "Ibilbide hau erreserbatu",
    logisticsNotesLabel: "Oharrak",
    logisticsNotesPlaceholder: "Arduradunak jakin beharrekoa",
    logisticsBook: "Erreserbatu",
    logisticsBookingsTitle: "Erreserbak",
    logisticsMyBookingTitle: "Zure erreserba",
    logisticsRatingsTitle: "Balorazioak",
    logisticsNoRatings: "Oraindik ez dago baloraziorik.",
    logisticsRatingsWhenClosed: "Balorazioak ibilbidea ixtean irekitzen dira.",
    logisticsScoreLabel: "Puntuazioa",
    logisticsRatingPlaceholder: "Nola joan da?",
    logisticsRate: "Baloratu",
    typeLogisticsRoute: "IBILBIDEA",
    typeLogisticsRating: "IBILBIDEAREN BALORAZIOA",
    statsLogisticsRoute: "Ibilbideak",
    statsLogisticsRating: "Ibilbideen balorazioak",
    logisticsRouteLabel: "IBILBIDEA",
    podcastsTitle: "Podcastak",
    modulesPodcastsLabel: "Podcastak",
    modulesPodcastsDescription: "Podcast kanalak argitaratzeko modulua.",
    podcastsDescription: "Podcast kanalak argitaratzeko modulua.",
    podcastCreate: "Podcasta sortu",
    podcastUpdate: "Eguneratu",
    podcastDelete: "Ezabatu",
    podcastCreateSectionTitle: "Podcasta sortu",
    podcastUpdateSectionTitle: "Podcasta eguneratu",
    podcastTitleLabel: "Izenburua",
    podcastTitlePlaceholder: "Kanalaren izena",
    podcastDescriptionLabel: "Deskribapena",
    podcastDescriptionPlaceholder: "Zeri buruz da podcast hau?",
    podcastCategoryLabel: "Kategoria",
    podcastCategoryNews: "ALBISTEAK",
    podcastCategoryMusic: "MUSIKA",
    podcastCategoryTalk: "SOLASALDIA",
    podcastCategoryEducation: "HEZKUNTZA",
    podcastCategoryTech: "TEKNOLOGIA",
    podcastCategoryCulture: "KULTURA",
    podcastCategoryCommunity: "KOMUNITATEA",
    podcastCategoryOasis: "OASIS",
    podcastCategoryOther: "BESTELAKOAK",
    podcastTagsLabel: "Etiketak",
    podcastTagsPlaceholder: "Idatzi etiketak komaz bereizita",
    podcastFilterAll: "GUZTIAK",
    podcastFilterMine: "NIREAK",
    podcastFilterRecent: "AZKENAK",
    podcastFilterTop: "TOP",
    podcastFilterViewers: "ENTZULEAK",
    podcastSearchPlaceholder: "Bilatu podcastetan...",
    podcastNoItems: "Ez da podcastik aurkitu.",
    podcastEpisodesLabel: "Atalak",
    podcastPlaysLabel: "Ikustaldiak",
    podcastLastEpisode: "Azken atala",
    podcastEpisodesTitle: "Atalak",
    podcastNoEpisodes: "Oraindik ez dago atalik.",
    podcastEpisodeAdd: "Atala gehitu",
    podcastEpisodeCreateTitle: "Atala argitaratu",
    podcastEpisodeUpdateTitle: "Atala eguneratu",
    podcastEpisodeTitleLabel: "Atalaren izenburua",
    podcastEpisodeTitlePlaceholder: "Atalaren izenburua",
    podcastEpisodeDescriptionLabel: "Oharrak",
    podcastEpisodeDescriptionPlaceholder: "Zer gertatzen den atal honetan, estekak, kredituak...",
    podcastEpisodePublish: "Argitaratu",
    podcastPlayed: "Entzunda",
    podcastMarkPlayed: "Entzundako gisa markatu",
    typePodcast: "PODCASTA",
    typePodcastEpisode: "ATALA",
    typePodcastOpinion: "ATALAREN IRITZIA",
    typePodcastPlay: "ERREPRODUKZIOA",
    statsPodcast: "Podcastak",
    statsPodcastEpisode: "Atalak",
    statsPodcastPlay: "Erreprodukzioak",
    pmBotPodcasts: "PodcastBot",
    pmBotBlogs: "BlogsBot",
    blogBotNewTitle: "Jarraitzen duzun blog batek sarrera berria du.",
    podcastBotEpisodeTitle: "Jarraitzen duzun podcast batek atal berria du.",
    podcastLabel: "PODCASTA",
    podcastEpisodeLabel: "ATALA",
    campaignsTitle: "Kanpainak",
    modulesCampaignsLabel: "Kanpainak",
    modulesCampaignsDescription: "Aurkitu eta kudeatu kanpainak zure sarean.",
    campaignsDescription: "Aurkitu eta kudeatu kanpainak zure sarean.",
    campaignCreate: "Kanpaina sortu",
    campaignUpdate: "Eguneratu",
    campaignDelete: "Ezabatu",
    campaignClose: "Itxi",
    campaignReopen: "Berriro ireki",
    campaignCreateSectionTitle: "Kanpaina sortu",
    campaignUpdateSectionTitle: "Kanpaina eguneratu",
    campaignTitleLabel: "Izenburua",
    campaignTitlePlaceholder: "Zer lortu nahi duzu?",
    campaignTextLabel: "Testua",
    campaignTextPlaceholder: "Azaldu kausa, nork erabakitzen duen eta zer eskatzen duzun...",
    campaignCategoryLabel: "Kategoria",
    campaignCategoryEnvironment: "INGURUMENA",
    campaignCategoryRights: "ESKUBIDEAK",
    campaignCategoryHealth: "OSASUNA",
    campaignCategoryEducation: "HEZKUNTZA",
    campaignCategoryInfrastructure: "AZPIEGITURA",
    campaignCategoryCulture: "KULTURA",
    campaignCategoryEconomy: "EKONOMIA",
    campaignCategoryOther: "BESTELAKOAK",
    campaignGoalLabel: "Sinadura helburua",
    campaignDeadlineLabel: "Epea",
    campaignTagsLabel: "Etiketak",
    campaignTagsPlaceholder: "Idatzi etiketak komaz bereizita",
    campaignFilterAll: "GUZTIAK",
    campaignFilterMine: "NIREAK",
    campaignFilterSigned: "SINATUAK",
    campaignFilterRecent: "AZKENAK",
    campaignFilterTop: "TOP",
    campaignStatusOpen: "IREKIA",
    campaignStatusAchieved: "LORTUA",
    campaignStatusUnachieved: "LORTU GABE",
    campaignStatusClosed: "ITXIA",
    campaignSearchPlaceholder: "Bilatu kanpainetan...",
    campaignNoItems: "Ez da kanpainarik aurkitu.",
    campaignSignaturesLabel: "Sinadurak",
    campaignSignaturesTitle: "Babesleak",
    campaignNoSignatures: "Oraindik ez dago sinadurarik.",
    campaignSignTitle: "Kanpaina hau sinatu",
    campaignSignPlaceholder: "Zergatik babesten duzu? (aukerakoa)",
    campaignSign: "Sinatu",
    campaignSigned: "Dagoeneko sinatu duzu!",
    campaignNotSigned: "Zure sinadura falta da oraindik",
    campaignElevate: "Parlamentura eraman",
    campaignElevated: "Parlamentura eramana",
    campaignUpdatesTitle: "Eguneraketak",
    campaignNoUpdates: "Oraindik ez dago eguneraketarik.",
    campaignUpdatePlaceholder: "Zer gertatu da?",
    campaignAddUpdate: "Eguneraketa argitaratu",
    campaignQrAlt: "Kanpaina hau sinatzeko QRa",
    campaignQrCaption: "Eskaneatu sinatzeko",
    typeCampaign: "KANPAINA",
    typeCampaignSignature: "SINADURA",
    typeCampaignUpdate: "KANPAINAREN EGUNERAKETA",
    statsCampaign: "Kanpainak",
    statsCampaignSignature: "Kanpainen sinadurak",
    statsCampaignUpdate: "Kanpainen eguneraketak",
    pmBotCampaigns: "CampaignBot",
    campaignBotUpdatedTitle: "Jarraitzen duzun kanpaina batek eguneraketa bat du.",
    campaignBotAchievedTitle: "Jarraitzen duzun kanpaina batek helburua lortu du.",
    campaignBotRaisedTitle: "Sinatu duzun kanpaina bat Parlamentura eraman da.",
    pmBotLogistics: "LogisticsBot",
    logisticsBotUpdatedTitle: "Erreserbatu duzun ibilbide bat aldatu da.",
    logisticsBotClosedTitle: "Erreserbatu duzun ibilbide bat itxi da.",
    logisticsBotBookedTitle: "Norbaitek zure ibilbidea erreserbatu du.",
    logisticsBotCancelledTitle: "Zure ibilbideko erreserba bat bertan behera utzi da.",
    logisticsBotConfirmedTitle: "Zure erreserba berretsi da: paketea bidean da.",
    logisticsBotRejectedTitle: "Zure erreserba baztertu da.",
    logisticsBotDeliveredTitle: "Zure paketea iritsi da.",
    campaignLabel: "KANPAINA",
    campaignGenerateReport: "Txostena sortu",
    logisticsGenerateReport: "Txostena sortu",
    mailingGenerateReport: "Txostena sortu",
    campaignUpdateEdited: "Editatua",
    mailingMessagesLabel: "Mezuak",
    logisticsBookingsLabel: "Erreserbak",
    backupTitle: "Segurtasun-kopia",
    modulesBackupLabel: "Segurtasun-kopia",
    modulesBackupDescription: "Zure gakoak esportatu eta inportatzeko eta segurtasun-kopia zifratuak egiteko modulua.",
    backupDescription: "Zure gakoak esportatu eta inportatzeko eta segurtasun-kopia zifratuak egiteko modulua.",
    backupKitWarning: "Orri hau irakurtzen duen edonork zure izenean jardun dezake. Ez partekatu inoiz!",
    backupTypeRecovery: "BERRESKURATZEA",
    backupTypeKeys: "GAKOAK ESPORTATU",
    backupTypeFull: "KOPIA OSOA",
    backupTypeRestore: "KOPIA LEHENERATU",
    backupTypeInstant: "BAT-BATEAN",
    backupInstantDescription: "Zure erregistro eta fitxategi guztien .zip soil bat, gako sekreturik gabe eta pasahitzik gabe. Azkarra, baina fitxategia duenak dena irakurtzen du.",
    backupInstantWarning: "Kopia hau ez doa zifratuta. Gorde leku seguru batean.",
    backupKitPageDescription: "Berreskuratze-kita gailu honetatik bakarrik ireki daiteke.",
    backupKitId: "Oasis IDa",
    backupKitDate: "Sortua",
    backupKitQrAlt: "Zure gako sekretuaren QR kodea",
    backupKitStep1: "Inprimatu edo eskuz kopiatu eta gorde leku seguru batean, konexiorik gabe.",
    backupKitStep2: "Berreskuratzeko, instalatu Oasis gailu berri batean eta inportatu sekretu hau Segurtasun-kopia › Gakoak ataletik.",
    backupKitStep3: "Suntsitu orri hau inoiz agerian geratzen bada.",
    backupKitPdfButton: "PDFa sortu",
    backupScopeLabel: "Irismena",
    backupScopeAll: "DENA",
    backupScopeMine: "NIRE EDUKIA BAKARRIK",
    backupSinceLabel: "Noiztik",
    backupEstimateTitle: "Estimazioa",
    backupFileInfo: "Zure kopia zifratua gailuan deskargatuko da (izena: oasis-backup-DATA.oasisbk)",
    backupExportButton: "Kopia deskargatu",
    backupRestorePassword: "Idatzi kopia egitean erabilitako pasahitza",
    backupRestoreButton: "Kopia berreskuratu",
    backupRestoredLine: "Kopia berreskuratuta.",
    backupRestoredMessages: "Gehitutako mezuak",
    backupRestoredSkipped: "Lehendik zeudenak",
    backupRestoredBlobs: "Gehitutako fitxategiak",
    backupRestoredState: "Ezarpenak berrezarrita",
    backupRestoredFailed: "Huts egindakoak",
    backupRestoredForked: "Dibergenteak",
    backupRestoreRunning: "Kopia leheneratzen. Orri hau bere kabuz eguneratzen da; bitartean Oasis erabiltzen jarrai dezakezu.",
    backupRestoreElapsed: "Igarotako denbora",
    backupRestoreFailedLine: "Ezin izan da kopia leheneratu.",
    backupRestoreForkMine: "Gailu honek dagoeneko zure identitatearekin kopian ez dauden mezuak argitaratu ditu, beraz ezin izan da haien gainean aplikatu. Leheneratu instalazio garbi batean, giltzak inportatu eta berehala, beste ezer egin aurretik.",
    verificationTitle: "Egiaztapena",
    verificationDescription: "Egiaztatu zure jarioaren katea, hauteman adarkatzeak eta berrikusi fitxategi umezurtzak edo falta direnak.",
    verificationRun: "Egiaztapena exekutatu",
    verificationTotalMessages: "mezu erregistroan",
    verificationFeed: "Zure jarioa",
    verificationMessages: "mezu",
    verificationLastSequence: "azken sekuentzia",
    verificationGaps: "Hutsuneak",
    verificationBrokenLinks: "Lotura hautsiak",
    verificationBadHashes: "Hash okerrak",
    verificationBadSignatures: "Sinadura okerrak",
    verificationDuplicates: "Sekuentzia bikoiztuak",
    verificationForks: "Adarkatzeak",
    verificationBlobs: "Fitxategiak",
    verificationBlobsPresent: "daude",
    verificationBlobsReferenced: "erreferentziatuak",
    verificationBlobsOrphan: "umezurtzak",
    verificationBlobsMissing: "falta dira",
    verificationBlobsMissingOwn: "Gailu honetan falta diren zure fitxategiak",
    verificationBlobsMissingOthers: "Beste biztanleen fitxategiak oraindik deskargatu gabe",
    verificationBlobsUnavailable: "Ezin izan dira fitxategiak zerrendatu gailu honetan.",
    wikiTitle: "Wikiak",
    modulesWikiLabel: "Wikiak",
    modulesWikiDescription: "Wikiak aurkitu eta kudeatzeko modulua.",
    wikiDescription: "Wikiak aurkitu eta kudeatzeko modulua.",
    wikiCreate: "Wikia sortu",
    wikiUpdate: "Eguneratu",
    wikiDelete: "Ezabatu",
    wikiEdit: "Editatu",
    wikiTitleLabel: "Izenburua",
    wikiTitlePlaceholder: "Wikiaren izenburua...",
    wikiBodyLabel: "Edukia",
    wikiBodyPlaceholder: "Lotu beste wiki batzuk [[Wikiaren izenburua]] edo [[Wikiaren izenburua|testu propioa]] erabiliz.\n\nAipatu bizilagun bat @id bidez.\n\nEtiketatu #oasis erabiliz.\n\nItsatsi estekak, adibidez https://solarnethub.com\n\nLerro huts batek paragrafo berria hasten du; lerro-jauzi bakunak mantentzen dira.\n\nErantsi onartutako edozein media eta hemen txertatuko da.",
    formatBarLabel: "Formatua",
    wikiStatusLabel: "Wiki mota",
    wikiStatusOpen: "IREKIA",
    wikiStatusClosed: "ITXIA",
    wikiTagsLabel: "Etiketak",
    wikiTagsPlaceholder: "Idatzi etiketak komaz bereizita",
    wikiSummaryLabel: "Aldaketaren laburpena",
    wikiSummaryPlaceholder: "Zer aldatu da?",
    wikiFilterAll: "GUZTIAK",
    wikiFilterMine: "NIREAK",
    wikiFilterRecent: "AZKENAK",
    wikiFilterLinked: "LOTUTAK",
    wikiChanges: "Azken aldaketak",
    wikiNoPages: "Ez da wikirik aurkitu.",
    wikiNoChanges: "Oraindik ez dago aldaketarik.",
    wikiHistory: "Historia",
    wikiVersion: "Bertsioa",
    wikiVersions: "bertsio",
    wikiRestore: "Berreskuratu",
    wikiDiff: "Aldaketak",
    wikiViewVersion: "Ikusi",
    wikiLinkedPages: "Lotutako orriak",
    wikiNoLinkedPages: "Orri hau ez dago oraindik beste inorekin lotuta.",
    wikiMissingLink: "Orria ez da existitzen oraindik",
    wikiDuplicateTitle: "Izenburu hori duen orri bat badago dagoeneko. Aldatu izenburua beste orri bat sortzeko.",
    wikiCreateSectionTitle: "Wikia sortu",
    wikiUpdateSectionTitle: "Wikia eguneratu",
    wikiSearchPlaceholder: "Bilatu Wikian...",
    wikiCurrentVersion: "Uneko bertsioa",
    wikiViewingVersion: "Bertsio zahar bat ikusten ari zara",
    wikiBackToPage: "Itzuli orrira",
    wikiLinkedChip: "Lotuta",
    wikiRestoredSummary: "Berreskuratutako bertsioa",
    wikiExportPdf: "Orria sortu",
    wikiPreview: "Aurrebista",
    tribeSectionWiki: "WIKIA",
    tribeWikiCreate: "Wikia sortu",
    tribeWikiEmpty: "Oraindik ez dago wikirik.",
    typeWiki: "WIKIA",
    padsTitle: "Padak",
    padTitle: "Pad",
    modulesPadsLabel: "Padak",
    modulesPadsDescription: "Testu-editore kolaboratiboak kudeatzeko modulua.",
    padCreate: "Pad Sortu",
    padUpdate: "Eguneratu",
    padDelete: "Ezabatu",
    ...
    padTagsPlaceholder: "Idatzi etiketak komaz bereizita",
    ...
    padSearchPlaceholder: "Bilatu hemen: Padak...",

    modulesChatsLabel: "Txatak",
    modulesChatsDescription: "Txatak aurkitu eta kudeatzeko modulua.",
    typeChat: "TXATAK",
    ...
    chatSearchPlaceholder: "Bilatu hemen: Txatak...",
    ...
    activitySearchPlaceholder: "Bilatu hemen: Jarduera...",
    trendingSearchPlaceholder: "Bilatu hemen: Pil-pilean...",
    opinionsSearchPlaceholder: "Bilatu hemen: Iritziak...",
    votesSearchPlaceholder: "Bilatu hemen: Bozkatzeak...",
    gamesSearchPlaceholder: "Bilatu hemen: Jokoak...",
    schoolTitle: "Eskola",
    pmBotWiki: "WikiBot",
    wikiBotEditedTitle: "Jarraitzen duzun wiki orri bat editatu da.",
    wikiBotRestoredTitle: "Jarraitzen duzun wiki orri baten aurreko bertsio bat berreskuratu da.",
    pmBotSchool: "EducaBot",
    schoolBotEnrolledTitle: "Ikasle berri batek zure ikastaroan izena eman du.",
    schoolBotInvitedTitle: "Ikastaro batera gonbidatu zaituzte.",
    schoolBotAdmittedTitle: "Ikastaro batean onartu zaituzte.",
    schoolBotCertificateTitle: "Ziurtagiri bat jaso duzu.",
    schoolBotPassedTitle: "Ikasle batek zure ikastaroa gainditu du.",
    schoolBotLessonTitle: "Ikasgai berri bat argitaratu da.",
    invitesSchoolTitle: "Eskola",
    invitesSchoolHint: "Sartu eskolako kode bat ikastaro pribatu batean sartzeko.",
    invitesSchoolCodePlaceholder: "Sartu ikastaroaren gonbidapen kodea",
    invitesSchoolJoinButton: "Sartu ikastaroan",
    schoolEnrollLabel: "Batu ikastarora",
    schoolExamRetryLater: "24 ordu igarota berriro saia zaitezke.",
    schoolApproved: "GAINDITUTA",
    schoolExamPassMark: "Gainditzeko nota (0-10)",
    schoolExamPassed: "GAINDITUTA",
    schoolExamPending: "Zain",
    schoolExamFailed: "EZ GAINDITUA",
    schoolExamAddQuestion: "Gehitu galdera",
    schoolExamCreateQuestion: "Galdera sortu",
    schoolExamOption: "Aukera",
    schoolExamCorrect: "Aukera zuzena",
    schoolExamPoints: "Puntuak",
    schoolMaterialTextPlaceholder: "Ikasgai honetarako oharrak...",
    schoolMaterials: "Materialak",
    schoolAddMaterial: "Gehitu materiala",
    schoolNoMaterials: "Oraindik ez dago materialik.",
    bankYourSchoolBalance: "Zure eskolako irabaziak",
    schoolProgress: "Aurrerapena",
    schoolProgressMark: "Markatu osatutzat",
    schoolProgressDone: "Osatuta",
    schoolExams: "Azterketak",
    schoolExamCreate: "Sortu azterketa",
    schoolExamTitlePlaceholder: "Azterketaren izenburua",
    schoolExamHelp: "Galdera bat lerroko: Galdera? ; aukera ; aukera zuzena* ; aukera",
    schoolExamQuestionsPlaceholder: "Zer da SSB? ; Datu-base bat ; P2P protokolo bat* ; Nabigatzaile bat",
    schoolExamSubmit: "Bidali erantzunak",
    schoolExamScore: "Zure nota",
    schoolNoScoresYet: "Oraindik ez dago emaitzarik.",
    schoolLessonUnit: "Unitatea / fasea",
    schoolLessonUnitPlaceholder: "adib. 1. fasea",
    schoolLessonOrder: "Ordena",
    profileClearnetSchoolLabel: "Eskola",
    schoolStartDate: "Hasiera data",
    schoolSessionDate: "Saioaren data",
    schoolCourseChat: "Ikastaroaren txata",
    agendaFilterSchool: "ESKOLA",
    agendaFilterCampaigns: "KANPAINAK",
    agendaFilterLogistics: "LOGISTIKA",
    schoolCourseType: "Ikastaro mota",
    schoolTypeOpen: "OPEN",
    schoolTypePaid: "PAID",
    schoolTypeInvite: "INVITE-ONLY",
    schoolLessonLocked: "Ikasgai zifratua — eskatu irakasleari ikastaroaren gakoa.",
    schoolGrantAccess: "Bidali ikastaroaren gakoa",
    schoolKeySent: "Gakoa bidalita",
    schoolOngoing: "Abian",
    schoolFilterApplied: "IZENA EMANDA",
    schoolFilterOpen: "IREKIAK",
    schoolFilterFavorites: "GOGOKOAK",
    schoolPendingPayment: "Ordainketa zain",
    schoolPendingStudents: "Izen-emateak zain",
    schoolViewBill: "Ikusi faktura",
    schoolPaymentNote: "Izena emateak ECO faktura bat (transferentzia bat) sortzen du. Zure izen-ematea transferentzia sinatzean berresten da.",
    schoolCloseCourse: "Itxi ikastaroa",
    schoolReopenCourse: "Ireki berriro ikastaroa",
    schoolDescription: "Irakatsi eta ikasi ikastaroak zure sarean.",
    schoolFilterAll: "GUZTIAK",
    schoolFilterMine: "NIREAK",
    schoolFilterTop: "TOP",
    schoolFilterRecent: "AZKENAK",
    schoolCreateButton: "Sortu Ikastaroa",
    schoolCreateSectionTitle: "Sortu ikastaro bat",
    schoolUpdateSectionTitle: "Eguneratu ikastaroa",
    schoolCourseTitlePlaceholder: "Zure ikastaroaren izena",
    schoolCourseDescriptionPlaceholder: "Zer irakatsiko duzu ikastaro honetan?",
    schoolCourseImage: "Ikastaroaren irudia (gehienezko tamaina: 50MB)",
    schoolTags: "Etiketak",
    schoolTagsPlaceholder: "Idatzi etiketak komaz bereizita",
    schoolPrice: "Prezioa (ECO)",
    schoolVisibility: "Ikusgaitasuna",
    schoolVisibilityPublic: "Publikoa",
    schoolVisibilityInvite: "Gonbidapenez",
    schoolStatus: "Egoera",
    schoolClosed: "Itxita",
    schoolFree: "Doan",
    schoolCreate: "Sortu ikastaroa",
    schoolUpdate: "Eguneratu ikastaroa",
    schoolSearchPlaceholder: "Bilatu hemen: Eskola...",
    schoolSortTitle: "Izenburua",
    schoolNoCourses: "Ez da ikastarorik aurkitu.",
    schoolStudents: "Ikasleak",
    schoolTeacher: "Irakaslea",
    schoolCreatedAt: "SORTUA",
    schoolLessons: "Ikasgaiak",
    schoolNoLessons: "Oraindik ez dago ikasgairik.",
    schoolEnrollToSee: "Eman izena ikastaro honetako ikasgaiak ikusteko.",
    schoolEnrollButton: "IZENA EMAN",
    schoolUnenrollButton: "Utzi ikastaroa",
    schoolInviteRequired: "Ikastaro hau gonbidapenez da.",
    schoolTeacherPanel: "Irakaslearen panela",
    schoolStudentPanel: "Ikaslearen panela",
    schoolAddLesson: "Ikasgaia sortu",
    schoolLessonTitlePlaceholder: "Ikasgaiaren izenburua",
    schoolLessonTextPlaceholder: "Deskribatu ikasgai honek lantzen dituen nozioak...",
    schoolInviteStudents: "Gonbidatu ikasleak",
    schoolInvitePlaceholder: "@id1, @id2...",
    schoolInviteButton: "GONBIDATU",
    schoolInvited: "Gonbidatuak",
    schoolIssueCertificate: "Ziurtagiria sortu",
    schoolCertified: "Ziurtatua",
    ...
    schoolDeleteButton: "Ezabatu",
    typeSchool: "ESKOLA",
    schoolCourseLabel: "IKASTAROA",
    emergencyLabel: "LARRIALDIA",
    wikiPageLabel: "WIKI",
    statsSchoolCourse: "Ikastaroak",
    statsSchoolLesson: "Ikasgaiak",
    statsSchoolEnroll: "Izen-emateak",
    statsSchoolCertificate: "Eskolako ziurtagiriak",
    modulesSchoolLabel: "Eskola",
    modulesSchoolDescription: "Ezagutza trukatzeko modulua.",
    ...
    chatTagsPlaceholder: "Idatzi etiketak komaz bereizita",
  ...
  calendarDeleteNote: "Delete",
    ...
    calendarSearchPlaceholder: "Bilatu hemen: Egutegia...",
    ...
    torrentTagsPlaceholder: "Idatzi etiketak komaz bereizita",
    torrentSizeLabel: "Tamaina",
    torrentDownloadButton: "DESKARGATU!",
    torrentDetailsButton: "XEHETASUNAK",
    torrentNoFile: "Torrent fitxategirik ez",
    noTorrents: "Ez da torrentik aurkitu.",
    torrentSearchPlaceholder: "Bilatu hemen: Torrentak...",
    ...
    logsSearchText: "Bilatu hemen: Egunkaria...",
    ...
    larpSearchPlaceholder: "Bilatu hemen: L.A.R.P....",
    ...
    bankOverviewYourTaxes: "Zergak guztira",
    ...
    indexingMessage: "Oasis biztanle sare erraldoi bat sinkronizatzen ari da. Itxaron une bat!",
    indexingRefreshNote: "Orri hau 10 segundoro birkargatzen da.",
    indexingTitle: "Sinkronizatzen",
    ...
    modulesLarpDescription: "Zuzeneko rol-jokoaren geruzarako modulua.",
