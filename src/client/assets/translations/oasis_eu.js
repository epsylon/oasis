...
module.exports = {
  eu: {
    ...
    shopOrdersDescription: "Denda honek jasotako eskaera zifratuak.",
    ...
    modulesLarpDescription: "Oasiseko bizirik dauden rol-jokuaren geruzaren modulua (9 Etxeak).",
