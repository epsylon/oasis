...
module.exports = {
  eu: {
    ...
    pmListLabel: "PM masiboa",
    pmListNone: "— Zerrendarik ez —",
    pmListNoSubscribers: "PM masibo honek ez du harpidedunik oraindik.",
    ...
    backupRestoreForkOthers: "Gailu honetako feed batzuk kopiatik aldentzen dira; gainerako mezuak ukitu gabe utzi dira.",
    backupRestoreErrors: "Arrazoiak",
