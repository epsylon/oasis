...
module.exports = {
  eu: {
    ...
    subscriptionTitle: "Posta zerrenda",
    ...
    pmListLabel: "Posta zerrenda",
    pmListNone: "— Zerrendarik ez —",
    pmListNoSubscribers: "Posta zerrenda honek ez du harpidedunik oraindik.",
