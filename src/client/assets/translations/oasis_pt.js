...
module.exports = {
  pt: {
    ...
    pmListNoSubscribers: "Este PM massivo ainda não tem subscritores.",
    ...
    backupRestoreForkOthers: "Alguns feeds deste dispositivo divergem da cópia; as mensagens restantes ficaram intactas.",
