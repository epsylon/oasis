...
module.exports = {
  pt: {
    ...
    walletCreateTransferLabel: "Gerar um transfer (recibo) para que o destinatário confirme este pagamento",
    ...
    bankWalletNotConfigured: "Carteira ECOin não configurada!",
