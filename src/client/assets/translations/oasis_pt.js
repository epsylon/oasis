...
module.exports = {
  pt: {
    ...
    melodyCompositionTitle: 'Composição',
    ...
    shopOrdersDescription: "Encomendas cifradas recebidas por esta loja.",
    ...
    modulesLarpDescription: "Módulo para a camada de role-playing ao vivo do Oasis (as 9 Casas).",
