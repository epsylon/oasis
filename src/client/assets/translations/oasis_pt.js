...
module.exports = {
  pt: {
    ...
    searchCasesPlaceholder: "Pesquisar em Tribunais...",
    ...
    mentionsSearchPlaceholder: "Pesquisar em Menções...",
    privateReminders: "LEMBRETES",
    inboxFilterPms: "PMs",
    inboxFilterNotifications: "Notificações",
    inboxMarkRead: "Marcar como lido",
    inboxMarkUnread: "Marcar como não lido",
    inboxUnreadChip: "Não lido",
    inboxMarkAllRead: "Marcar tudo como lido",
    inboxDeleteShown: "Apagar tudo",
    inboxArchive: "Arquivar",
    inboxUnarchive: "Desarquivar",
    inboxFilterArchived: "Arquivados",
    inboxEarlierMessages: "mensagens anteriores",
    inboxSortThread: "Por conversa",
    inboxSortRecent: "Mais recentes primeiro",
    inboxAllBots: "Bots",
    settingsInboxBotsTitle: "Notificações do Inbox",
    settingsInboxBotsDesc: "Escolhe quais bots podem avisar-te no teu Inbox. Os bots desmarcados ficam ocultos e os seus avisos não são contados.",
    ...
    settings: "Definições",
    settingsDescription: "Configura o ambiente da tua rede.",
    ...
    inboxSearchPlaceholder: "Pesquisar em Caixa de entrada...",
    ...
    telegramPhoneLabel: "Número de telefone",
    telegramSendCode: "Enviar código",
    telegramCodeHelp: "Introduz o código que o Telegram te acabou de enviar (app ou SMS).",
    telegramCodeLabel: "Código",
    telegramPasswordHelp: "Esta conta tem verificação em dois passos. Introduz a tua palavra-passe.",
    telegramPasswordLabel: "Palavra-passe",
    telegramVerify: "Verificar",
    telegramCancel: "Cancelar",
    telegramChats: "Conversas",
    telegramUnread: "Não lidas",
    telegramOpen: "Abrir",
    telegramSend: "Enviar",
    telegramYou: "Tu",
    telegramNoChats: "Ainda não há conversas.",
    telegramNoMessages: "Ainda não há mensagens.",
    telegramComposePlaceholder: "Escreve uma mensagem…",
    telegramChannel: "Canal",
    telegramGroup: "Grupo",
    telegramPrivate: "Privado",
    telegramErrConnect: "Não foi possível contactar o Telegram.",
    telegramErrTimeout: "O Telegram demorou demasiado a responder.",
    telegramErrAuth: "Sessão do Telegram inválida ou expirada. Liga de novo.",
    telegramErrFetch: "Não foi possível carregar as conversas.",
    telegramErrSend: "Não foi possível enviar a mensagem.",
    telegramErrMissing: "São necessários API ID, API hash e número de telefone.",
    telegramErrCode: "Código inválido. Tenta de novo.",
    telegramErrCodeExpired: "O código expirou. Começa de novo.",
    telegramErrPassword: "Palavra-passe errada.",
    telegramErrPhone: "Número de telefone inválido.",
    telegramErrApi: "API ID ou API hash inválidos.",
    telegramErrFlood: "Demasiadas tentativas. Espera um pouco e tenta de novo.",
    telegramErrNoLogin: "Nenhum início de sessão em curso. Começa de novo.",
    ...
    dateInPastError: "A data não pode ser anterior a hoje",
    ...
    indexes: "Índices",
    indexesRebuilt: "Índices reconstruídos",
    indexesRebuildFailed: "Não foi possível reconstruir os índices",
    indexesFiles: "Ficheiros de índice",
    indexesDescription:
    ...
    walletDescription: "Gere a tua carteira ECOin.",
    walletDate: "Data",
    ...
    walletReset: "Repor",
    walletSend: "Enviar",
    walletPayingTransfer: "A pagar transfer",
    walletCreateTransferLabel: "Gerar contrato (transferência)",
    walletTransferNotifiedNote: "A outra parte foi avisada deste pagamento",
    walletTransferCreatedNote: "Foi criado um transfer (recibo) deste pagamento",
    walletTransferNoPayeeNote: "Nenhum habitante publicou este endereço, por isso não se criou transfer",
    walletTransferReceiptConcept: "Pagamento a partir da carteira",
    walletPaymentPmText: "enviou-te um pagamento",
    walletPayeeLabel: "Destinatário",
    walletConceptLabel: "Conceito",
    pmBotBanking: "BankingBot",
    bankingBotUbiPaidTitle: "Recebeste o teu RBU.",
    bankingBotPaymentTitle: "Recebeste um pagamento.",
    bankingBotUbiPaidText: "O teu Rendimento Básico Universal foi pago",
    bankUbiPubThisNode: "Este nó paga o RBU",
    bankUbiPubConnected: "PUB do RBU",
    bankUbiPubNone: "Nenhum PUB anuncia ainda RBU na tua rede",
    bankUbiAddressPublished: "Endereço ECOin publicado",
    bankUbiAddressMissing: "Publica o teu endereço ECOin para receber o RBU",
    bankUbiClaimedThisMonth: "Reclamado este mês",
    bankUbiPubBalance: "Carteira do PUB disponível para o RBU",
    bankNoPubAddress: "O PUB do RBU ainda não publicou um endereço ECOin.",
    bankUbiTab: "RBU",
    bankDonateEco: "DOAR!",
    donateTooltip: "Doar ECOin",
    bankNoUserAddress: "Este habitante não partilha um endereço ECOin.",
    bankUbiPubDefault: "Predefinido",
    bankUbiPool: "Dote",
    bankUbiLastSeen: "Visto pela última vez",
    bankUbiLastPayout: "Última ação",
    bankUbiPaidOut: "Distribuído",
    bankRangeToday: "Hoje",
    bankRangeWeek: "Semana",
    bankRangeMonth: "Mês",
    bankRangeYear: "Ano",
    bankRangeFiveYears: "5 anos",
    bankRangeAll: "Tudo",
    bankChartValueTitle: "Evolução do valor de ECOin",
    bankChartValueHours: "Equivalência em tempo (h)",
    bankChartWealthTitle: "Redistribuição da riqueza ECOin",
    bankChartDistributed: "RBU distribuído (ECO)",
    bankChartTaxes: "Impostos retidos (ECO)",
    bankChartNoDataRange: "Sem dados neste intervalo.",
    bankChartNoDataYet: "Ainda sem dados",
    bankChartPerHour: "por hora",
    bankChartPerDay: "por dia",
    bankChartPerMonth: "por mês",
    bankTotalUbiDistributed: "RBU total redistribuído (rede)",
    bankTotalTaxesWithheld: "Impostos totais retidos (rede)",
    bankInflationIssuance: "Taxa de emissão (anual, pela recompensa de bloco)",
    bankRulesEligibilityTitle: "Quem pode receber o RBU",
    bankRulesEligibility1: "Um endereço ECOin publicado no perfil (Perfil → Sensores → Carteira ECOin).",
    bankRulesEligibility2: "Um feed com mais de 30 dias e atividade na rede: karma acima de zero.",
    bankRulesEligibility3: "Uma reclamação por mês (epoch), em Banking com o botão Reclamar RBU. O mês em curso pode recusar-se com Recusar RBU.",
    bankRulesEligibility4: "O mínimo de 1 ECO paga-se sempre; os impostos só reduzem a parte acima dele e nunca se cobram à parte.",
    bankRulesEligibility5: "O PUB paga no ciclo seguinte e publica um transfer RBU que podes confirmar.",
    bankRulesEligibility6: "Se falta o endereço, o feed é demasiado novo, recusaste o mês ou o PUB não tem fundos, a reclamação é ignorada e registada no PUB.",
    copyLinkTitle: "Copiar ligação",
    linkBoxOasis: "Oasis",
    linkBoxClearnet: "Clearnet",
    bankRefuseUBI: "Recusar RBU",
    bankUbiRefusedThisMonth: "Recusaste o RBU deste mês.",
    bankingBotUbiAvailableTitle: "Podes reclamar o teu RBU.",
    bankingBotUbiAvailableText: "O teu RBU deste mês está disponível",
    bankingBotConfirmTitle: "Tens um smart-contract pendente de confirmação",
    bankingBotConfirmText: "Smart-contracts à espera da tua confirmação",
    bankChartZoomHint: "Clica para ampliar",
    bankChartPoolTitle: "Dote do RBU (ao longo do tempo)",
    bankChartNetworkUbiTitle: "RBU total redistribuído (rede)",
    bankChartSupplyTitle: "Oferta circulante de ECOin (ao longo do tempo)",
    bankChartInflationTitle: "Inflação de ECOin (ao longo do tempo)",
    bankChartInflationSeries: "Taxa anualizada (%)",
    bankChartPool: "Dote total (ECO)",
    bankChartKarmaTitle: "KARMA Scoring (ao longo do tempo)",
    bankChartFundsTitle: "Os seus fundos ECOin (ao longo do tempo)",
    bankChartKarma: "Karma",
    bankWalletReady: "ECOin ligado",
    bankWalletNotConfigured: "ECOin desligado",
    ...
    walletDisconnectButton: "Desligar carteira",
    cipher: "Encriptação",
    ...
    bookmarkSearchPlaceholder: "Pesquisar em Marcadores...",
    ...
    videoSearchPlaceholder: "Pesquisar em Vídeos...",
    ...
    documentSearchPlaceholder: "Pesquisar em Documentos...",
    ...
    tagsPlaceholder: "Introduz tags separadas por vírgulas",
    ...
    audioSearchPlaceholder: "Pesquisar em Áudios...",
    ...
    favoritesSearchPlaceholder: "Pesquisar em Favoritos...",
    ...
    searchInhabitantsPlaceholder: "Pesquisar em Habitantes...",
    ...
    parliamentSeatsOpposition: "Oposição",
    parliamentSeatsAbstention: "Abstenção",
    parliamentSeatsQuorum: "Quórum de eleição",
    parliamentSeatsPass: "Limiar de aprovação",
    parliamentSeatsByElection: "Por eleição",
    parliamentSeatsByHouses: "Por casa do LARP",
    parliamentSeatsSeats: "assentos",
    parliamentSeatsSeat: "assento",
    parliamentSeatsLeader: "Líder",
    parliamentSeatsVotesFor: "votos para",
    parliamentSeatsNoHouse: "Sem casa",
    ...
    parliamentViewReport: "Ver relatório",
    ...
    parliamentRulesHemicycle: "O hemiciclo atribui um assento por habitante: o bloco do governo (os eleitores da candidatura vencedora e o líder), um bloco de oposição por cada outra candidatura do ciclo, e a abstenção. As marcas tracejadas mostram o quórum de eleição (25 % do censo) e o limiar de aprovação do método em vigor. \"Por casa do LARP\" colore os mesmos assentos por casa.",
    ...
    podcastEpisodeButton: "EPISÓDIO",
    campaignButton: "CAMPANHA",
    logisticsRouteButton: "ROTA",
    ...
    taskSearchPlaceholder: "Pesquisar em Tarefas...",
    ...
    eventSearchPlaceholder: "Pesquisar em Eventos...",
    eventPrice: "Preço",
    eventStatus: "Estado",
    ...
    tagsSearchPlaceholder: "Pesquisar em Tags...",
    ...
    transfersFilterMinePending: "PENDENTES",
    transfersFilterMineConfirmed: "ASSINADOS",
    ...
    transfersSearchPlaceholder: "Pesquisar em Transferências...",
    ...
    commentsGoToLast: "Ir para o último comentário",
    ...
    dataSearchPlaceholder: "Pesquisar em Correspondências...",
    ...
    dataReasonFollowing: "Apoias este habitante",
    dataReasonTribe: "Partilha uma tribo contigo",
    dataReasonPinned: "Coincide com algo que fixaste",
    dataReasonCv: "Coincide com as competências do teu CV",
    dataReasonContent: "Relacionado com o que publicas",
    dataReasonRelated: "Relacionado com os teus interesses",
    dataReasonAlike: "Publicado por um habitante afim a ti",
    dataReasonSupportsYou: "Apoia-te",
    dataReasonMutual: "Apoio mútuo",
    dataReasonRated: "Bem avaliado pela rede",
    dataReasonNear: "Perto de ti",
    dataStatPeople: "CVs",
    ...
    pollSearchPlaceholder: "Pesquisar em Sondagens...",
    ...
    blogSearchPlaceholder: "Pesquisar em Blogs...",
    ...
    forumSearchPlaceholder: "Pesquisar em Fóruns...",
    ...
    imageSearchPlaceholder: "Pesquisar em Imagens...",
    ...
    feedSearchPlaceholder: "Pesquisar em Feed...",
    feedTitle:        "Feed",
    ...
    typeTop: "TOP",
    typePost:             "BLOG",
    activityUpdateLabel: "ATUALIZAÇÃO",
    typeTribe:            "TRIBOS",
    typeLarp: "L.A.R.P.",
    ...
    reportsSearchPlaceholder: "Pesquisar em Relatórios...",
    ...
    searchTribesPlaceholder:  "Pesquisar em Tribos...",
    ...
    subscriptionTitle: "Subscrições",
    subscriptionOn: "Subscrito",
    subscriptionOff: "Não subscrito",
    subscriptionSubscribe: "Subscrever",
    subscriptionUnsubscribe: "Cancelar subscrição",
    subscriptionSubscribers: "Subscritores",
    pmListLabel: "Enviar para",
    pmListNone: "— Sem lista —",
    pmListNoSubscribers: "Sem subscritores",
    ...
    agendaSearchPlaceholder: "Pesquisar em Agenda...",
    ...
    privateDescription: "Gere as tuas mensagens privadas.",
    ...
    bankingDescription: "A economia coletiva de ECOin.",
    ...
    bankYourFundsMonth: "Fundos totais",
    bankIndustryBalance: "Produção industrial",
    ...
    bankAddAddressLabelPlaceholder: "Carteira do Bob, loja da Alice…",
    bankAddAddressUserOptional: "Oasis ID (opcional)",
    bankAddressUnnamed: "Endereço sem nome",
    ...
    shopSearchPlaceholder: "Pesquisar em Lojas...",
    shopUrl: "URL",
    ...
    shopTagsPlaceholder: "Introduz tags separadas por vírgulas",
    ...
    bankTotalSupply: "Oferta ECOin total",
    bankPubsSupply: "Oferta ECOin da reserva dos PUBs",
    bankHoldingSupply: "Oferta ECOin fora do RBU",
    bankEcoinHours: "Equivalência ECOin em tempo (1 ECO)",
    ...
    bankCurrentSupply: "Oferta ECOin atual",
    bankingSyncStatus: 'ECOin Status',
    bankingSyncStatusSynced: 'Synced',
    bankingSyncStatusOutdated: "Não sincronizado",
    ...
    walletAddressCopyHint: "Clica para selecionar e copiar",
    ...
    aiServerError: "Não consigo responder bem. Tenta de novo.",
    aiStatusLoading: "42 está a carregar o modelo. Pergunta de novo dentro de momentos.",
    aiThinking: "A pensar",
    aiWaiting: "À espera",
    aiStatusMissingModel: "O modelo de IA não está instalado: falta src/AI/oasis-42-1-chat.Q4_K_M.gguf.",
    aiExportFineTuning: "Exportar Fine-Tuning",
    aiFactsTitle: "Dados da tua rede",
    ...
    marketSearchPlaceholder: "Pesquisar em Mercado...",
    ...
    housingSearchPlaceholder: "Pesquisar em Habitação...",
    ...
    jobsSearchPlaceholder: "Pesquisar em Empregos...",
    ...
    industrySearchPlaceholder: "Pesquisar em Indústria...",
    ...
    projectSearchPlaceholder: "Pesquisar em Projetos...",
    ...
    modulesBankingDescription: "Módulo para gerir o tesouro comum: valor do ECOIN, impostos e RBU.",
    ...
    errorNoAllocation: "Nenhuma alocação encontrada para esta reivindicação.",
    errorInvalidClaim: "Esta alocação não pode ser reivindicada.",
    ...
    mapTagsLabel: "Tags",
    mapTagsPlaceholder: "Introduz tags separadas por vírgulas",
    ...
    mapSearchPlaceholder: "Pesquisar em Mapas...",
    ...
    modulesEmergenciesLabel: "Emergências",
    modulesEmergenciesDescription: "Módulo para lançar, confirmar e seguir emergências na rede.",
    emergenciesDescription: "Módulo para lançar, confirmar e seguir emergências na rede.",
    emergencyCreate: "Criar emergência",
    emergencyUpdate: "Atualizar",
    emergencyDelete: "Apagar",
    emergencyTitleLabel: "Título",
    emergencyTitlePlaceholder: "O que está a acontecer?",
    emergencyTextLabel: "Detalhes",
    emergencyTextPlaceholder: "Onde, desde quando, o que fazer...",
    emergencyCategoryLabel: "Categoria",
    emergencyCategoryWeather: "METEOROLOGIA",
    emergencyCategoryInfrastructure: "INFRAESTRUTURA",
    emergencyCategoryHealth: "SAÚDE",
    emergencyCategorySecurity: "SEGURANÇA",
    emergencyCategoryLost: "PERDIDOS E ACHADOS",
    emergencyCategoryNeighborhood: "VIZINHANÇA",
    emergencyExpiresLabel: "Expira em",
    emergencyExpires1d: "1 dia",
    emergencyExpires3d: "3 dias",
    emergencyExpires7d: "1 semana",
    emergencyExpires30d: "1 mês",
    emergencyExpiresNone: "Indefinido",
    emergencyExpiresKeep: "Manter a data atual",
    emergencyTagsLabel: "Etiquetas",
    emergencyTagsPlaceholder: "Introduz tags separadas por vírgulas",
    emergencyFilterAll: "TODOS",
    emergencyFilterMine: "MEUS",
    emergencyFilterRecent: "RECENTES",
    emergencySeverityUnverified: "NÃO VERIFICADO",
    emergencySeverityLow: "BAIXA",
    emergencySeverityMedium: "MÉDIA",
    emergencySeverityHigh: "ALTA",
    emergencyStatusActive: "ATIVO",
    emergencyStatusResolved: "RESOLVIDO",
    emergencyStatusExpired: "EXPIRADO",
    emergencyConfirmations: "Confirmações",
    emergencyConfirmButton: "Confirmar",
    emergencyConfirmed: "Confirmaste esta emergência",
    emergencyResolveButton: "Resolver",
    emergencyReopenButton: "Reabrir",
    emergencyGenerateReport: "Gerar relatório",
    emergencyUpdateEdited: "Editada",
    emergencyLastUpdate: "ÚLTIMA ATUALIZAÇÃO",
    emergencyUpdatesTitle: "Últimas atualizações:",
    emergencyNoUpdates: "Ainda sem atualizações.",
    emergencyAddUpdate: "Publicar atualização",
    emergencyUpdatePlaceholder: "O que mudou?",
    emergencyNoItems: "Nenhuma emergência encontrada.",
    emergencyExpiresAt: "Expira",
    emergencyBannerLabel: "Emergência ativa",
    emergencyCreateSectionTitle: "Criar emergência",
    emergencyUpdateSectionTitle: "Atualizar emergência",
    emergencySearchPlaceholder: "Pesquisar em emergências...",
    typeEmergency: "EMERGÊNCIAS",
    typeEmergencyConfirm: "CONFIRMAÇÃO DE EMERGÊNCIA",
    typeEmergencyUpdate: "ATUALIZAÇÃO DE EMERGÊNCIA",
    statsEmergency: "Emergências",
    statsEmergencyConfirm: "Confirmações de emergências",
    statsEmergencyUpdate: "Atualizações de emergências",
    pmBotEmergencies: "EmergencyBot",
    emergencyBotUpdatedTitle: "Uma emergência que segues tem uma atualização.",
    emergencyBotResolvedTitle: "Uma emergência que segues foi resolvida.",
    dataKindEmergencies: "EMERGÊNCIAS",
    mailingTitle: "Listas de correio",
    modulesMailingLabel: "Listas de correio",
    modulesMailingDescription: "Descobre e gere listas de correio na tua rede.",
    mailingDescription: "Descobre e gere listas de correio na tua rede.",
    mailingCreate: "Criar lista de correio",
    mailingUpdate: "Atualizar",
    mailingDelete: "Eliminar",
    mailingArchive: "Arquivar",
    mailingActivate: "Ativar",
    mailingCreateSectionTitle: "Criar lista de correio",
    mailingUpdateSectionTitle: "Atualizar lista de correio",
    mailingTitleLabel: "Título",
    mailingTitlePlaceholder: "Nome da lista de correio",
    mailingDescriptionLabel: "Descrição",
    mailingDescriptionPlaceholder: "Sobre o que é esta lista?",
    mailingTypeLabel: "Tipo de lista de correio",
    mailingTypeOpen: "ABERTA",
    mailingTypeClosed: "FECHADA",
    mailingStatusLabel: "Estado",
    mailingStatusActive: "ATIVA",
    mailingStatusArchived: "ARQUIVADA",
    mailingMembersLabel: "Convidar habitantes",
    mailingMembersPlaceholder: "@id1.ed25519, @id2.ed25519, ...",
    mailingSubscribers: "Subscritores",
    mailingTagsLabel: "Etiquetas",
    mailingTagsPlaceholder: "Introduz tags separadas por vírgulas",
    mailingFilterAll: "TODAS",
    mailingFilterMine: "MINHAS",
    mailingFilterSubscribed: "SUBSCRITAS",
    mailingFilterRecent: "RECENTES",
    mailingHistoryDate: "DATA",
    mailingHistoryThreads: "TÓPICOS",
    mailingHistoryInhabitants: "HABITANTES",
    mailingHistorySearchPlaceholder: "Pesquisar no histórico...",
    mailingNoMessages: "Ainda não há mensagens.",
    mailingNoItems: "Nenhuma lista de correio encontrada.",
    mailingSearchPlaceholder: "Pesquisar em listas de correio...",
    mailingWriteButton: "Escrever mensagem",
    mailingWriteTitle: "Escrever à lista",
    mailingReplyTitle: "Responder à lista",
    mailingSend: "Enviar",
    mailingTextPlaceholder: "A tua mensagem chega a todos os participantes da lista.",
    mailingParticipants: "Participantes",
    inboxFilterMailing: "Listas de correio",
    mailingReplyPlaceholder: "Responder à lista...",
    mailingReplyToList: "Responder à lista",
    typeMailingList: "LISTA DE CORREIO",
    statsMailingList: "Listas de correio",
    mailingListLabel: "LISTA DE CORREIO",
    logisticsTitle: "Logística",
    modulesLogisticsLabel: "Logística",
    modulesLogisticsDescription: "Descobre e gere planos logísticos na tua rede.",
    logisticsDescription: "Descobre e gere planos logísticos na tua rede.",
    logisticsCreate: "Criar rota",
    logisticsUpdate: "Atualizar",
    logisticsDelete: "Eliminar",
    logisticsClose: "Fechar",
    logisticsReopen: "Reabrir",
    logisticsCreateSectionTitle: "Criar rota",
    logisticsUpdateSectionTitle: "Atualizar rota",
    logisticsTitleLabel: "Título",
    logisticsTitlePlaceholder: "Viagem ao mercado, carrinha disponível...",
    logisticsKindLabel: "Tipo de logística",
    logisticsKindTrip: "VIAGEM",
    logisticsKindShipment: "ENVIO",
    logisticsKindTrips: "VIAGENS",
    logisticsKindShipments: "ENVIOS",
    logisticsModeLabel: "Modo",
    logisticsModeOffer: "OFEREÇO",
    logisticsModeRequest: "PROCURO",
    logisticsModeOffers: "OFERTAS",
    logisticsModeRequests: "PEDIDOS",
    logisticsDescriptionLabel: "Descrição",
    logisticsDescriptionPlaceholder: "Ponto de encontro, o que levas, condições...",
    logisticsOriginLabel: "Origem",
    logisticsOriginPlaceholder: "Onde começa",
    logisticsDestinationLabel: "Destino",
    logisticsDestinationPlaceholder: "Onde termina",
    logisticsDateLabel: "Data e hora",
    logisticsRecurrenceLabel: "Recorrência",
    logisticsFrequencyLabel: "Frequência",
    logisticsRecurrenceNone: "ÚNICA",
    logisticsRecurrenceDaily: "DIÁRIA",
    logisticsRecurrenceWeekly: "SEMANAL",
    logisticsRecurrenceMonthly: "MENSAL",
    logisticsSeatsLabel: "Lugares",
    logisticsSizeLabel: "Tamanho",
    logisticsSizePlaceholder: "p. ex. 2m x 1m",
    logisticsWeightLabel: "Peso",
    logisticsWeightPlaceholder: "p. ex. 40kg",
    logisticsPriceFree: "GRÁTIS",
    logisticsPriceEco: "ECO",
    logisticsPriceTime: "TEMPO",
    logisticsPriceLabel: "Preço",
    logisticsHours: "h",
    logisticsOrderRefLabel: "Ligação ao pedido",
    logisticsOrderRefPlaceholder: "/shops/... ou /market/... do pedido a entregar",
    logisticsOrderLink: "Pedido ligado",
    logisticsTagsLabel: "Etiquetas",
    logisticsTagsPlaceholder: "Introduz tags separadas por vírgulas",
    logisticsFilterAll: "TODAS",
    logisticsFilterMine: "MINHAS",
    logisticsFilterBooked: "RESERVADAS",
    logisticsFilterRecent: "RECENTES",
    logisticsFilterHistory: "HISTÓRICO",
    logisticsFilterTop: "TOP",
    logisticsStatusOpen: "ABERTA",
    logisticsStatusUpcoming: "PRÓXIMAS",
    logisticsStatusPast: "PASSADAS",
    logisticsStatusClosed: "FECHADAS",
    logisticsZoneLabel: "Zona",
    logisticsSearchPlaceholder: "Pesquisar em logística...",
    logisticsNoItems: "Nenhuma rota encontrada.",
    logisticsBookingPending: "PENDENTE",
    logisticsBookingConfirmed: "CONFIRMADA",
    logisticsBookingRejected: "RECUSADA",
    logisticsBookingCancelled: "CANCELADA",
    logisticsBookingDelivered: "ENTREGUE",
    logisticsConfirm: "Confirmar",
    logisticsReject: "Recusar",
    ...
    logisticsBookTitle: "Reservar esta rota",
    logisticsNotesLabel: "Notas",
    logisticsNotesPlaceholder: "O que o responsável deve saber",
    logisticsBook: "Reservar",
    logisticsBookingsTitle: "Reservas",
    logisticsMyBookingTitle: "A tua reserva",
    logisticsRatingsTitle: "Avaliações",
    logisticsNoRatings: "Ainda não há avaliações.",
    logisticsRatingsWhenClosed: "As avaliações abrem quando a rota fecha.",
    logisticsScoreLabel: "Pontuação",
    logisticsRatingPlaceholder: "Como correu?",
    logisticsRate: "Avaliar",
    typeLogisticsRoute: "ROTA",
    typeLogisticsRating: "AVALIAÇÃO DE ROTA",
    statsLogisticsRoute: "Rotas",
    statsLogisticsRating: "Avaliações de rotas",
    logisticsRouteLabel: "ROTA",
    podcastsTitle: "Podcasts",
    modulesPodcastsLabel: "Podcasts",
    modulesPodcastsDescription: "Módulo para publicar canais de podcast.",
    podcastsDescription: "Módulo para publicar canais de podcast.",
    podcastCreate: "Criar podcast",
    podcastUpdate: "Atualizar",
    podcastDelete: "Eliminar",
    podcastCreateSectionTitle: "Criar podcast",
    podcastUpdateSectionTitle: "Atualizar podcast",
    podcastTitleLabel: "Título",
    podcastTitlePlaceholder: "Nome do canal",
    podcastDescriptionLabel: "Descrição",
    podcastDescriptionPlaceholder: "Sobre o que é este podcast?",
    podcastCategoryLabel: "Categoria",
    podcastCategoryNews: "NOTÍCIAS",
    podcastCategoryMusic: "MÚSICA",
    podcastCategoryTalk: "CONVERSA",
    podcastCategoryEducation: "EDUCAÇÃO",
    podcastCategoryTech: "TECNOLOGIA",
    podcastCategoryCulture: "CULTURA",
    podcastCategoryCommunity: "COMUNIDADE",
    podcastCategoryOasis: "OASIS",
    podcastCategoryOther: "OUTROS",
    podcastTagsLabel: "Etiquetas",
    podcastTagsPlaceholder: "Introduz tags separadas por vírgulas",
    podcastFilterAll: "TODOS",
    podcastFilterMine: "MEUS",
    podcastFilterRecent: "RECENTES",
    podcastFilterTop: "TOP",
    podcastFilterViewers: "OUVINTES",
    podcastSearchPlaceholder: "Pesquisar em podcasts...",
    podcastNoItems: "Nenhum podcast encontrado.",
    podcastEpisodesLabel: "Episódios",
    podcastPlaysLabel: "Visualizações",
    podcastLastEpisode: "Último episódio",
    podcastEpisodesTitle: "Episódios",
    podcastNoEpisodes: "Ainda não há episódios.",
    podcastEpisodeAdd: "Adicionar episódio",
    podcastEpisodeCreateTitle: "Publicar episódio",
    podcastEpisodeUpdateTitle: "Atualizar episódio",
    podcastEpisodeTitleLabel: "Título do episódio",
    podcastEpisodeTitlePlaceholder: "Título do episódio",
    podcastEpisodeDescriptionLabel: "Notas",
    podcastEpisodeDescriptionPlaceholder: "O que acontece neste episódio, ligações, créditos...",
    podcastEpisodePublish: "Publicar",
    podcastPlayed: "Reproduzido",
    podcastMarkPlayed: "Marcar como reproduzido",
    typePodcast: "PODCAST",
    typePodcastEpisode: "EPISÓDIO",
    typePodcastOpinion: "OPINIÃO DO EPISÓDIO",
    typePodcastPlay: "REPRODUÇÃO",
    statsPodcast: "Podcasts",
    statsPodcastEpisode: "Episódios",
    statsPodcastPlay: "Reproduções",
    pmBotPodcasts: "PodcastBot",
    pmBotBlogs: "BlogsBot",
    blogBotNewTitle: "Um blog que segues tem uma nova entrada.",
    podcastBotEpisodeTitle: "Um podcast que segues tem um novo episódio.",
    podcastLabel: "PODCAST",
    podcastEpisodeLabel: "EPISÓDIO",
    campaignsTitle: "Campanhas",
    modulesCampaignsLabel: "Campanhas",
    modulesCampaignsDescription: "Descobre e gere campanhas na tua rede.",
    campaignsDescription: "Descobre e gere campanhas na tua rede.",
    campaignCreate: "Criar campanha",
    campaignUpdate: "Atualizar",
    campaignDelete: "Eliminar",
    campaignClose: "Fechar",
    campaignReopen: "Reabrir",
    campaignCreateSectionTitle: "Criar campanha",
    campaignUpdateSectionTitle: "Atualizar campanha",
    campaignTitleLabel: "Título",
    campaignTitlePlaceholder: "O que queres alcançar?",
    campaignTextLabel: "Texto",
    campaignTextPlaceholder: "Explica a causa, quem decide e o que pedes...",
    campaignCategoryLabel: "Categoria",
    campaignCategoryEnvironment: "AMBIENTE",
    campaignCategoryRights: "DIREITOS",
    campaignCategoryHealth: "SAÚDE",
    campaignCategoryEducation: "EDUCAÇÃO",
    campaignCategoryInfrastructure: "INFRAESTRUTURA",
    campaignCategoryCulture: "CULTURA",
    campaignCategoryEconomy: "ECONOMIA",
    campaignCategoryOther: "OUTROS",
    campaignGoalLabel: "Objetivo de assinaturas",
    campaignDeadlineLabel: "Prazo",
    campaignTagsLabel: "Etiquetas",
    campaignTagsPlaceholder: "Introduz tags separadas por vírgulas",
    campaignFilterAll: "TODAS",
    campaignFilterMine: "MINHAS",
    campaignFilterSigned: "ASSINADAS",
    campaignFilterRecent: "RECENTES",
    campaignFilterTop: "TOP",
    campaignStatusOpen: "ABERTA",
    campaignStatusAchieved: "ALCANÇADA",
    campaignStatusUnachieved: "NÃO ALCANÇADA",
    campaignStatusClosed: "FECHADA",
    campaignSearchPlaceholder: "Pesquisar em campanhas...",
    campaignNoItems: "Nenhuma campanha encontrada.",
    campaignSignaturesLabel: "Assinaturas",
    campaignSignaturesTitle: "Apoiantes",
    campaignNoSignatures: "Ainda não há assinaturas.",
    campaignSignTitle: "Assinar esta campanha",
    campaignSignPlaceholder: "Porque a apoias? (opcional)",
    campaignSign: "Assinar",
    campaignSigned: "Já assinaste!",
    campaignNotSigned: "Ainda falta a tua assinatura",
    campaignElevate: "Levar ao Parlamento",
    campaignElevated: "Levada ao Parlamento",
    campaignUpdatesTitle: "Atualizações",
    campaignNoUpdates: "Ainda não há atualizações.",
    campaignUpdatePlaceholder: "O que aconteceu?",
    campaignAddUpdate: "Publicar atualização",
    campaignQrAlt: "QR para assinar esta campanha",
    campaignQrCaption: "Digitaliza para assinar",
    typeCampaign: "CAMPANHA",
    typeCampaignSignature: "ASSINATURA",
    typeCampaignUpdate: "ATUALIZAÇÃO DE CAMPANHA",
    statsCampaign: "Campanhas",
    statsCampaignSignature: "Assinaturas de campanhas",
    statsCampaignUpdate: "Atualizações de campanhas",
    pmBotCampaigns: "CampaignBot",
    campaignBotUpdatedTitle: "Uma campanha que segues tem uma atualização.",
    campaignBotAchievedTitle: "Uma campanha que segues atingiu o objetivo.",
    campaignBotRaisedTitle: "Uma campanha que assinaste foi levada ao Parlamento.",
    pmBotLogistics: "LogisticsBot",
    logisticsBotUpdatedTitle: "Uma rota que reservaste mudou.",
    logisticsBotClosedTitle: "Uma rota que reservaste foi fechada.",
    logisticsBotBookedTitle: "Alguém reservou a tua rota.",
    logisticsBotCancelledTitle: "Uma reserva na tua rota foi cancelada.",
    logisticsBotConfirmedTitle: "A tua reserva foi confirmada: o pacote está a caminho.",
    logisticsBotRejectedTitle: "A tua reserva foi rejeitada.",
    logisticsBotDeliveredTitle: "O teu pacote chegou.",
    campaignLabel: "CAMPANHA",
    campaignGenerateReport: "Gerar relatório",
    logisticsGenerateReport: "Gerar relatório",
    mailingGenerateReport: "Gerar relatório",
    campaignUpdateEdited: "Editada",
    mailingMessagesLabel: "Mensagens",
    logisticsBookingsLabel: "Reservas",
    backupTitle: "Cópia de segurança",
    modulesBackupLabel: "Cópia de segurança",
    modulesBackupDescription: "Módulo para exportar e importar as tuas chaves e fazer cópias de segurança cifradas.",
    backupDescription: "Módulo para exportar e importar as tuas chaves e fazer cópias de segurança cifradas.",
    backupKitWarning: "Qualquer pessoa que leia esta página pode agir como tu. Nunca a partilhes!",
    backupTypeRecovery: "RECUPERAÇÃO",
    backupTypeKeys: "EXPORTAR CHAVES",
    backupTypeFull: "CÓPIA COMPLETA",
    backupTypeRestore: "RESTAURAR CÓPIA",
    backupTypeInstant: "INSTANTÂNEA",
    backupInstantDescription: "Um .zip simples de todo o teu registo e ficheiros, sem a tua chave secreta e sem palavra-passe. Rápido, mas quem tiver o ficheiro lê tudo.",
    backupInstantWarning: "Esta cópia não vai cifrada. Guarda-a num sítio seguro.",
    backupKitPageDescription: "O kit de recuperação só pode ser aberto a partir deste dispositivo.",
    backupKitId: "ID Oasis",
    backupKitDate: "Gerado",
    backupKitQrAlt: "Código QR da tua chave secreta",
    backupKitStep1: "Imprime-o ou copia-o à mão e guarda-o num lugar seguro e offline.",
    backupKitStep2: "Para recuperar, instala o Oasis num dispositivo novo e importa este segredo em Cópia de segurança › Chaves.",
    backupKitStep3: "Destrói esta página se alguma vez ficar exposta.",
    backupKitPdfButton: "Gerar PDF",
    backupScopeLabel: "Âmbito",
    backupScopeAll: "TUDO",
    backupScopeMine: "SÓ O MEU CONTEÚDO",
    backupSinceLabel: "Desde",
    backupEstimateTitle: "Estimativa",
    backupFileInfo: "A tua cópia cifrada será descarregada para o teu dispositivo (nome: oasis-backup-DATA.oasisbk)",
    backupExportButton: "Descarregar cópia",
    backupRestorePassword: "Escreve a palavra-passe usada ao fazer a cópia",
    backupRestoreButton: "Restaurar cópia",
    backupRestoredLine: "Cópia restaurada.",
    backupRestoredMessages: "Mensagens adicionadas",
    backupRestoredSkipped: "Já existentes",
    backupRestoredBlobs: "Ficheiros adicionados",
    backupRestoredState: "Configurações restauradas",
    backupRestoredFailed: "Falhados",
    backupRestoredForked: "Divergentes",
    backupRestoreRunning: "Restaurando a cópia. Esta página atualiza-se sozinha; entretanto podes continuar a usar o Oasis.",
    backupRestoreElapsed: "Decorrido",
    backupRestoreFailedLine: "Não foi possível restaurar a cópia.",
    backupRestoreForkMine: "Este dispositivo já publicou mensagens com a tua identidade que não estão na cópia, por isso não foi possível aplicá-la por cima. Restaura numa instalação limpa logo após importar as tuas chaves, antes de fazer qualquer outra coisa.",
    verificationTitle: "Verificação",
    verificationDescription: "Verifica a cadeia do teu feed, deteta bifurcações e revê ficheiros órfãos ou em falta.",
    verificationRun: "Executar verificação",
    verificationTotalMessages: "mensagens no registo",
    verificationFeed: "O teu feed",
    verificationMessages: "mensagens",
    verificationLastSequence: "última sequência",
    verificationGaps: "Lacunas",
    verificationBrokenLinks: "Ligações quebradas",
    verificationBadHashes: "Hashes incorretos",
    verificationBadSignatures: "Assinaturas incorretas",
    verificationDuplicates: "Sequências duplicadas",
    verificationForks: "Bifurcações",
    verificationBlobs: "Ficheiros",
    verificationBlobsPresent: "presentes",
    verificationBlobsReferenced: "referenciados",
    verificationBlobsOrphan: "órfãos",
    verificationBlobsMissing: "em falta",
    verificationBlobsMissingOwn: "Ficheiros teus em falta neste dispositivo",
    verificationBlobsMissingOthers: "Ficheiros de outros habitantes ainda por descarregar",
    verificationBlobsUnavailable: "Não foi possível listar os ficheiros neste dispositivo.",
    wikiTitle: "Wikis",
    modulesWikiLabel: "Wikis",
    modulesWikiDescription: "Módulo para descobrir e gerir wikis.",
    wikiDescription: "Módulo para descobrir e gerir wikis.",
    wikiCreate: "Criar wiki",
    wikiUpdate: "Atualizar",
    wikiDelete: "Apagar",
    wikiEdit: "Editar",
    wikiTitleLabel: "Título",
    wikiTitlePlaceholder: "Título da wiki...",
    wikiBodyLabel: "Conteúdo",
    wikiBodyPlaceholder: "Liga outras wikis com [[Título da wiki]] ou [[Título da wiki|um texto próprio]].\n\nMenciona um habitante com @id.\n\nEtiqueta com #oasis.\n\nCola ligações como https://solarnethub.com\n\nUma linha em branco abre um novo parágrafo; as quebras de linha simples mantêm-se.\n\nAnexa qualquer media suportado e será incorporado aqui.",
    formatBarLabel: "Formato",
    wikiStatusLabel: "Tipo de wiki",
    wikiStatusOpen: "ABERTA",
    wikiStatusClosed: "FECHADA",
    wikiTagsLabel: "Etiquetas",
    wikiTagsPlaceholder: "Introduz tags separadas por vírgulas",
    wikiSummaryLabel: "Resumo da alteração",
    wikiSummaryPlaceholder: "O que mudou?",
    wikiFilterAll: "TODAS",
    wikiFilterMine: "MINHAS",
    wikiFilterRecent: "RECENTES",
    wikiFilterLinked: "LIGADAS",
    wikiChanges: "Alterações recentes",
    wikiNoPages: "Nenhuma wiki encontrada.",
    wikiNoChanges: "Ainda sem alterações.",
    wikiHistory: "Histórico",
    wikiVersion: "Versão",
    wikiVersions: "versões",
    wikiRestore: "Restaurar",
    wikiDiff: "Alterações",
    wikiViewVersion: "Ver",
    wikiLinkedPages: "Páginas ligadas",
    wikiNoLinkedPages: "Esta página ainda não está ligada a nenhuma outra.",
    wikiMissingLink: "A página ainda não existe",
    wikiDuplicateTitle: "Já existe uma página com este título. Muda o título para criar uma página diferente.",
    wikiCreateSectionTitle: "Criar wiki",
    wikiUpdateSectionTitle: "Atualizar wiki",
    wikiSearchPlaceholder: "Pesquisar na Wiki...",
    wikiCurrentVersion: "Versão atual",
    wikiViewingVersion: "Estás a ver uma versão antiga",
    wikiBackToPage: "Voltar à página",
    wikiLinkedChip: "Ligada",
    wikiRestoredSummary: "Versão restaurada",
    wikiExportPdf: "Gerar página",
    wikiPreview: "Pré-visualizar",
    tribeSectionWiki: "WIKI",
    tribeWikiCreate: "Criar wiki",
    tribeWikiEmpty: "Ainda sem wikis.",
    typeWiki: "WIKI",
    padsTitle: "Pads",
    padTitle: "Pad",
    ...
    padTagsLabel: "Tags",
    padTagsPlaceholder: "Introduz tags separadas por vírgulas",
    ...
    padSearchPlaceholder: "Pesquisar em Pads...",

    modulesChatsLabel: "Chats",
    modulesChatsDescription: "Módulo para descobrir e gerir chats.",
    typeChat: "CHATS",
    ...
    chatSearchPlaceholder: "Pesquisar em Chats...",
    ...
    activitySearchPlaceholder: "Pesquisar em Atividade...",
    trendingSearchPlaceholder: "Pesquisar em Tendências...",
    opinionsSearchPlaceholder: "Pesquisar em Opiniões...",
    votesSearchPlaceholder: "Pesquisar em Votações...",
    gamesSearchPlaceholder: "Pesquisar em Jogos...",
    schoolTitle: "Escola",
    pmBotWiki: "WikiBot",
    wikiBotEditedTitle: "Uma página wiki que segues foi editada.",
    wikiBotRestoredTitle: "Foi restaurada uma versão anterior de uma página wiki que segues.",
    ...
    schoolEnrollLabel: "Juntar-se ao curso",
    ...
    agendaFilterCampaigns: "CAMPANHAS",
    ...
    schoolTags: "Tags",
    schoolTagsPlaceholder: "Introduz tags separadas por vírgulas",
    ...
    schoolSearchPlaceholder: "Pesquisar em Escola...",
    ...
    schoolStudentPanel: "Painel do estudante",
    schoolAddLesson: "Criar lição",
    ...
    chatTagsPlaceholder: "Introduz tags separadas por vírgulas",
    ...
    calendarTagsPlaceholder: "Introduz tags separadas por vírgulas",
  ...
  calendarDeleteNote: "Delete",
    ...
    calendarSearchPlaceholder: "Pesquisar em Calendário...",
    ...
    torrentTagsPlaceholder: "Introduz tags separadas por vírgulas",
    torrentSizeLabel: "Tamanho",
    torrentDownloadButton: "DESCARREGAR!",
    torrentDetailsButton: "DETALHES",
    torrentNoFile: "Nenhum arquivo torrent",
    noTorrents: "Nenhum torrent encontrado.",
    torrentSearchPlaceholder: "Pesquisar em Torrents...",
    ...
    logsSearchText: "Pesquisar em Diário...",
    ...
    larpSearchPlaceholder: "Pesquisar em L.A.R.P....",
    larpAllHouses: "Casas:",
    ...
    indexingMessage: "O Oasis está a sincronizar uma rede enorme de habitantes. Aguarda um momento!",
    indexingRefreshNote: "Esta página recarrega a cada 10 segundos.",
    indexingTitle: "A sincronizar",
    ...
    ecoTaxLabel: "ECO Tax",
    bankTaxes: "Impostos",
    bankOverviewYourTaxes: "Impostos totais",
    ...
    modulesLarpDescription: "Módulo para a camada de jogo de papéis ao vivo.",
