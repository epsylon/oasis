...
module.exports = {
  en: {
    ...
    pmListLabel: "Massive PM",
    pmListNone: "— No list —",
    pmListNoSubscribers: "This Massive PM has no subscribers yet.",
    ...
    backupRestoreForkOthers: "Some feeds on this device diverge from the backup; their remaining messages were left untouched.",
    backupRestoreErrors: "Reasons",
