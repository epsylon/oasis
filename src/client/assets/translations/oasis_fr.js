...
module.exports = {
  fr: {
    ...
    shopOrderPaymentConcept: "Paiement",
    ...
    inhabitantProfileTitle: "Profil de l’habitant",
    ...
    feedViewDetails: "Voir les détails",
    eventFileLabel: "Joindre une image",
    taskFileLabel: "Joindre une image",
    courtsRespondentRequired: "L'identifiant du défendeur est requis",
    extended: "Multivers",
    extendedDescription: [
    ...
    searchInhabitantLabel: "Habitant (Oasis ID)",
    ...
    melodyCompositionHelp: 'Chaque bloc de ta blockchain devient une note musicale selon son type et sa taille.',
    melodyStatsTitle: 'Répartition par type',
    melodyInhabitantLabel: 'Habitant',
    melodyTotalBlocks: 'Notes',
    melodyType: 'Type',
    melodyCount: 'Blocs',
    melodyFilterAll: 'TOUTES',
    melodyFilterShare: 'Téléverser une mélodie',
    melodyShareTitle: 'Partage ta mélodie',
    melodyShareHelp: 'Publie un instantané de ta mélodie actuelle pour que d’autres puissent l’écouter et la remixer.',
    melodyShareTitleLabel: 'Titre (optionnel)',
    melodyShareTitlePlaceholder: 'Un fantôme de blockchain',
    melodyShareSubmit: 'Publier la mélodie',
    melodyNoShared: 'Aucune mélodie blockchain pour l’instant.',
    melodyRegenerate: 'Régénérer',
    melodyDownload: "Télécharger BCS",
    profileActivityTitle: 'Activité',
    profileActivityMore: 'Voir toute l’activité',
    ...
    profileHubAll: 'Tout',
    profileHubTitle: 'Contenu Public',
    footerPulseTitle: 'Pouls',
    footerPulsePeers: 'Pairs',
    footerPulseInbox: 'Boîte',
    footerPulseSync: 'Dernière sync',
    footerPulseEcoValue: 'ECO/h',
    footerPulseLastActivity: 'Dernière activité',
    footerLicenseLabel: 'Licence',
    profileSwitchToOasis: 'Retour à Oasis',
    profileSwitchToClearnet: 'Plonger dans le Clearnet',
    profileVisibilityFediverse: "Fediverse",
    profileSwitchToFediverse: "Plonger dans le fédiverse",
    ...
    fediverse: "Fediverse",
    fediverseDescription: "Gérez vos autres comptes du fédiverse, y compris l'envoi et la réception de contenu.",
    fediverseStatus: "Statut",
    fediverseDisconnected: "Fédiverse déconnecté. Vérifiez %LINK% ou l'état de la connexion.",
    ...
    fediverseEmpty: "Lorsque vous connectez d'autres comptes du fédiverse depuis %LINK%, vous pouvez les gérer ici.",
    ...
    unknown: 'Inconnus',
    lanBroadcastLabel: "Diffusion LAN",
    lanBroadcastActive: "Active (multicast UDP sur le LAN)",
    lanBroadcastDisabled: "Désactivée (mode pub)",
    peerSourceRpc: "RPC",
    ...
    profileQrAlt: "Code QR du profil",
    profileQrHint: "Scannez pour copier cet identifiant Oasis.",
    ...
    profileVisibilityClearnet: "Publier mon profil",
    ...
    activityProfileUpdated: "a mis à jour son profil",
    typeAbout:            "HABITANTS",
    typeCurriculum:       "CVS",
    typeImage:            "IMAGES",
    ...
    pmTextPlaceholder: "Corps limité à 8096 caractères.",
    pmSubject: "Sujet",
    ...
    fileShareRecipientPlaceholder: "Saisir l'Oasis ID (@....ed25519)",
    ...
    shopClearnetPublish: "Publier sur le Clearnet",
    shopClearnetUnpublish: "Retirer du Clearnet",
    shopClearnetUrlLabel: "URL Clearnet",
    shopClearnetWarning: "Publier sur le Clearnet rend cette boutique indexable par les moteurs de recherche et robots externes.",
    ...
    jobsHoursOfferedPlaceholder: "ex. 4",
    jobsHoursRequestedPlaceholder: "ex. 4",
    jobsExchangeSkillPlaceholder: "ex. menuiserie, design",
    jobExchangeHint: "Pour les emplois en échange d’heures, remplissez les champs ci-dessous au lieu du salaire.",
    ...
    modulesFediverseDescription: "Gérez vos autres comptes du fédiverse, y compris l'envoi et la réception de contenu.",
    ...
    aiNavResultsTitle: "Suggestions de navigation IA",
    aiNavQueryLabel: "Requête",
    aiNavResultsDescription: "Choisissez l'itinéraire qui correspond le mieux à ce que vous cherchez.",
    aiNavResultPath: "Route",
    aiNavResultDescription: "Ce que vous pouvez y faire",
    aiNavResultMatch: "Correspondance",
    aiNavResultsEmpty: "Aucune route correspondante. Essayez /search.",
    aiNavSearchInstead: "Rechercher plutôt",
  ...
  calendarDeleteNote: "Delete",
    ...
    larpRulesEntryTitle: "Maison de départ",
    ...
    larpRulesLeaveText: "Les membres de toute maison peuvent retourner à ACADEMIA à tout moment depuis leur page de maison ; cela réinitialise leur appartenance mais ne lève pas le délai du test.",
    larpRulesGovernanceTitle: "Mur de gouvernance",
    ...
    larpRulesSignTitle: "Emblème L.A.R.P.",
    ...
    larpPostLabel: "Nouvelle publication",
    larpPostPlaceholder: "Qu'a cette maison à dire ?",
    larpPostPublic: "Public (visible par tous, sinon réservé aux membres)",
    larpPostSubmit: "Publier",
    larpPostMembersOnly: "Membres seulement",
    ...
    larpRulesInviteEntry: "Code d'invitation",
    ...
    larpRulesOneHouseTitle: "Une maison à la fois",
    larpRulesTestEntry: "Test WILL",
    larpRulesTestEntryText: "Chaque option pondère une ou plusieurs maisons ; lors de l'envoi, le système additionne les scores et t'admet automatiquement dans la maison ayant le score le plus élevé.",
    ...
    larpMembersTitle: "Membres",
    larpNoMembers: "Aucun membre pour le moment.",
    larpRolesLabel: "Rôles",
    larpFunctionLabel: "Fonction",
    larpMonthLabel: "Cycle de gouvernance",
    larpLeaveToAcademia: "Retour à ACADEMIA",
    larpAcademiaJoinTitle: "Rejoindre une maison",
    larpAcademiaJoinHint: "Passe le test psychologique de profil pour être affecté à la maison qui te correspond le mieux, ou utilise un code d'invitation partagé par un membre d'une maison.",
    larpTakeTestButton: "Passer le test de profil",
    ...
    larpTestAssignedHouse: "Maison attribuée",
    ...
    bankTaxesNetworkTitle: "Impôts du réseau",
    bankTaxesEcoTaxTitle: "ECO Tax",
    bankTaxesArchTaxTitle: "ARCH Tax",
    bankTaxesUserTitle: "Tes impôts",
    ...
    audioTranscodeStegoTitle: "Incrusté dans la forme d'onde",
    ...
    audioBackToAudio: "Retour à l'audio",
    audioBackToBcs: "Retour à BCS",
    audioAuthorLabel: "Auteur",
    ...
    larpLastAttemptResult: "Résultat",
    ...
    larpTestPassed: "Test réussi — bienvenue !",
    larpTestFailed: "Test non réussi",
    larpTestScore: "Score",
