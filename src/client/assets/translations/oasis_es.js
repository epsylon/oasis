...
module.exports = {
  es: {
    ...
    melodyCompositionTitle: 'Composición',
    ...
    shopOrdersDescription: "Pedidos cifrados recibidos por esta tienda.",
    ...
    modulesLarpDescription: "Módulo para la capa de role-playing en vivo de Oasis (las 9 Casas).",
