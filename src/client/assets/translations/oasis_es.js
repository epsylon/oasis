...
module.exports = {
  es: {
    ...
    searchCasesPlaceholder: "Buscar en Tribunales...",
    ...
    mentionsSearchPlaceholder: "Buscar en Menciones...",
    privateReminders: "RECORDATORIOS",
    inboxFilterPms: "PMs",
    inboxFilterNotifications: "Notificaciones",
    inboxMarkRead: "Marcar como leído",
    inboxMarkUnread: "Marcar como no leído",
    inboxUnreadChip: "No leído",
    inboxMarkAllRead: "Marcar todo como leído",
    inboxDeleteShown: "Borrar todo",
    inboxArchive: "Archivar",
    inboxUnarchive: "Desarchivar",
    inboxFilterArchived: "Archivados",
    inboxEarlierMessages: "mensajes anteriores",
    inboxSortThread: "Por hilo",
    inboxSortRecent: "Más recientes primero",
    inboxAllBots: "Bots",
    settingsInboxBotsTitle: "Notificaciones del Inbox",
    settingsInboxBotsDesc: "Elige qué bots pueden avisarte en tu Inbox. Los bots desmarcados se ocultan y sus avisos no se cuentan.",
    ...
    settingsDescription: "Configura el entorno de tu red.",
    ...
    inbox: "Buzón",
    inboxSearchPlaceholder: "Buscar en Buzón...",
    ...
    telegramSendCode: "Enviar código",
    telegramCodeHelp: "Introduce el código que Telegram te acaba de enviar (app o SMS).",
    telegramCodeLabel: "Código",
    telegramPasswordHelp: "Esta cuenta tiene verificación en dos pasos. Introduce tu contraseña.",
    telegramPasswordLabel: "Contraseña",
    telegramVerify: "Verificar",
    telegramCancel: "Cancelar",
    telegramChats: "Chats",
    telegramUnread: "Sin leer",
    telegramOpen: "Abrir",
    telegramSend: "Enviar",
    telegramYou: "Tú",
    telegramNoChats: "Todavía no hay chats.",
    telegramNoMessages: "Todavía no hay mensajes.",
    telegramComposePlaceholder: "Escribe un mensaje…",
    telegramChannel: "Canal",
    telegramGroup: "Grupo",
    telegramPrivate: "Privado",
    telegramErrConnect: "No se pudo contactar con Telegram.",
    telegramErrTimeout: "Telegram tardó demasiado en responder.",
    telegramErrAuth: "Sesión de Telegram inválida o caducada. Conéctala de nuevo.",
    telegramErrFetch: "No se pudieron cargar los chats.",
    telegramErrSend: "No se pudo enviar el mensaje.",
    telegramErrMissing: "Hacen falta API ID, API hash y número de teléfono.",
    telegramErrCode: "Código incorrecto. Inténtalo de nuevo.",
    telegramErrCodeExpired: "El código ha caducado. Empieza de nuevo.",
    telegramErrPassword: "Contraseña incorrecta.",
    telegramErrPhone: "Número de teléfono inválido.",
    telegramErrApi: "API ID o API hash inválidos.",
    telegramErrFlood: "Demasiados intentos. Espera un rato e inténtalo de nuevo.",
    telegramErrNoLogin: "No hay ningún inicio de sesión en curso. Empieza de nuevo.",
    ...
    dateInPastError: "La fecha no puede ser anterior a hoy",
    ...
    indexes: "Índices",
    indexesRebuilt: "Índices reconstruidos",
    indexesRebuildFailed: "No se han podido reconstruir los índices",
    indexesFiles: "Ficheros de índice",
    indexesDescription:
    ...
    profileClearnetMarketLabel: "Mercado",
    ...
    walletDescription: "Gestiona tu cartera ECOin.",
    walletDate: "Fecha",
    ...
    walletSend: "Enviar",
    walletPayingTransfer: "Pagando transfer",
    walletCreateTransferLabel: "Generar contrato (transfer)",
    walletTransferNotifiedNote: "Se ha avisado del pago a la otra parte",
    walletTransferCreatedNote: "Se ha creado un transfer (recibo) de este pago",
    walletTransferNoPayeeNote: "Ningún habitante ha publicado esta dirección, así que no se creó transfer",
    walletTransferReceiptConcept: "Pago desde el monedero",
    walletPaymentPmText: "te ha enviado un pago",
    walletPayeeLabel: "Destinatario",
    walletConceptLabel: "Concepto",
    pmBotBanking: "BankingBot",
    bankingBotUbiPaidTitle: "Has recibido tu RBU.",
    bankingBotPaymentTitle: "Has recibido un pago.",
    bankingBotUbiPaidText: "Tu Renta Básica Universal ha sido pagada",
    bankUbiPubThisNode: "Este nodo paga la RBU",
    bankUbiPubConnected: "PUB de la RBU",
    bankUbiPubNone: "No hay PUBs anunciando una RBU, de momento.",
    bankUbiAddressPublished: "Dirección ECOin publicada",
    bankUbiAddressMissing: "Publica tu dirección ECOin para recibir la RBU",
    bankUbiClaimedThisMonth: "Reclamada este mes",
    bankUbiPubBalance: "Cartera del PUB disponible para la RBU",
    bankNoPubAddress: "El PUB de la RBU aún no ha publicado una dirección ECOin.",
    bankUbiTab: "RBU",
    bankDonateEco: "¡DONAR!",
    donateTooltip: "Donar ECOin",
    bankNoUserAddress: "Este habitante no comparte una dirección ECOin.",
    bankUbiPubDefault: "Por defecto",
    bankUbiPool: "Asignación",
    bankUbiLastSeen: "Visto por última vez",
    bankUbiLastPayout: "Última acción",
    bankUbiPaidOut: "Repartido",
    bankRangeToday: "Hoy",
    bankRangeWeek: "Semana",
    bankRangeMonth: "Mes",
    bankRangeYear: "Año",
    bankRangeFiveYears: "5 años",
    bankRangeAll: "Todo",
    bankChartValueTitle: "Evolución del valor de ECOin",
    bankChartValueHours: "Equivalencia en tiempo (h)",
    bankChartWealthTitle: "Redistribución de riqueza ECOin",
    bankChartDistributed: "RBU repartida (ECO)",
    bankChartTaxes: "Impuestos retenidos (ECO)",
    bankChartNoDataRange: "Sin datos en este rango.",
    bankChartNoDataYet: "Todavía no hay datos",
    bankChartPerHour: "por hora",
    bankChartPerDay: "por día",
    bankChartPerMonth: "por mes",
    bankTotalUbiDistributed: "RBU total redistribuida (red)",
    bankTotalTaxesWithheld: "Impuestos totales retenidos (red)",
    bankInflationIssuance: "Tasa de emisión (anual, por recompensa de bloque)",
    bankRulesEligibilityTitle: "Quién puede recibir la RBU",
    bankRulesEligibility1: "Una dirección ECOin publicada en tu perfil (Perfil → Sensores → Cartera ECOin).",
    bankRulesEligibility2: "Un feed con más de 30 días y actividad en la red: karma por encima de cero.",
    bankRulesEligibility3: "Un reclamo por mes (epoch), desde Banking con el botón Reclamar RBU. Se puede rechazar la del mes en curso con Rechazar RBU.",
    bankRulesEligibility4: "El suelo de 1 ECO se paga siempre; los impuestos solo reducen la parte que lo supera y nunca se cobran aparte.",
    bankRulesEligibility5: "El PUB paga en su siguiente ciclo y publica un transfer RBU que puedes confirmar.",
    bankRulesEligibility6: "Si falta tu dirección, el feed es demasiado joven, rechazaste el mes o el PUB no tiene fondos, el reclamo se salta y queda registrado en el PUB.",
    copyLinkTitle: "Copiar enlace",
    linkBoxOasis: "Oasis",
    linkBoxClearnet: "Clearnet",
    bankRefuseUBI: "Rechazar RBU",
    bankUbiRefusedThisMonth: "Has rechazado la RBU de este mes.",
    bankingBotUbiAvailableTitle: "Puedes reclamar tu RBU.",
    bankingBotUbiAvailableText: "Tu RBU de este mes está disponible",
    bankingBotConfirmTitle: "Tienes un contrato pendiente de confirmación",
    bankingBotConfirmText: "Contratos pendientes de confirmación",
    bankChartZoomHint: "Clic para ampliar",
    bankChartPoolTitle: "Asignación de la RBU (en el tiempo)",
    bankChartNetworkUbiTitle: "RBU total redistribuida (red)",
    bankChartSupplyTitle: "Oferta circulante de ECOin (en el tiempo)",
    bankChartInflationTitle: "Inflación de ECOin (en el tiempo)",
    bankChartInflationSeries: "Tasa anualizada (%)",
    bankChartPool: "Asignación total (ECO)",
    bankChartKarmaTitle: "KARMA Scoring (en el tiempo)",
    bankChartFundsTitle: "Tus fondos ECOin (en el tiempo)",
    bankChartKarma: "Karma",
    bankWalletReady: "ECOin conectada",
    bankWalletNotConfigured: "ECOin desconectada",
    transfersPayWithWallet: "¡PAGAR!",
    walletStatus: "Estado",    
    walletDisconnected: [
      "Tienes la ",
    ...
    walletDisconnectButton: "Desconectar wallet",
    cipher: "Cifrador",
    ...
    bookmarkSearchPlaceholder: "Buscar en Marcadores...",
    ...
    videoSearchPlaceholder: "Buscar en Vídeos...",
    ...
    documentSearchPlaceholder: "Buscar en Documentos...",
    ...
    audioSearchPlaceholder: "Buscar en Audios...",
    ...
    searchInhabitantsPlaceholder:  "Buscar en Habitantes...",
    ...
    parliamentSeatsGovernment: "Gobierno",
    parliamentSeatsOpposition: "Oposición",
    parliamentSeatsAbstention: "Abstención",
    parliamentSeatsQuorum: "Cuórum de elección",
    parliamentSeatsPass: "Umbral de aprobación",
    parliamentSeatsByElection: "Por elección",
    parliamentSeatsByHouses: "Por casa del LARP",
    parliamentSeatsSeats: "escaños",
    parliamentSeatsSeat: "escaño",
    parliamentSeatsLeader: "Líder",
    parliamentSeatsVotesFor: "votos a",
    parliamentSeatsNoHouse: "Sin casa",
    ...
    parliamentViewReport: "Ver informe",
    ...
    parliamentRulesHemicycle: "El hemiciclo da un escaño por habitante: el bloque de gobierno (votantes de la candidatura ganadora y el líder), un bloque de oposición por cada otra candidatura del ciclo, y la abstención. Las marcas discontinuas señalan el cuórum de elección (25 % del censo) y el umbral de aprobación del método vigente. \"Por casa del LARP\" colorea los mismos escaños por casa.",
    ...
    taskSearchPlaceholder: "Buscar en Tareas...",
    ...
    eventSearchPlaceholder: "Buscar en Eventos...",
    eventPrice: "Precio",
    eventStatus: "Estado",
    ...
    tagsSearchPlaceholder: "Buscar en Etiquetas...",
    ...
    transfersFilterMinePending: "PENDIENTES",
    transfersFilterMineConfirmed: "FIRMADOS",
    ...
    transfersSearchPlaceholder: "Buscar en Transferencias...",
    ...
    commentsGoToLast: "Ir al último comentario",
    ...
    dataSearchPlaceholder: "Buscar en Coincidencias...",
    ...
    dataReasonFollowing: "Das soporte a este habitante",
    dataReasonTribe: "Comparte tribu contigo",
    dataReasonPinned: "Coincide con algo que has fijado",
    dataReasonCv: "Coincide con las habilidades de tu CV",
    dataReasonContent: "Relacionado con lo que publicas",
    dataReasonRelated: "Relacionado con tus intereses",
    dataReasonAlike: "Publicado por un habitante afín a ti",
    dataReasonSupportsYou: "Te da soporte",
    dataReasonMutual: "Soporte mutuo",
    dataReasonRated: "Bien valorado por la red",
    dataReasonNear: "Cerca de ti",
    dataStatPeople: "CVs",
    ...
    pollSearchPlaceholder: "Buscar en Encuestas...",
    ...
    blogSearchPlaceholder: "Buscar en Blogs...",
    ...
    forumSearchPlaceholder: "Buscar en Foros...",
    ...
    imageSearchPlaceholder: "Buscar en Imágenes...",
    ...
    reportsSearchPlaceholder: "Buscar en Informes...",
    ...
    searchTribesPlaceholder:  "Buscar en Tribus...",
    ...
    pmListLabel: "Enviar a",
    pmListNone: "— Sin lista —",
    pmListNoSubscribers: "Sin suscriptores",
    ...
    agendaSearchPlaceholder: "Buscar en Agenda...",
    ...
    private: "Buzón",
    privateDescription: "Gestiona tus mensajes privados.",
    privateInbox: "BUZÓN",
    ...
    bankingDescription: "La economía colectiva de ECOin.",
    ...
    bankYourFundsMonth: "Fondos totales",
    bankIndustryBalance: "Producción industrial",
    ...
    bankAddAddressLabel: "Etiqueta (opcional)",
    bankAddAddressLabelPlaceholder: "Cartera de Bob, tienda de Alice…",
    bankAddAddressUserOptional: "Oasis ID (opcional)",
    bankAddressUnnamed: "Dirección sin nombre",
    ...
    shopSearchPlaceholder: "Buscar en Tiendas...",
    shopUrl: "URL",
    ...
    shopTagsPlaceholder: "Introduce etiquetas separadas por comas",
    ...
    bankTotalSupply: "Suministro ECOin total",
    bankPubsSupply: "Suministro ECOin del pozo de los PUBs",
    bankHoldingSupply: "Suministro ECOin fuera de la RBU",
    ...
    bankCurrentSupply: "Suministro ECOin actual",
    bankingSyncStatus: 'Estado de ECOin',
    bankingSyncStatusSynced: 'Sincronizado',
    bankingSyncStatusOutdated: "Sin sincronizar",
    ...
    walletAddressCopyHint: "Pulsa para seleccionar y copiar",
    ...
    aiServerError: "No puedo responder bien. Inténtalo de nuevo.",
    aiStatusLoading: "42 está cargando el modelo. Pregunta de nuevo en un momento.",
    aiThinking: "Pensando",
    aiWaiting: "Esperando",
    aiStatusMissingModel: "El modelo de IA no está instalado: falta src/AI/oasis-42-1-chat.Q4_K_M.gguf.",
    aiExportFineTuning: "Exportar Fine-Tuning",
    aiFactsTitle: "Datos de tu red",
    ...
    marketCreateButton: "Vender algo",
    marketItemType: "Tipo",
    ...
    marketSearchPlaceholder: "Buscar en Mercado...",
    ...
    housingSearchPlaceholder: "Buscar en Vivienda...",
    ...
    jobsSearchPlaceholder: "Buscar en Laboral...",
    ...
    industrySearchPlaceholder: "Buscar en Industria...",
    ...
    projectSearchPlaceholder: "Buscar en Proyectos...",
    ...
    modulesBankingDescription: "Módulo para gestionar el tesoro común: valor de ECOIN, impuestos y RBU.",
    ...
    errorNoAllocation: "No se ha encontrado ninguna asignación para esta reclamación.",
    errorInvalidClaim: "Esta asignación no se puede reclamar.",
    ...
    bankEcoinHours: "Equivalencia ECOin en tiempo (1 ECO)",
    mapsLabel: "Mapas",
    mapTitle: "Mapas",
    ...
    mapSearchPlaceholder: "Buscar en Mapas...",
    ...
    modulesEmergenciesLabel: "Emergencias",
    modulesEmergenciesDescription: "Módulo para lanzar, confirmar y seguir emergencias en la red.",
    emergenciesDescription: "Módulo para lanzar, confirmar y seguir emergencias en la red.",
    emergencyCreate: "Crear emergencia",
    emergencyUpdate: "Actualizar",
    emergencyDelete: "Borrar",
    emergencyTitleLabel: "Título",
    emergencyTitlePlaceholder: "¿Qué está pasando?",
    emergencyTextLabel: "Detalles",
    emergencyTextPlaceholder: "Dónde, desde cuándo, qué hacer...",
    emergencyCategoryLabel: "Categoría",
    emergencyCategoryWeather: "METEOROLOGÍA",
    emergencyCategoryInfrastructure: "INFRAESTRUCTURA",
    emergencyCategoryHealth: "SALUD",
    emergencyCategorySecurity: "SEGURIDAD",
    emergencyCategoryLost: "PERDIDOS",
    emergencyCategoryNeighborhood: "VECINDARIO",
    emergencyExpiresLabel: "Caduca en",
    emergencyExpires1d: "1 día",
    emergencyExpires3d: "3 días",
    emergencyExpires7d: "1 semana",
    emergencyExpires30d: "1 mes",
    emergencyExpiresNone: "Indefinido",
    emergencyExpiresKeep: "Mantener la fecha actual",
    emergencyTagsLabel: "Etiquetas",
    emergencyTagsPlaceholder: "Introduce etiquetas separadas por comas",
    emergencyFilterAll: "TODAS",
    emergencyFilterMine: "MÍAS",
    emergencyFilterRecent: "RECIENTES",
    emergencySeverityUnverified: "SIN VERIFICAR",
    emergencySeverityLow: "BAJA",
    emergencySeverityMedium: "MEDIA",
    emergencySeverityHigh: "ALTA",
    emergencyStatusActive: "ACTIVA",
    emergencyStatusResolved: "RESUELTA",
    emergencyStatusExpired: "CADUCADA",
    emergencyConfirmations: "Confirmaciones",
    emergencyConfirmButton: "Confirmar",
    emergencyConfirmed: "Has confirmado esta emergencia",
    emergencyResolveButton: "Resolver",
    emergencyReopenButton: "Reabrir",
    emergencyGenerateReport: "Generar informe",
    emergencyUpdateEdited: "Editada",
    emergencyLastUpdate: "ÚLTIMA ACTUALIZACIÓN",
    emergencyUpdatesTitle: "Últimas actualizaciones:",
    emergencyNoUpdates: "Aún no hay actualizaciones.",
    emergencyAddUpdate: "Publicar actualización",
    emergencyUpdatePlaceholder: "¿Qué ha cambiado?",
    emergencyNoItems: "No se han encontrado emergencias.",
    emergencyExpiresAt: "Caduca",
    emergencyBannerLabel: "Emergencia activa",
    emergencyCreateSectionTitle: "Crear emergencia",
    emergencyUpdateSectionTitle: "Actualizar emergencia",
    emergencySearchPlaceholder: "Buscar en emergencias...",
    typeEmergency: "EMERGENCIAS",
    typeEmergencyConfirm: "CONFIRMACIÓN DE EMERGENCIA",
    typeEmergencyUpdate: "ACTUALIZACIÓN DE EMERGENCIA",
    statsEmergency: "Emergencias",
    statsEmergencyConfirm: "Confirmaciones de emergencias",
    statsEmergencyUpdate: "Actualizaciones de emergencias",
    pmBotEmergencies: "EmergencyBot",
    emergencyBotUpdatedTitle: "Una emergencia que sigues tiene una actualización.",
    emergencyBotResolvedTitle: "Una emergencia que sigues se ha resuelto.",
    dataKindEmergencies: "EMERGENCIAS",
    mailingTitle: "Listas de correo",
    modulesMailingLabel: "Listas de correo",
    modulesMailingDescription: "Descubre y gestiona listas de correo en tu red.",
    mailingDescription: "Descubre y gestiona listas de correo en tu red.",
    mailingCreate: "Crear lista de correo",
    mailingUpdate: "Actualizar",
    mailingDelete: "Borrar",
    mailingArchive: "Archivar",
    mailingActivate: "Activar",
    mailingCreateSectionTitle: "Crear lista de correo",
    mailingUpdateSectionTitle: "Actualizar lista de correo",
    mailingTitleLabel: "Título",
    mailingTitlePlaceholder: "Nombre de la lista de correo",
    mailingDescriptionLabel: "Descripción",
    mailingDescriptionPlaceholder: "¿De qué trata esta lista?",
    mailingTypeLabel: "Tipo de lista de correo",
    mailingTypeOpen: "ABIERTA",
    mailingTypeClosed: "CERRADA",
    mailingStatusLabel: "Estado",
    mailingStatusActive: "ACTIVA",
    mailingStatusArchived: "ARCHIVADA",
    mailingMembersLabel: "Invitar habitantes",
    mailingMembersPlaceholder: "@id1.ed25519, @id2.ed25519, ...",
    mailingSubscribers: "Suscriptores",
    mailingTagsLabel: "Etiquetas",
    mailingTagsPlaceholder: "Introduce etiquetas separadas por comas",
    mailingFilterAll: "TODAS",
    mailingFilterMine: "MÍAS",
    mailingFilterSubscribed: "SUSCRITAS",
    mailingFilterRecent: "RECIENTES",
    mailingHistoryDate: "FECHA",
    mailingHistoryThreads: "HILOS",
    mailingHistoryInhabitants: "HABITANTES",
    mailingHistorySearchPlaceholder: "Buscar en el historial...",
    mailingNoMessages: "Aún no hay mensajes.",
    mailingNoItems: "No se han encontrado listas de correo.",
    mailingSearchPlaceholder: "Buscar en listas de correo...",
    mailingWriteButton: "Escribir mensaje",
    mailingWriteTitle: "Escribir a la lista",
    mailingReplyTitle: "Responder a la lista",
    mailingSend: "Enviar",
    mailingTextPlaceholder: "Tu mensaje llega a todos los participantes de la lista.",
    mailingParticipants: "Participantes",
    inboxFilterMailing: "Listas de correo",
    mailingReplyPlaceholder: "Responder a la lista...",
    mailingReplyToList: "Responder a la lista",
    typeMailingList: "LISTA DE CORREO",
    statsMailingList: "Listas de correo",
    mailingListLabel: "LISTA DE CORREO",
    logisticsTitle: "Logística",
    modulesLogisticsLabel: "Logística",
    modulesLogisticsDescription: "Descubre y gestiona planes logísticos en tu red.",
    logisticsDescription: "Descubre y gestiona planes logísticos en tu red.",
    logisticsCreate: "Crear ruta",
    logisticsUpdate: "Actualizar",
    logisticsDelete: "Borrar",
    logisticsClose: "Cerrar",
    logisticsReopen: "Reabrir",
    logisticsCreateSectionTitle: "Crear ruta",
    logisticsUpdateSectionTitle: "Actualizar ruta",
    logisticsTitleLabel: "Título",
    logisticsTitlePlaceholder: "Viaje al mercado, furgoneta disponible...",
    logisticsKindLabel: "Tipo de logística",
    logisticsKindTrip: "VIAJE",
    logisticsKindShipment: "ENVÍO",
    logisticsKindTrips: "VIAJES",
    logisticsKindShipments: "ENVÍOS",
    logisticsModeLabel: "Modo",
    logisticsModeOffer: "OFREZCO",
    logisticsModeRequest: "BUSCO",
    logisticsModeOffers: "OFERTAS",
    logisticsModeRequests: "PETICIONES",
    logisticsDescriptionLabel: "Descripción",
    logisticsDescriptionPlaceholder: "Punto de encuentro, qué llevas, condiciones...",
    logisticsOriginLabel: "Origen",
    logisticsOriginPlaceholder: "Dónde empieza",
    logisticsDestinationLabel: "Destino",
    logisticsDestinationPlaceholder: "Dónde termina",
    logisticsDateLabel: "Fecha y hora",
    logisticsRecurrenceLabel: "Recurrencia",
    logisticsFrequencyLabel: "Frecuencia",
    logisticsRecurrenceNone: "ÚNICO",
    logisticsRecurrenceDaily: "DIARIO",
    logisticsRecurrenceWeekly: "SEMANAL",
    logisticsRecurrenceMonthly: "MENSUAL",
    logisticsSeatsLabel: "Plazas",
    logisticsSizeLabel: "Tamaño",
    logisticsSizePlaceholder: "p. ej. 2m x 1m",
    logisticsWeightLabel: "Peso",
    logisticsWeightPlaceholder: "p. ej. 40kg",
    logisticsPriceFree: "GRATIS",
    logisticsPriceEco: "ECO",
    logisticsPriceTime: "TIEMPO",
    logisticsPriceLabel: "Precio",
    logisticsHours: "h",
    logisticsOrderRefLabel: "Enlace al pedido",
    logisticsOrderRefPlaceholder: "/shops/... o /market/... del pedido a entregar",
    logisticsOrderLink: "Pedido enlazado",
    logisticsTagsLabel: "Etiquetas",
    logisticsTagsPlaceholder: "Introduce etiquetas separadas por comas",
    logisticsFilterAll: "TODAS",
    logisticsFilterMine: "MÍAS",
    logisticsFilterBooked: "RESERVADAS",
    logisticsFilterRecent: "RECIENTES",
    logisticsFilterHistory: "HISTORIAL",
    logisticsFilterTop: "TOP",
    logisticsStatusOpen: "ABIERTA",
    logisticsStatusUpcoming: "PRÓXIMAS",
    logisticsStatusPast: "PASADAS",
    logisticsStatusClosed: "CERRADAS",
    logisticsZoneLabel: "Zona",
    logisticsSearchPlaceholder: "Buscar en logística...",
    logisticsNoItems: "No se han encontrado rutas.",
    logisticsBookingPending: "PENDIENTE",
    logisticsBookingConfirmed: "CONFIRMADA",
    logisticsBookingRejected: "RECHAZADA",
    logisticsBookingCancelled: "CANCELADA",
    logisticsBookingDelivered: "ENTREGADA",
    logisticsConfirm: "Confirmar",
    logisticsReject: "Rechazar",
    logisticsDeliver: "Entregar",
    logisticsReceiptLabel: "Recibo",
    logisticsReceiptPlaceholder: "Nota de entrega (opcional)",
    logisticsCancelBooking: "Cancelar reserva",
    logisticsBookTitle: "Reservar esta ruta",
    logisticsNotesLabel: "Notas",
    logisticsNotesPlaceholder: "Lo que el responsable deba saber",
    logisticsBook: "Reservar",
    logisticsBookingsTitle: "Reservas",
    logisticsMyBookingTitle: "Tu reserva",
    logisticsRatingsTitle: "Valoraciones",
    logisticsNoRatings: "Aún no hay valoraciones.",
    logisticsRatingsWhenClosed: "Las valoraciones se abren al cerrar la ruta.",
    logisticsScoreLabel: "Puntuación",
    logisticsRatingPlaceholder: "¿Qué tal fue?",
    logisticsRate: "Valorar",
    typeLogisticsRoute: "RUTA",
    typeLogisticsRating: "VALORACIÓN DE RUTA",
    statsLogisticsRoute: "Rutas",
    statsLogisticsRating: "Valoraciones de rutas",
    logisticsRouteLabel: "RUTA",
    podcastsTitle: "Podcasts",
    modulesPodcastsLabel: "Podcasts",
    modulesPodcastsDescription: "Módulo para publicar canales de podcast.",
    podcastsDescription: "Módulo para publicar canales de podcast.",
    podcastCreate: "Crear podcast",
    podcastUpdate: "Actualizar",
    podcastDelete: "Borrar",
    podcastCreateSectionTitle: "Crear podcast",
    podcastUpdateSectionTitle: "Actualizar podcast",
    podcastTitleLabel: "Título",
    podcastTitlePlaceholder: "Nombre del canal",
    podcastDescriptionLabel: "Descripción",
    podcastDescriptionPlaceholder: "¿De qué trata este podcast?",
    podcastCategoryLabel: "Categoría",
    podcastCategoryNews: "NOTICIAS",
    podcastCategoryMusic: "MÚSICA",
    podcastCategoryTalk: "CHARLA",
    podcastCategoryEducation: "EDUCACIÓN",
    podcastCategoryTech: "TECNOLOGÍA",
    podcastCategoryCulture: "CULTURA",
    podcastCategoryCommunity: "COMUNIDAD",
    podcastCategoryOasis: "OASIS",
    podcastCategoryOther: "OTROS",
    podcastTagsLabel: "Etiquetas",
    podcastTagsPlaceholder: "Introduce etiquetas separadas por comas",
    podcastFilterAll: "TODOS",
    podcastFilterMine: "MÍOS",
    podcastFilterRecent: "RECIENTES",
    podcastFilterTop: "TOP",
    podcastFilterViewers: "OYENTES",
    podcastSearchPlaceholder: "Buscar en podcasts...",
    podcastNoItems: "No se han encontrado podcasts.",
    podcastEpisodesLabel: "Episodios",
    podcastPlaysLabel: "Visualizaciones",
    podcastLastEpisode: "Último episodio",
    podcastEpisodesTitle: "Episodios",
    podcastNoEpisodes: "Aún no hay episodios.",
    podcastEpisodeAdd: "Añadir episodio",
    podcastEpisodeCreateTitle: "Publicar episodio",
    podcastEpisodeUpdateTitle: "Actualizar episodio",
    podcastEpisodeTitleLabel: "Título del episodio",
    podcastEpisodeTitlePlaceholder: "Título del episodio",
    podcastEpisodeDescriptionLabel: "Notas",
    podcastEpisodeDescriptionPlaceholder: "Qué pasa en este episodio, enlaces, créditos...",
    podcastEpisodePublish: "Publicar",
    podcastPlayed: "Reproducido",
    podcastMarkPlayed: "Marcar como reproducido",
    typePodcast: "PODCAST",
    typePodcastEpisode: "EPISODIO",
    typePodcastOpinion: "OPINIÓN DE EPISODIO",
    typePodcastPlay: "REPRODUCCIÓN",
    statsPodcast: "Podcasts",
    statsPodcastEpisode: "Episodios",
    statsPodcastPlay: "Reproducciones",
    pmBotPodcasts: "PodcastBot",
    pmBotBlogs: "BlogsBot",
    blogBotNewTitle: "Un blog que sigues tiene una nueva entrada.",
    podcastBotEpisodeTitle: "Un podcast que sigues tiene un episodio nuevo.",
    podcastLabel: "PODCAST",
    podcastEpisodeLabel: "EPISODIO",
    campaignsTitle: "Campañas",
    modulesCampaignsLabel: "Campañas",
    modulesCampaignsDescription: "Descubre y gestiona campañas en tu red.",
    campaignsDescription: "Descubre y gestiona campañas en tu red.",
    campaignCreate: "Crear campaña",
    campaignUpdate: "Actualizar",
    campaignDelete: "Borrar",
    campaignClose: "Cerrar",
    campaignReopen: "Reabrir",
    campaignCreateSectionTitle: "Crear campaña",
    campaignUpdateSectionTitle: "Actualizar campaña",
    campaignTitleLabel: "Título",
    campaignTitlePlaceholder: "¿Qué quieres conseguir?",
    campaignTextLabel: "Texto",
    campaignTextPlaceholder: "Explica la causa, quién decide y qué pides...",
    campaignCategoryLabel: "Categoría",
    campaignCategoryEnvironment: "MEDIO AMBIENTE",
    campaignCategoryRights: "DERECHOS",
    campaignCategoryHealth: "SALUD",
    campaignCategoryEducation: "EDUCACIÓN",
    campaignCategoryInfrastructure: "INFRAESTRUCTURA",
    campaignCategoryCulture: "CULTURA",
    campaignCategoryEconomy: "ECONOMÍA",
    campaignCategoryOther: "OTROS",
    campaignGoalLabel: "Objetivo de firmas",
    campaignDeadlineLabel: "Plazo",
    campaignTagsLabel: "Etiquetas",
    campaignTagsPlaceholder: "Introduce etiquetas separadas por comas",
    campaignFilterAll: "TODAS",
    campaignFilterMine: "MÍAS",
    campaignFilterSigned: "FIRMADAS",
    campaignFilterRecent: "RECIENTES",
    campaignFilterTop: "TOP",
    campaignStatusOpen: "ABIERTA",
    campaignStatusAchieved: "LOGRADA",
    campaignStatusUnachieved: "NO LOGRADA",
    campaignStatusClosed: "CERRADA",
    campaignSearchPlaceholder: "Buscar en campañas...",
    campaignNoItems: "No se han encontrado campañas.",
    campaignSignaturesLabel: "Firmas",
    campaignSignaturesTitle: "Apoyos",
    campaignNoSignatures: "Aún no hay firmas.",
    campaignSignTitle: "Firmar esta campaña",
    campaignSignPlaceholder: "¿Por qué la apoyas? (opcional)",
    campaignSign: "Firmar",
    campaignSigned: "¡Ya has firmado!",
    campaignNotSigned: "Aún falta tu firma",
    campaignElevate: "Elevar al Parlamento",
    campaignElevated: "Elevada al Parlamento",
    campaignUpdatesTitle: "Actualizaciones",
    campaignNoUpdates: "Aún no hay actualizaciones.",
    campaignUpdatePlaceholder: "¿Qué ha pasado?",
    campaignAddUpdate: "Publicar actualización",
    campaignQrAlt: "QR para firmar esta campaña",
    campaignQrCaption: "Escanea para firmar",
    typeCampaign: "CAMPAÑA",
    typeCampaignSignature: "FIRMA",
    typeCampaignUpdate: "ACTUALIZACIÓN DE CAMPAÑA",
    statsCampaign: "Campañas",
    statsCampaignSignature: "Firmas de campañas",
    statsCampaignUpdate: "Actualizaciones de campañas",
    pmBotCampaigns: "CampaignBot",
    campaignBotUpdatedTitle: "Una campaña que sigues tiene una actualización.",
    campaignBotAchievedTitle: "Una campaña que sigues ha alcanzado su objetivo.",
    campaignBotRaisedTitle: "Una campaña que has firmado se ha elevado al Parlamento.",
    pmBotLogistics: "LogisticsBot",
    logisticsBotUpdatedTitle: "Una ruta que reservaste ha cambiado.",
    logisticsBotClosedTitle: "Una ruta que reservaste se ha cerrado.",
    logisticsBotBookedTitle: "Alguien ha reservado tu ruta.",
    logisticsBotCancelledTitle: "Se ha cancelado una reserva de tu ruta.",
    logisticsBotConfirmedTitle: "Tu reserva se ha confirmado: el paquete está en camino.",
    logisticsBotRejectedTitle: "Tu reserva se ha rechazado.",
    logisticsBotDeliveredTitle: "Tu paquete ha llegado.",
    campaignLabel: "CAMPAÑA",
    campaignGenerateReport: "Generar informe",
    logisticsGenerateReport: "Generar informe",
    mailingGenerateReport: "Generar informe",
    campaignUpdateEdited: "Editada",
    mailingMessagesLabel: "Mensajes",
    logisticsBookingsLabel: "Reservas",
    backupTitle: "Copia de seguridad",
    modulesBackupLabel: "Copia de seguridad",
    modulesBackupDescription: "Módulo para exportar e importar tus llaves y hacer copias de seguridad cifradas.",
    backupDescription: "Módulo para exportar e importar tus llaves y hacer copias de seguridad cifradas.",
    backupKitWarning: "Cualquiera que lea esta página puede actuar como tú. ¡Nunca la compartas!",
    backupTypeRecovery: "RECUPERACIÓN",
    backupTypeKeys: "EXPORTAR CLAVES",
    backupTypeFull: "COPIA COMPLETA",
    backupTypeRestore: "RESTAURAR COPIA",
    backupTypeInstant: "INSTANTÁNEA",
    backupInstantDescription: "Un .zip llano con todo tu registro y tus ficheros, sin tu clave secreta y sin contraseña. Rápido, pero quien tenga el fichero lo lee todo.",
    backupInstantWarning: "Esta copia no va cifrada. Guárdala en un sitio seguro.",
    backupKitPageDescription: "El kit de recuperación solo puede abrirse desde este dispositivo.",
    backupKitId: "ID de Oasis",
    backupKitDate: "Generado",
    backupKitQrAlt: "Código QR de tu llave secreta",
    backupKitStep1: "Imprímelo o cópialo a mano y guárdalo en un lugar seguro y sin conexión.",
    backupKitStep2: "Para recuperar, instala Oasis en un dispositivo nuevo e importa este secreto desde Copia de seguridad › Llaves.",
    backupKitStep3: "Destruye esta página si alguna vez queda expuesta.",
    backupKitPdfButton: "Generar PDF",
    backupScopeLabel: "Alcance",
    backupScopeAll: "TODO",
    backupScopeMine: "SOLO MI CONTENIDO",
    backupSinceLabel: "Desde",
    backupEstimateTitle: "Estimación",
    backupFileInfo: "Tu copia cifrada se descargará en tu dispositivo (nombre: oasis-backup-FECHA.oasisbk)",
    backupExportButton: "Descargar copia",
    backupRestorePassword: "Escribe la contraseña usada al hacer la copia",
    backupRestoreButton: "Restaurar copia",
    backupRestoredLine: "Copia restaurada.",
    backupRestoredMessages: "Mensajes añadidos",
    backupRestoredSkipped: "Ya existentes",
    backupRestoredBlobs: "Archivos añadidos",
    backupRestoredState: "Configuración restaurada",
    backupRestoredFailed: "Fallidos",
    backupRestoredForked: "Divergentes",
    backupRestoreRunning: "Restaurando la copia. Esta página se actualiza sola; mientras tanto puedes seguir usando Oasis.",
    backupRestoreElapsed: "Transcurrido",
    backupRestoreFailedLine: "No se pudo restaurar la copia.",
    backupRestoreForkMine: "Este dispositivo ya publicó mensajes con tu identidad que no están en la copia, así que no se pudo aplicar encima de ellos. Restaura en una instalación limpia justo después de importar tus llaves, antes de hacer nada más.",
    verificationTitle: "Verificación",
    verificationDescription: "Comprueba la cadena de tu feed, detecta bifurcaciones y revisa archivos huérfanos o ausentes.",
    verificationRun: "Ejecutar verificación",
    verificationTotalMessages: "mensajes en el registro",
    verificationFeed: "Tu feed",
    verificationMessages: "mensajes",
    verificationLastSequence: "última secuencia",
    verificationGaps: "Huecos",
    verificationBrokenLinks: "Enlaces rotos",
    verificationBadHashes: "Hashes incorrectos",
    verificationBadSignatures: "Firmas incorrectas",
    verificationDuplicates: "Secuencias duplicadas",
    verificationForks: "Bifurcaciones",
    verificationBlobs: "Archivos",
    verificationBlobsPresent: "presentes",
    verificationBlobsReferenced: "referenciados",
    verificationBlobsOrphan: "huérfanos",
    verificationBlobsMissing: "ausentes",
    verificationBlobsMissingOwn: "Ficheros tuyos que faltan en este dispositivo",
    verificationBlobsMissingOthers: "Ficheros de otros habitantes aún sin descargar",
    verificationBlobsUnavailable: "No se han podido listar los archivos en este dispositivo.",
    wikiTitle: "Wikis",
    modulesWikiLabel: "Wikis",
    modulesWikiDescription: "Módulo para descubrir y gestionar wikis.",
    wikiDescription: "Módulo para descubrir y gestionar wikis.",
    wikiCreate: "Crear wiki",
    wikiUpdate: "Actualizar",
    wikiDelete: "Borrar",
    wikiEdit: "Editar",
    wikiTitleLabel: "Título",
    wikiTitlePlaceholder: "Título de la wiki...",
    wikiBodyLabel: "Contenido",
    wikiBodyPlaceholder: "Enlaza otras wikis con [[Título de la wiki]] o [[Título de la wiki|un texto propio]].\n\nMenciona a un habitante con @id.\n\nEtiqueta con #oasis.\n\nPega enlaces como https://solarnethub.com\n\nUna línea en blanco abre un párrafo nuevo; los saltos de línea simples se conservan.\n\nAdjunta cualquier media soportado y se incrustará aquí.",
    formatBarLabel: "Formato",
    wikiStatusLabel: "Tipo de wiki",
    wikiStatusOpen: "ABIERTA",
    wikiStatusClosed: "CERRADA",
    wikiTagsLabel: "Etiquetas",
    wikiTagsPlaceholder: "Introduce etiquetas separadas por comas",
    wikiSummaryLabel: "Resumen del cambio",
    wikiSummaryPlaceholder: "¿Qué ha cambiado?",
    wikiFilterAll: "TODAS",
    wikiFilterMine: "MÍAS",
    wikiFilterRecent: "RECIENTES",
    wikiFilterLinked: "ENLAZADAS",
    wikiChanges: "Cambios recientes",
    wikiNoPages: "No se han encontrado wikis.",
    wikiNoChanges: "Aún no hay cambios.",
    wikiHistory: "Historial",
    wikiVersion: "Versión",
    wikiVersions: "versiones",
    wikiRestore: "Restaurar",
    wikiDiff: "Cambios",
    wikiViewVersion: "Ver",
    wikiLinkedPages: "Páginas enlazadas",
    wikiNoLinkedPages: "Esta página aún no se enlaza con ninguna otra.",
    wikiMissingLink: "La página aún no existe",
    wikiDuplicateTitle: "Ya existe una página con este título. Cambia el título para crear una página distinta.",
    wikiCreateSectionTitle: "Crear wiki",
    wikiUpdateSectionTitle: "Actualizar wiki",
    wikiSearchPlaceholder: "Buscar en la Wiki...",
    wikiCurrentVersion: "Versión actual",
    wikiViewingVersion: "Estás viendo una versión antigua",
    wikiBackToPage: "Volver a la página",
    wikiLinkedChip: "Enlazada",
    wikiRestoredSummary: "Versión restaurada",
    wikiExportPdf: "Generar página",
    wikiPreview: "Vista previa",
    tribeSectionWiki: "WIKI",
    tribeWikiCreate: "Crear wiki",
    tribeWikiEmpty: "Aún no hay wikis.",
    typeWiki: "WIKI",
    padsTitle: "Pads",
    padTitle: "Pad",
    ...
    padTagsPlaceholder: "Introduce etiquetas separadas por comas",
    ...
    padSearchPlaceholder: "Buscar en Pads...",
    ...
    calendarTagsPlaceholder: "Introduce etiquetas separadas por comas",
  ...
  calendarDeleteNote: "Delete",
    ...
    calendarSearchPlaceholder: "Buscar en Calendario...",
    ...
    modulesChatsDescription: "Módulo para descubrir y gestionar chats.",
    typeChat: "CHATS",
    ...
    chatSearchPlaceholder: "Buscar en Chats...",
    ...
    activitySearchPlaceholder: "Buscar en Actividad...",
    ...
    gamesSearchPlaceholder: "Buscar en Juegos...",
    schoolTitle: "Escuela",
    pmBotWiki: "WikiBot",
    wikiBotEditedTitle: "Se ha editado una página wiki que sigues.",
    wikiBotRestoredTitle: "Se ha restaurado una versión anterior de una página wiki que sigues.",
    ...
    agendaFilterCampaigns: "CAMPAÑAS",
    agendaFilterLogistics: "LOGÍSTICA",
    ...
    schoolTagsPlaceholder: "Introduce etiquetas separadas por comas",
    ...
    schoolSearchPlaceholder: "Buscar en Escuela...",
    ...
    chatTagsPlaceholder: "Introduce etiquetas separadas por comas",
    ...
    torrentDownloadButton: "¡DESCARGAR!",
    torrentDetailsButton: "DETALLES",
    torrentNoFile: "Sin archivo torrent",
    noTorrents: "No se encontraron torrents.",
    torrentSearchPlaceholder: "Buscar en Torrents...",
    ...
    logsSearchText: "Buscar en Bitácora...",
    ...
    larpSearchPlaceholder: "Buscar en L.A.R.P....",
    larpAllHouses: "Casas:",
    ...
    indexingMessage: "Oasis está sincronizando una red enorme de habitantes. ¡Espera un momento!",
    indexingRefreshNote: "Esta página se recarga cada 10 segundos.",
    indexingTitle: "Sincronizando",
    ...
    ecoTaxLabel: "ECO Tax",
    bankTaxes: "Impuestos",
    bankOverviewYourTaxes: "Impuestos totales",
    ...
    modulesLarpDescription: "Módulo para la capa de juego de rol en vivo.",
