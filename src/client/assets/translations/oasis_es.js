...
module.exports = {
  es: {
    ...
    pmListLabel: "PM masivo",
    pmListNone: "— Sin lista —",
    pmListNoSubscribers: "Este PM masivo aún no tiene suscriptores.",
    ...
    backupRestoreForkOthers: "Algunos feeds de este dispositivo divergen de la copia; sus mensajes restantes se dejaron sin tocar.",
    backupRestoreErrors: "Motivos",
