...
module.exports = {
  zh: {
    ...
    courtsSettlementAcceptBtn: "接受和解",
    ...
    statsCarbonYearProgress: "年度已过",
    statsNetworkTitle: "网络",
    statsStorageTitle: "存储",
    statsEcoTaxTitle: "ECO 税",
    statsAccountTitle: "账户",
    statsAveragesTitle: "平均值",
    ...
    profile: "头像",
    inhabitants: "居民",
    peersReplicatedFeeds: "已复制",
    peersOasisId: "Oasis ID",
    peersOasisVersion: "版本",
    graphos: "Graphos",
    ...
    mentionsSearchPlaceholder: "在提及中搜索...",
    privateReminders: "提醒",
    inboxFilterPms: "私信",
    inboxFilterNotifications: "通知",
    inboxMarkRead: "标为已读",
    inboxMarkUnread: "标为未读",
    inboxUnreadChip: "未读",
    inboxMarkAllRead: "全部标为已读",
    inboxDeleteShown: "全部删除",
    inboxArchive: "归档",
    inboxUnarchive: "取消归档",
    inboxFilterArchived: "已归档",
    inboxEarlierMessages: "条较早的消息",
    inboxSortThread: "按会话",
    inboxSortRecent: "最新优先",
    inboxAllBots: "机器人",
    settingsInboxBotsTitle: "收件箱通知",
    settingsInboxBotsDesc: "选择哪些机器人可以在收件箱中通知你。未勾选的机器人将被隐藏，其通知不计入计数。",
    ...
    profileVisibilityFediverse: "多元宇宙",
    ...
    inbox: "收件箱",
    inboxSearchPlaceholder: "在收件箱中搜索...",
    multiverse: "多元宇宙",
    fediverse: "多元宇宙",
    fediverseDescription: "管理你的其他多元宇宙账户，包括发送和接收内容。",
    fediverseStatus: "状态",
    fediverseDisconnected: "多元宇宙已断开。请检查%LINK%或连接状态。",
    fediverseSettingsTitle: "多元宇宙",
    ...
    telegramPhoneLabel: "手机号",
    telegramSendCode: "发送验证码",
    telegramCodeHelp: "输入 Telegram 刚发送的登录码（应用或短信）。",
    telegramCodeLabel: "登录码",
    telegramPasswordHelp: "该账号启用了两步验证，请输入云密码。",
    telegramPasswordLabel: "密码",
    telegramVerify: "验证",
    telegramCancel: "取消",
    telegramChats: "聊天",
    telegramUnread: "未读",
    ...
    telegramSend: "发送",
    telegramYou: "你",
    telegramNoChats: "还没有聊天。",
    telegramNoMessages: "还没有消息。",
    telegramComposePlaceholder: "输入消息…",
    telegramChannel: "频道",
    telegramGroup: "群组",
    telegramPrivate: "私聊",
    telegramErrConnect: "无法连接 Telegram。",
    telegramErrTimeout: "Telegram 响应超时。",
    telegramErrAuth: "Telegram 会话无效或已过期，请重新连接。",
    telegramErrFetch: "无法加载聊天。",
    telegramErrSend: "无法发送消息。",
    telegramErrMissing: "需要 API ID、API hash 和手机号。",
    telegramErrCode: "验证码无效，请重试。",
    telegramErrCodeExpired: "验证码已过期，请重新开始。",
    telegramErrPassword: "密码错误。",
    telegramErrPhone: "手机号无效。",
    telegramErrApi: "API ID 或 API hash 无效。",
    telegramErrFlood: "尝试次数过多，请稍后再试。",
    telegramErrNoLogin: "没有进行中的登录，请重新开始。",
    bookmarksLabel: "书签",
    videosLabel: "视频",
    torrentsLabel: "种子",
    docsLabel: "文档",
    ...
    sendTime: "大约 ",
    theme: "主题",
    backupKeysExportButton: "导出",
    backupKeysImportButton: "导入",
    ssbLogStream: "区块链",
    ssbLogStreamDescription: "配置区块链流的消息限制。",
    logWindowChip: "最近 {n} 条区块链流",
    saveSettings: "保存设置",
    exportDescription: "设置密码（至少32个字符）以加密你的密钥",
    exportDataTitle: "即时备份",
    ...
    aiSuggestionBanner: "建议：",
    aiSuggestionsEnable: "AI 建议",
    ...
    sync: "同步网络",
    indexes: "索引",
    indexesRebuilt: "索引已重建",
    indexesRebuildFailed: "无法重建索引",
    indexesFiles: "索引文件",
    indexesDescription:
    ...
    invitesPubsHint: "粘贴 pub 邀请码，与它建立联邦并开始复制其居民。",
    invitesFederationsHint: "已联邦的 pub：刷新、移除无法连接的，或导出列表。",
    invitesHousesHint: "输入房屋代码以加入 LARP 房屋并参与其经济。",
    invitesTribesHint: "输入部落代码以成为成员并访问其私有内容。",
    invitesChatsHint: "输入聊天代码以加入对话及其话题。",
    invitesPadsHint: "输入协作页代码，与他人共同编辑同一份文档。",
    invitesCalendarsHint: "输入日历代码以共享日期与提醒。",
    invitesEventsHint: "输入活动代码以加入私密活动。",
    invitesForumsHint: "输入论坛代码以在私密论坛中阅读与回复。",
    invitesMapsHint: "输入地图代码，在共享地图上查看和添加地点。",
    invitesShopsHint: "输入店铺代码以加入店铺及其目录。",
    invitesInhabitantsHint: "输入居民代码以互相关注并交换内容。",
    ...
    profileClearnetPodcastsLabel: "播客",
    profileClearnetMarketLabel: "市场",
    profileClearnetFeedLabel: "动态",
    profileClearnetWikiLabel: "维基",
    ...
    walletCnfrs: "确认数",
    walletConfirm: "确认",
    walletDescription: "管理您的 ECOin 钱包。",
    walletDate: "日期",
    ...
    walletReset: "重置",
    walletSend: "发送",
    walletPayingTransfer: "正在支付转账",
    walletCreateTransferLabel: "生成智能合约（转账）",
    walletTransferNotifiedNote: "已通知对方本次付款",
    walletTransferCreatedNote: "已为本次付款创建转账（收据）",
    walletTransferNoPayeeNote: "没有居民发布过此地址，因此未创建转账",
    walletTransferReceiptConcept: "钱包付款",
    walletPaymentPmText: "向你发送了一笔付款",
    walletPayeeLabel: "收款人",
    walletConceptLabel: "事由",
    pmBotBanking: "BankingBot",
    bankingBotUbiPaidTitle: "您已收到 UBI。",
    bankingBotPaymentTitle: "您已收到一笔付款。",
    bankingBotUbiPaidText: "您的全民基本收入已发放",
    bankUbiPubThisNode: "本节点负责发放 UBI",
    bankUbiPubConnected: "UBI PUB",
    bankUbiPubNone: "您的网络中尚无 PUB 宣告 UBI",
    bankUbiAddressPublished: "ECOin 地址已发布",
    bankUbiAddressMissing: "发布您的 ECOin 地址以领取 UBI",
    bankUbiClaimedThisMonth: "本月已领取",
    bankUbiPubBalance: "可用于 UBI 的 PUB 钱包",
    bankNoPubAddress: "UBI PUB 尚未发布 ECOin 地址。",
    bankUbiTab: "UBI",
    bankDonateEco: "捐赠！",
    donateTooltip: "捐赠 ECOin",
    bankNoUserAddress: "该居民未公开 ECOin 地址。",
    bankUbiPubDefault: "默认",
    bankUbiPool: "资金池",
    bankUbiLastSeen: "最后在线",
    bankUbiLastPayout: "最近操作",
    bankUbiPaidOut: "已发放",
    bankRangeToday: "今天",
    bankRangeWeek: "本周",
    bankRangeMonth: "本月",
    bankRangeYear: "本年",
    bankRangeFiveYears: "5 年",
    bankRangeAll: "全部",
    bankChartValueTitle: "ECOin 价值演变",
    bankChartValueHours: "时间等值（小时）",
    bankChartWealthTitle: "ECOin 财富再分配",
    bankChartDistributed: "已发放 UBI（ECO）",
    bankChartTaxes: "已扣税款（ECO）",
    bankChartNoDataRange: "此范围内没有数据。",
    bankChartNoDataYet: "暂无数据",
    bankChartPerHour: "每小时",
    bankChartPerDay: "每天",
    bankChartPerMonth: "每月",
    bankTotalUbiDistributed: "已重新分配的 UBI 总额（全网）",
    bankTotalTaxesWithheld: "已扣税款总额（全网）",
    bankInflationIssuance: "发行率（年化，按区块奖励）",
    bankRulesEligibilityTitle: "谁可以领取 UBI",
    bankRulesEligibility1: "在个人资料中发布的 ECOin 地址（资料 → 传感器 → ECOin 钱包）。",
    bankRulesEligibility2: "超过 30 天且在网络中有活动的 feed：业力大于零。",
    bankRulesEligibility3: "每月（每个周期）一次领取，在 Banking 中点击领取 UBI。可用拒绝 UBI 放弃当月。",
    bankRulesEligibility4: "1 ECO 的底线始终发放；税款只减少超出部分，从不另行收取。",
    bankRulesEligibility5: "PUB 在下一周期支付并发布一笔可供确认的 UBI 转账。",
    bankRulesEligibility6: "若缺少地址、feed 太新、已拒绝当月或 PUB 无资金，领取将被跳过并记录在 PUB 上。",
    copyLinkTitle: "复制链接",
    linkBoxOasis: "Oasis",
    linkBoxClearnet: "Clearnet",
    bankRefuseUBI: "拒绝 UBI",
    bankUbiRefusedThisMonth: "您已拒绝本月的 UBI。",
    bankingBotUbiAvailableTitle: "您可以领取 UBI 了。",
    bankingBotUbiAvailableText: "您本月的 UBI 已可领取",
    bankingBotConfirmTitle: "您有一份等待确认的智能合约",
    bankingBotConfirmText: "等待您确认的智能合约",
    bankChartZoomHint: "点击放大",
    bankChartPoolTitle: "UBI 资金池（变化）",
    bankChartNetworkUbiTitle: "已重新分配的 UBI 总额（全网）",
    bankChartSupplyTitle: "ECOin 流通供应量（变化）",
    bankChartInflationTitle: "ECOin 通胀（变化）",
    bankChartInflationSeries: "年化率（%）",
    bankChartPool: "资金池总额（ECO）",
    bankChartKarmaTitle: "KARMA Scoring（变化）",
    bankChartFundsTitle: "你的 ECOin 资金（变化）",
    bankChartKarma: "业力",
    bankWalletReady: "ECOin 已连接",
    bankWalletNotConfigured: "ECOin 未连接",
    transfersPayWithWallet: "支付！",
    walletStatus: "状态",
    walletDisconnected: [
      "ECOin ",
      strong("钱包已断开连接"),
    ...
    bookmarkSearchPlaceholder: "在书签中搜索...",
    ...
    favoritesSearchPlaceholder: "在收藏中搜索...",
    ...
    searchInhabitantsPlaceholder: "在居民中搜索...",
    ...
    "TOP INACTIVITYButton": "最不活跃",
    topinactivitySectionTitle: "最不活跃的居民",
    ...
    parliamentFilterRevocations: "罢免",
    parliamentFilterHistorical: "历史",
    parliamentFilterLeaders: "领导",
    parliamentFilterRules: "规则",
    parliamentGovernmentCard: "现任政府",
    parliamentSeatsGovernment: "政府",
    parliamentSeatsOpposition: "反对派",
    parliamentSeatsAbstention: "弃权",
    parliamentSeatsQuorum: "选举法定人数",
    parliamentSeatsPass: "通过门槛",
    parliamentSeatsByElection: "按选举",
    parliamentSeatsByHouses: "按 LARP 家族",
    parliamentSeatsSeats: "席",
    parliamentSeatsSeat: "席",
    parliamentSeatsLeader: "领袖",
    parliamentSeatsVotesFor: "投给",
    parliamentSeatsNoHouse: "无家族",
    ...
    parliamentRulesHemicycle: "半圆议席图为每位居民分配一席：政府席（获胜候选的投票者与领袖）、每个其他候选各一个反对席，以及弃权席。虚线标记显示选举法定人数（人口的 25%）和当前方法的通过门槛。“按 LARP 家族”以家族为同一批席位着色。",
    ...
    taskAssignedTo: "分配",
    taskAssignedChip: "已认领",
    taskUnassignedChip: "未认领",
    taskAssignees: "被分配者",
    ...
    taskSetStatus: "设置状态",
    eventDateLabel: "日期",
    eventRecurrenceLabel: "重复",
    eventRecurrenceUntil: "重复至",
    eventRecurrenceHint: "一次性活动请留空结束日期。",
    eventUpcomingDates: "接下来的日期",
    eventsTitle: "活动",
    eventsDescription: "发现和管理你网络中的活动。",
    eventSearchPlaceholder: "在活动中搜索...",
    eventPrice: "价格",
    eventStatus: "状态",
    ...
    generatePdf: "生成 PDF",
    sharePm: "通过私信分享",
    galleryImages: "图片（每张最大 50MB）",
    galleryPhotos: "图片",
    galleryAddPhoto: "添加图片",
    galleryRemovePhoto: "移除",
    galleryVideo: "视频（最大 50MB）",
    galleryAddVideo: "添加视频",
    galleryRemoveVideo: "移除视频",
    viewVotation: "查看投票",
    voteCastTitle: "投票",
    voteResults: "结果",
    eventTitleLabel: "标题",
    ...
    tagsFilterMine: "我的",
    tagsFilterRecent: "最新",
    tagsMineSectionTitle: "我的标签",
    tagsRecentSectionTitle: "最新标签",
    tagsFilterTop: "热门",
    tagsFilterCloud: "标签云",
    tagsNoItems: "没有可用的标签。",
    tagsSearchPlaceholder: "在标签中搜索...",
    ...
    transfersFilterMinePending: "待确认",
    transfersFilterMineConfirmed: "已签署",
    ...
    transfersSearchPlaceholder: "在转账中搜索...",
    ...
    blogMedia: "附件（最多 8 张图片和 1 个视频）",
    blogPublish: "发布",
    pollsTitle: "投票",
    dataTitle: "匹配",
    dataDescription: "探索并可视化你的网络中的匹配。",
    dataFilterAll: "全部",
    dataFilterMine: "我的",
    dataFilterRecent: "最近",
    dataFilterTop: "最高",
    dataKindInhabitants: "居民",
    dataKindJobs: "工作",
    dataKindProjects: "项目",
    dataKindEvents: "活动",
    dataKindTribes: "部落",
    ...
    dataKindReports: "报告",
    dataKindVotes: "投票",
    dataSearchPlaceholder: "在匹配中搜索...",
    dataCohesionTitle: "凝聚系数 (CC)",
    dataCcShort: "CC",
    dataCohesionHint: "网络已发布内容之间的平均相近度。",
    dataAffinity: "匹配度",
    dataCommonTerms: "关键词",
    dataReasonFollowing: "你正在支持这位居民",
    dataReasonTribe: "与你同属一个部落",
    dataReasonPinned: "与你置顶的内容相符",
    dataReasonCv: "与你简历中的技能相符",
    dataReasonContent: "与你发布的内容相关",
    dataReasonRelated: "与你的兴趣相关",
    dataReasonAlike: "由与你相似的居民发布",
    dataReasonSupportsYou: "支持你",
    dataReasonMutual: "相互支持",
    dataReasonRated: "网络评价很高",
    dataReasonNear: "在你附近",
    dataStatPeople: "简历",
    dataStatConnected: "已连接",
    dataStatSkills: "技能",
    dataBestMatch: "最佳匹配",
    dataStatIsolated: "孤立",
    dataStatEntities: "已比较的实体",
    dataStatTerms: "不同词条",
    dataStatPairs: "已连接的配对",
    dataMatchesTitle: "匹配",
    dataMatchesHint: "算法的个性化推荐。",
    dataTermsTitle: "关键词",
    dataTermsHint: "出现在最多内容中的词条。",
    dataConnections: "关联匹配",
    dataTopicTitle: "与此相关的一切：",
    dataTopicHint: "算法与该主题关联的内容",
    dataNoMatches: "没有可显示的交叉数据。",
    dataNoProfile: "发布内容或填写简历，让算法了解你的兴趣。",
    pollsDescription: "用于向网络提问并统计答案的模块。",
    pollFilterAll: "全部",
    pollFilterMine: "我的",
    pollFilterRecent: "最近",
    pollFilterTop: "热门",
    pollFilterVoted: "已投票",
    pollFilterOpen: "进行中",
    pollFilterClosed: "已结束",
    pollCreateButton: "创建投票",
    pollCreateTitle: "创建投票",
    pollEditTitle: "编辑投票",
    pollQuestion: "问题",
    ...
    pollNoVotesYet: "尚无投票",
    pollTie: "平局",
    pollOptionsPlaceholder: "广场\n公园\n酒吧",
    pollAnonymous: "匿名",
    pollAnonymousLabel: "匿名投票",
    pollMultiple: "多选",
    pollMultipleLabel: "允许多个答案",
    pollDeadline: "截止时间",
    pollTags: "标签",
    pollPublishButton: "发布投票",
    pollUpdateButton: "更新",
    pollCloseButton: "关闭",
    pollDeleteButton: "删除",
    pollVoteButton: "投票",
    ...
    pollStatusLabel: "状态",
    pollStatusOpen: "进行中",
    pollStatusClosed: "已结束",
    pollSearchPlaceholder: "在投票中搜索...",
    pollsNoItems: "未找到投票。",
    viewPoll: "查看投票",
    pollChatCreate: "创建投票",
    pollInChat: "投票",
    blogTitle: "博客",
    blogDescription: "用于发现和管理博客的模块。",
    blogFilterAll: "全部",
    blogFilterMine: "我的",
    blogFilterRecent: "最近",
    blogFilterFavorites: "收藏",
    blogFilterTop: "热门",
    blogCreateButton: "创建博客",
    blogSearchPlaceholder: "在博客中搜索...",
    blogComments: "评论",
    blogAllowComments: "允许评论",
    blogCommentsClosed: "作者已关闭此博客的评论。",
    blogNoItems: "未找到博客。",
    viewBlog: "查看博客",
    forumTitle: "论坛",
    ...
    courtsNoCases: '没有案件。',
    reportsTitle: "报告",
    reportsDescription: "管理并跟踪你的网络中的报告。",
    reportsSearchPlaceholder: "在报告中搜索...",
    reportsFilterAll: "全部",
    reportsFilterRecent: "最新",
    reportsFilterTop: "热门",
    ...
    tribeFilterMine: "我的",
    tribeFilterMembership: "成员",
    tribeFilterSubtribes: "子部落",
    tribeFilterTop: "热门",
    tribeFilterGallery: "图库",
    ...
    tribeTitleLabel: "标题",
    searchTribesPlaceholder:  "在部落中搜索...",
    ...
    subscriptionUnsubscribe: "取消订阅",
    subscriptionSubscribers: "订阅者",
    pmListLabel: "发送至",
    pmListNone: "— 无列表 —",
    pmListNoSubscribers: "没有订阅者",
    tribeLeaveButton: "离开",
    tribePublic: "公开",
    tribePrivate: "私密",
    tribeGenerateInvite: "单次邀请",
    tribeOpenInvitation: "公开邀请",
    tribeJoinOpen: "加入部落",
    tribeRemoveInvitation: "移除邀请",
    tribeCreatedAt: "创建于",
    tribeAuthor: "作者",
    tribeStrict: "严格",
    tribeOpen: "开放",
    ...
    agendaSearchPlaceholder: "在日程中搜索...",
    agendaFilterAll: "全部",
    ...
    pmCrypterCharsLabel: "字符",
    pmInvalidRecipients: "无效的 Oasis ID（应形如 @…=.ed25519）。",
    pmEncryptionLabel: "加密",
    private: "收件箱",
    privateDescription: "管理你的私信。",
    privateInbox: "收件箱",
    privateSent: "已发送",
    privateDelete: "删除",
    pmCreateButton: "写私信",
    ...
    blockchainViewBlockexplorer: "在 Blockexplorer 中查看",
    blockchainBack: '返回区块浏览器',
    blockchainContentDeleted: "此内容已被标记为墓碑",
    visitContent: "查看内容",
    favoriteAdd: "固定到收藏",
    pmContentTooltip: "发送私信",
    favoriteRemove: "从收藏移除",
    reportContent: "举报内容",
    banking: '银行',
    bankingTitle: '银行',
    bankingDescription: "ECOin 集体经济。",
    bankOverview: '概览',
    bankEpochs: '纪元',
    bankRules: '规则',
    pending: '待处理',
    ...
    bankYourFundsMonth: "资金合计",
    bankIndustryBalance: "工业产值",
    ...
    bankAddAddressLabel: "标签（可选）",
    bankAddAddressLabelPlaceholder: "Bob 的钱包、Alice 的商店…",
    bankAddAddressUserOptional: "Oasis ID（可选）",
    bankAddressUnnamed: "未命名地址",
    ...
    shopTagsPlaceholder: "输入标签，用逗号分隔",
    ...
    bankPubsSupply: "PUB 资金池的 ECOin 供应量",
    bankHoldingSupply: "UBI 之外的 ECOin 供应量",
    bankEcoinHours: "ECOin 时间等价 (1 ECO)",
    bankHoursOfWork: '小时',
    bankUnitMs: "毫秒",
    bankUnitSeconds: "秒",
    bankUnitMinutes: "分钟",
    ...
    bankInflation: "ECOin 通胀率 (年)",
    bankInflationMonthly: "ECOin 通胀率 (月)",
    ...
    aiPromptUsed: "提示语",
    aiClearHistory: "清除历史",
    aiServerError: "我无法正常回答，请再试一次。",
    aiStatusLoading: "42 正在加载模型，请稍后再问。",
    aiThinking: "思考中",
    aiWaiting: "等待中",
    aiStatusMissingModel: "AI 模型未安装：缺少 src/AI/oasis-42-1-chat.Q4_K_M.gguf。",
    aiExportFineTuning: "导出微调数据",
    aiFactsTitle: "来自你网络的数据",
    ...
    marketSearchPlaceholder: "在市场中搜索...",
    ...
    housingSearchPlaceholder: "在住所中搜索...",
    ...
    jobsTagsLabel: "标签",
    noJobsMatch: "没有匹配的工作。",
    industrySearchPlaceholder: "在工业中搜索...",
    ...
    pmBotJobs: "JobsBot",
    jobsBotMatchTitle: "有一份工作与你的简历匹配",
    jobsBotMatchIntro: "有一份工作与你的简历匹配。",
    jobsBotMatchJob: "工作",
    jobsBotMatchHint: "你收到这条消息是因为你的简历由 AI 管理。可在简历中关闭。",
    cvAiManaged: "AI 管理",
    switchOn: "开启",
    switchOff: "关闭",
    cvAiManagedHint: "开启后，当有工作与你的简历匹配时，JobsBot 会通过私信通知你。",
    cvMatchThreshold: "达到此匹配度时通知我",
    ...
    projectSearchPlaceholder: "在项目中搜索...",
    ...
    modulesFediverseLabel: "多元宇宙",
    modulesBlogsLabel: "博客",
    modulesBlogsDescription: "用于发现和管理博客的模块。",
    modulesPollsLabel: "投票",
    modulesPollsDescription: "用于向网络提问并统计答案的模块。",
    modulesFediverseDescription: "管理你的其他多元宇宙账户，包括发送和接收内容。",
    modulesFeedLabel: "动态",
    ...
    modulesBankingDescription: "用于管理共同金库的模块：ECOIN 价值、税收与全民基本收入。",
    ...
    errorNoAllocation: "未找到与此申领对应的分配。",
    errorInvalidClaim: "此分配无法申领。",
    visibilityLabel: "可见性",
    visibilityPublic: "公开",
    visibilityHidden: "隐藏",
    ...
    aiNavPlaceholder: "描述你需要什么...",
    aiNavDisabled: "AI 导航已停用。",
    aiNavResultsTitle: "AINav 建议",
    aiNavQueryLabel: "查询",
    ...
    workflowsTitle: "工作模式",
    workflowsDescription: "工作模式会设定主题与启用的模块。",
    workflowsSet: "应用工作模式",
    workflow_default: "默认",
    workflow_jobs: "工作",
    workflow_ruling: "治理",
    workflow_politics: "政治",
    workflow_social: "社交",
    workflow_business: "商务",
    workflow_night: "夜间",
    workflow_kids: "儿童",
    workflow_mobile: "移动端",
    ...
    emergenciesTitle: "紧急情况",
    modulesEmergenciesLabel: "紧急情况",
    modulesEmergenciesDescription: "用于在网络中发布、确认和跟进紧急情况的模块。",
    emergenciesDescription: "用于在网络中发布、确认和跟进紧急情况的模块。",
    emergencyCreate: "创建紧急情况",
    emergencyUpdate: "更新",
    emergencyDelete: "删除",
    emergencyTitleLabel: "标题",
    emergencyTitlePlaceholder: "发生了什么？",
    emergencyTextLabel: "详情",
    emergencyTextPlaceholder: "地点、开始时间、应对措施...",
    emergencyCategoryLabel: "类别",
    emergencyCategoryWeather: "天气",
    emergencyCategoryInfrastructure: "基础设施",
    emergencyCategoryHealth: "健康",
    emergencyCategorySecurity: "安全",
    emergencyCategoryLost: "失物招领",
    emergencyCategoryNeighborhood: "社区",
    emergencyExpiresLabel: "有效期",
    emergencyExpires1d: "1 天",
    emergencyExpires3d: "3 天",
    emergencyExpires7d: "1 周",
    emergencyExpires30d: "1 个月",
    emergencyExpiresNone: "未定",
    emergencyExpiresKeep: "保留当前日期",
    emergencyTagsLabel: "标签",
    emergencyTagsPlaceholder: "输入标签，用逗号分隔",
    emergencyFilterAll: "全部",
    emergencyFilterMine: "我的",
    emergencyFilterRecent: "最近",
    emergencySeverityUnverified: "未核实",
    emergencySeverityLow: "低",
    emergencySeverityMedium: "中",
    emergencySeverityHigh: "高",
    emergencyStatusActive: "进行中",
    emergencyStatusResolved: "已解决",
    emergencyStatusExpired: "已过期",
    emergencyConfirmations: "确认数",
    emergencyConfirmButton: "确认",
    emergencyConfirmed: "你已确认此紧急情况",
    emergencyResolveButton: "标记为已解决",
    emergencyReopenButton: "重新开放",
    emergencyGenerateReport: "生成报告",
    emergencyUpdateEdited: "已编辑",
    emergencyLastUpdate: "最新更新",
    emergencyUpdatesTitle: "最新更新：",
    emergencyNoUpdates: "暂无更新。",
    emergencyAddUpdate: "发布更新",
    emergencyUpdatePlaceholder: "有什么变化？",
    emergencyNoItems: "未找到紧急情况。",
    emergencyExpiresAt: "到期",
    emergencyBannerLabel: "进行中的紧急情况",
    emergencyCreateSectionTitle: "创建紧急情况",
    emergencyUpdateSectionTitle: "更新紧急情况",
    emergencySearchPlaceholder: "在紧急情况中搜索...",
    typeEmergency: "紧急情况",
    typeEmergencyConfirm: "紧急情况确认",
    typeEmergencyUpdate: "紧急情况更新",
    statsEmergency: "紧急情况",
    statsEmergencyConfirm: "紧急情况确认",
    statsEmergencyUpdate: "紧急情况更新",
    pmBotEmergencies: "EmergencyBot",
    emergencyBotUpdatedTitle: "你关注的紧急情况有更新。",
    emergencyBotResolvedTitle: "你关注的紧急情况已解决。",
    dataKindEmergencies: "紧急情况",
    mailingTitle: "邮件列表",
    modulesMailingLabel: "邮件列表",
    modulesMailingDescription: "在你的网络中发现和管理邮件列表。",
    mailingDescription: "在你的网络中发现和管理邮件列表。",
    mailingCreate: "创建邮件列表",
    mailingUpdate: "更新",
    mailingDelete: "删除",
    mailingArchive: "归档",
    mailingActivate: "激活",
    mailingCreateSectionTitle: "创建邮件列表",
    mailingUpdateSectionTitle: "更新邮件列表",
    mailingTitleLabel: "标题",
    mailingTitlePlaceholder: "邮件列表名称",
    mailingDescriptionLabel: "描述",
    mailingDescriptionPlaceholder: "这个列表是关于什么的？",
    mailingTypeLabel: "邮件列表类型",
    mailingTypeOpen: "开放",
    mailingTypeClosed: "封闭",
    mailingStatusLabel: "状态",
    mailingStatusActive: "活跃",
    mailingStatusArchived: "已归档",
    mailingMembersLabel: "邀请居民",
    mailingMembersPlaceholder: "@id1.ed25519, @id2.ed25519, ...",
    mailingSubscribers: "订阅者",
    mailingTagsLabel: "标签",
    mailingTagsPlaceholder: "输入标签，用逗号分隔",
    mailingFilterAll: "全部",
    mailingFilterMine: "我的",
    mailingFilterSubscribed: "已订阅",
    mailingFilterRecent: "最近",
    mailingHistoryDate: "日期",
    mailingHistoryThreads: "话题",
    mailingHistoryInhabitants: "居民",
    mailingHistorySearchPlaceholder: "在历史中搜索...",
    mailingNoMessages: "还没有消息。",
    mailingNoItems: "未找到邮件列表。",
    mailingSearchPlaceholder: "在邮件列表中搜索...",
    mailingWriteButton: "写消息",
    mailingWriteTitle: "写信给列表",
    mailingReplyTitle: "回复列表",
    mailingSend: "发送",
    mailingTextPlaceholder: "你的消息会送达列表中的每个参与者。",
    mailingParticipants: "参与者",
    inboxFilterMailing: "邮件列表",
    mailingReplyPlaceholder: "回复列表...",
    mailingReplyToList: "回复列表",
    typeMailingList: "邮件列表",
    statsMailingList: "邮件列表",
    mailingListLabel: "邮件列表",
    logisticsTitle: "物流",
    modulesLogisticsLabel: "物流",
    modulesLogisticsDescription: "在你的网络中发现和管理物流计划。",
    logisticsDescription: "在你的网络中发现和管理物流计划。",
    logisticsCreate: "创建路线",
    logisticsUpdate: "更新",
    logisticsDelete: "删除",
    logisticsClose: "关闭",
    logisticsReopen: "重新开放",
    logisticsCreateSectionTitle: "创建路线",
    logisticsUpdateSectionTitle: "更新路线",
    logisticsTitleLabel: "标题",
    logisticsTitlePlaceholder: "去市场的顺风车，有货车...",
    logisticsKindLabel: "物流类型",
    logisticsKindTrip: "出行",
    logisticsKindShipment: "运送",
    logisticsKindTrips: "出行",
    logisticsKindShipments: "运送",
    logisticsModeLabel: "模式",
    logisticsModeOffer: "提供",
    logisticsModeRequest: "寻求",
    logisticsModeOffers: "提供",
    logisticsModeRequests: "请求",
    logisticsDescriptionLabel: "描述",
    logisticsDescriptionPlaceholder: "集合地点、携带物品、条件...",
    logisticsOriginLabel: "起点",
    logisticsOriginPlaceholder: "从哪里出发",
    logisticsDestinationLabel: "终点",
    logisticsDestinationPlaceholder: "到哪里结束",
    logisticsDateLabel: "日期和时间",
    logisticsRecurrenceLabel: "重复",
    logisticsFrequencyLabel: "频率",
    logisticsRecurrenceNone: "单次",
    logisticsRecurrenceDaily: "每天",
    logisticsRecurrenceWeekly: "每周",
    logisticsRecurrenceMonthly: "每月",
    logisticsSeatsLabel: "座位",
    logisticsSizeLabel: "尺寸",
    logisticsSizePlaceholder: "例如 2m x 1m",
    logisticsWeightLabel: "重量",
    logisticsWeightPlaceholder: "例如 40kg",
    logisticsPriceFree: "免费",
    logisticsPriceEco: "ECO",
    logisticsPriceTime: "时间",
    logisticsPriceLabel: "价格",
    logisticsHours: "小时",
    logisticsOrderRefLabel: "订单链接",
    logisticsOrderRefPlaceholder: "待送达订单的 /shops/... 或 /market/...",
    logisticsOrderLink: "关联订单",
    logisticsTagsLabel: "标签",
    logisticsTagsPlaceholder: "输入标签，用逗号分隔",
    logisticsFilterAll: "全部",
    logisticsFilterMine: "我的",
    logisticsFilterBooked: "已预订",
    logisticsFilterRecent: "最近",
    logisticsFilterHistory: "历史",
    logisticsFilterTop: "热门",
    logisticsStatusOpen: "开放",
    logisticsStatusUpcoming: "即将",
    logisticsStatusPast: "已过",
    logisticsStatusClosed: "已关闭",
    logisticsZoneLabel: "区域",
    logisticsSearchPlaceholder: "在物流中搜索...",
    logisticsNoItems: "未找到路线。",
    logisticsBookingPending: "待处理",
    logisticsBookingConfirmed: "已确认",
    logisticsBookingRejected: "已拒绝",
    logisticsBookingCancelled: "已取消",
    logisticsBookingDelivered: "已送达",
    logisticsConfirm: "确认",
    logisticsReject: "拒绝",
    logisticsDeliver: "送达",
    logisticsReceiptLabel: "收据",
    logisticsReceiptPlaceholder: "送达备注（可选）",
    logisticsCancelBooking: "取消预订",
    logisticsBookTitle: "预订此路线",
    logisticsNotesLabel: "备注",
    logisticsNotesPlaceholder: "负责人需要了解的信息",
    logisticsBook: "预订",
    logisticsBookingsTitle: "预订",
    logisticsMyBookingTitle: "你的预订",
    logisticsRatingsTitle: "评价",
    logisticsNoRatings: "还没有评价。",
    logisticsRatingsWhenClosed: "路线关闭后开放评价。",
    logisticsScoreLabel: "评分",
    logisticsRatingPlaceholder: "进行得如何？",
    logisticsRate: "评价",
    typeLogisticsRoute: "路线",
    typeLogisticsRating: "路线评价",
    statsLogisticsRoute: "路线",
    statsLogisticsRating: "路线评价",
    logisticsRouteLabel: "路线",
    podcastsTitle: "播客",
    modulesPodcastsLabel: "播客",
    modulesPodcastsDescription: "用于发布播客频道的模块。",
    podcastsDescription: "用于发布播客频道的模块。",
    podcastCreate: "创建播客",
    podcastUpdate: "更新",
    podcastDelete: "删除",
    podcastCreateSectionTitle: "创建播客",
    podcastUpdateSectionTitle: "更新播客",
    podcastTitleLabel: "标题",
    podcastTitlePlaceholder: "频道名称",
    podcastDescriptionLabel: "描述",
    podcastDescriptionPlaceholder: "这个播客是关于什么的？",
    podcastCategoryLabel: "分类",
    podcastCategoryNews: "新闻",
    podcastCategoryMusic: "音乐",
    podcastCategoryTalk: "谈话",
    podcastCategoryEducation: "教育",
    podcastCategoryTech: "科技",
    podcastCategoryCulture: "文化",
    podcastCategoryCommunity: "社区",
    podcastCategoryOasis: "OASIS",
    podcastCategoryOther: "其他",
    podcastTagsLabel: "标签",
    podcastTagsPlaceholder: "输入标签，用逗号分隔",
    podcastFilterAll: "全部",
    podcastFilterMine: "我的",
    podcastFilterRecent: "最近",
    podcastFilterTop: "热门",
    podcastFilterViewers: "听众",
    podcastSearchPlaceholder: "在播客中搜索...",
    podcastNoItems: "未找到播客。",
    podcastEpisodesLabel: "剧集",
    podcastPlaysLabel: "观看次数",
    podcastLastEpisode: "最新剧集",
    podcastEpisodesTitle: "剧集",
    podcastNoEpisodes: "还没有剧集。",
    podcastEpisodeAdd: "添加剧集",
    podcastEpisodeCreateTitle: "发布剧集",
    podcastEpisodeUpdateTitle: "更新剧集",
    podcastEpisodeTitleLabel: "剧集标题",
    podcastEpisodeTitlePlaceholder: "剧集标题",
    podcastEpisodeDescriptionLabel: "节目笔记",
    podcastEpisodeDescriptionPlaceholder: "本集内容、链接、致谢...",
    podcastEpisodePublish: "发布",
    podcastPlayed: "已播放",
    podcastMarkPlayed: "标记为已播放",
    typePodcast: "播客",
    typePodcastEpisode: "剧集",
    typePodcastOpinion: "剧集评价",
    typePodcastPlay: "剧集播放",
    statsPodcast: "播客",
    statsPodcastEpisode: "剧集",
    statsPodcastPlay: "剧集播放",
    pmBotPodcasts: "PodcastBot",
    pmBotBlogs: "BlogsBot",
    blogBotNewTitle: "你关注的博客有新文章。",
    podcastBotEpisodeTitle: "你关注的播客有新剧集。",
    podcastLabel: "播客",
    podcastEpisodeLabel: "剧集",
    campaignsTitle: "倡议",
    modulesCampaignsLabel: "倡议",
    modulesCampaignsDescription: "在你的网络中发现和管理倡议。",
    campaignsDescription: "在你的网络中发现和管理倡议。",
    campaignCreate: "发起倡议",
    campaignUpdate: "更新",
    campaignDelete: "删除",
    campaignClose: "关闭",
    campaignReopen: "重新开放",
    campaignCreateSectionTitle: "发起倡议",
    campaignUpdateSectionTitle: "更新倡议",
    campaignTitleLabel: "标题",
    campaignTitlePlaceholder: "你想达成什么？",
    campaignTextLabel: "正文",
    campaignTextPlaceholder: "说明诉求、由谁决定以及你要求什么...",
    campaignCategoryLabel: "分类",
    campaignCategoryEnvironment: "环境",
    campaignCategoryRights: "权利",
    campaignCategoryHealth: "健康",
    campaignCategoryEducation: "教育",
    campaignCategoryInfrastructure: "基础设施",
    campaignCategoryCulture: "文化",
    campaignCategoryEconomy: "经济",
    campaignCategoryOther: "其他",
    campaignGoalLabel: "签名目标",
    campaignDeadlineLabel: "截止日期",
    campaignTagsLabel: "标签",
    campaignTagsPlaceholder: "输入标签，用逗号分隔",
    campaignFilterAll: "全部",
    campaignFilterMine: "我的",
    campaignFilterSigned: "已签名",
    campaignFilterRecent: "最近",
    campaignFilterTop: "热门",
    campaignStatusOpen: "进行中",
    campaignStatusAchieved: "已达成",
    campaignStatusUnachieved: "未达成",
    campaignStatusClosed: "已关闭",
    campaignSearchPlaceholder: "在倡议中搜索...",
    campaignNoItems: "未找到倡议。",
    campaignSignaturesLabel: "签名",
    campaignSignaturesTitle: "支持者",
    campaignNoSignatures: "还没有签名。",
    campaignSignTitle: "签署此倡议",
    campaignSignPlaceholder: "你为什么支持？（可选）",
    campaignSign: "签名",
    campaignSigned: "你已签名！",
    campaignNotSigned: "还缺你的签名",
    campaignElevate: "提交议会",
    campaignElevated: "已提交议会",
    campaignUpdatesTitle: "进展",
    campaignNoUpdates: "还没有进展。",
    campaignUpdatePlaceholder: "发生了什么？",
    campaignAddUpdate: "发布进展",
    campaignQrAlt: "签署此倡议的二维码",
    campaignQrCaption: "扫码签名",
    typeCampaign: "倡议",
    typeCampaignSignature: "签名",
    typeCampaignUpdate: "倡议进展",
    statsCampaign: "倡议",
    statsCampaignSignature: "倡议签名",
    statsCampaignUpdate: "倡议进展",
    pmBotCampaigns: "CampaignBot",
    campaignBotUpdatedTitle: "你关注的倡议有新进展。",
    campaignBotAchievedTitle: "你关注的倡议已达成目标。",
    campaignBotRaisedTitle: "你签署的一个活动已提交议会。",
    pmBotLogistics: "LogisticsBot",
    logisticsBotUpdatedTitle: "你预订的路线已更改。",
    logisticsBotClosedTitle: "你预订的路线已关闭。",
    logisticsBotBookedTitle: "有人预订了你的路线。",
    logisticsBotCancelledTitle: "你路线上的一个预订已取消。",
    logisticsBotConfirmedTitle: "你的预订已确认：包裹已在途中。",
    logisticsBotRejectedTitle: "你的预订已被拒绝。",
    logisticsBotDeliveredTitle: "你的包裹已送达。",
    campaignLabel: "倡议",
    campaignGenerateReport: "生成报告",
    logisticsGenerateReport: "生成报告",
    mailingGenerateReport: "生成报告",
    campaignUpdateEdited: "已编辑",
    mailingMessagesLabel: "消息",
    logisticsBookingsLabel: "预订",
    backupTitle: "备份",
    modulesBackupLabel: "备份",
    modulesBackupDescription: "用于导出和导入密钥并创建加密备份的模块。",
    backupDescription: "用于导出和导入密钥并创建加密备份的模块。",
    backupKitWarning: "任何阅读此页面的人都可以冒充你。切勿分享！",
    backupTypeRecovery: "恢复",
    backupTypeKeys: "导出密钥",
    backupTypeFull: "完整备份",
    backupTypeRestore: "恢复备份",
    backupTypeInstant: "即时",
    backupInstantDescription: "一个普通的 .zip，包含你全部的日志与文件，不含你的私钥，也没有密码。很快，但拿到文件的人能读到里面的一切。",
    backupInstantWarning: "这份副本没有加密，请妥善保管。",
    backupKitPageDescription: "恢复工具包只能在本设备上打开。",
    backupKitId: "Oasis ID",
    backupKitDate: "生成时间",
    backupKitQrAlt: "你的私钥二维码",
    backupKitStep1: "打印或手抄，并离线存放在安全的地方。",
    backupKitStep2: "恢复时，在新设备上安装 Oasis，并在 备份 › 密钥 中导入此私钥。",
    backupKitStep3: "如果此页面泄露，请立即销毁。",
    backupKitPdfButton: "生成 PDF",
    backupScopeLabel: "范围",
    backupScopeAll: "全部",
    backupScopeMine: "仅我的内容",
    backupSinceLabel: "起始日期",
    backupEstimateTitle: "估算",
    backupFileInfo: "加密副本将下载到你的设备（文件名：oasis-backup-日期.oasisbk）",
    backupExportButton: "下载备份",
    backupRestorePassword: "输入创建备份时使用的密码",
    backupRestoreButton: "恢复备份",
    backupRestoredLine: "备份已恢复。",
    backupRestoredMessages: "新增消息",
    backupRestoredSkipped: "已存在",
    backupRestoredBlobs: "新增文件",
    backupRestoredState: "已恢复设置",
    backupRestoredFailed: "失败",
    backupRestoredForked: "分叉",
    backupRestoreRunning: "正在恢复备份。此页面会自动刷新；期间你可以继续使用 Oasis。",
    backupRestoreElapsed: "已用时",
    backupRestoreFailedLine: "无法恢复备份。",
    backupRestoreForkMine: "此设备已用你的身份发布了备份中没有的消息，因此无法在其之上应用备份。请在全新安装中导入密钥后立即恢复，且不要先做其他操作。",
    verificationTitle: "校验",
    verificationDescription: "检查你的动态链、检测分叉，并查看孤立或缺失的文件。",
    verificationRun: "运行校验",
    verificationTotalMessages: "日志中的消息",
    verificationFeed: "你的动态",
    verificationMessages: "条消息",
    verificationLastSequence: "最后序号",
    verificationGaps: "缺口",
    verificationBrokenLinks: "断链",
    verificationBadHashes: "错误哈希",
    verificationBadSignatures: "错误签名",
    verificationDuplicates: "重复序号",
    verificationForks: "分叉",
    verificationBlobs: "文件",
    verificationBlobsPresent: "存在",
    verificationBlobsReferenced: "被引用",
    verificationBlobsOrphan: "孤立",
    verificationBlobsMissing: "缺失",
    verificationBlobsMissingOwn: "此设备上缺失的你自己的文件",
    verificationBlobsMissingOthers: "其他居民的文件尚未下载",
    verificationBlobsUnavailable: "无法在此设备上列出文件。",
    wikiTitle: "维基",
    modulesWikiLabel: "维基",
    modulesWikiDescription: "用于发现和管理维基的模块。",
    wikiDescription: "用于发现和管理维基的模块。",
    wikiCreate: "创建维基",
    wikiUpdate: "更新",
    wikiDelete: "删除",
    wikiEdit: "编辑",
    wikiTitleLabel: "标题",
    wikiTitlePlaceholder: "维基标题...",
    wikiBodyLabel: "内容",
    wikiBodyPlaceholder: "用 [[维基标题]] 或 [[维基标题|自定义文字]] 链接其他维基。\n\n用 @id 提及居民。\n\n用 #oasis 添加标签。\n\n粘贴链接，如 https://solarnethub.com\n\n空行开始新段落；单个换行会被保留。\n\n附加任何受支持的媒体，它会嵌入到这里。",
    formatBarLabel: "格式",
    wikiStatusLabel: "维基类型",
    wikiStatusOpen: "开放",
    wikiStatusClosed: "关闭",
    wikiTagsLabel: "标签",
    wikiTagsPlaceholder: "输入标签，用逗号分隔",
    wikiSummaryLabel: "修改摘要",
    wikiSummaryPlaceholder: "改了什么？",
    wikiFilterAll: "全部",
    wikiFilterMine: "我的",
    wikiFilterRecent: "最近",
    wikiFilterLinked: "已关联",
    wikiChanges: "最近更改",
    wikiNoPages: "未找到维基。",
    wikiNoChanges: "暂无更改。",
    wikiHistory: "历史",
    ...
    wikiDiff: "更改",
    wikiViewVersion: "查看",
    wikiLinkedPages: "关联页面",
    wikiNoLinkedPages: "此页面尚未与其他页面互链。",
    wikiMissingLink: "页面尚不存在",
    wikiDuplicateTitle: "已存在使用该标题的页面。请修改标题以创建另一个页面。",
    wikiCreateSectionTitle: "创建维基",
    wikiUpdateSectionTitle: "更新维基",
    wikiSearchPlaceholder: "在维基中搜索...",
    wikiCurrentVersion: "当前版本",
    wikiViewingVersion: "你正在查看旧版本",
    wikiBackToPage: "返回页面",
    wikiLinkedChip: "已关联",
    wikiRestoredSummary: "已恢复的版本",
    wikiExportPdf: "生成页面",
    wikiPreview: "预览",
    tribeSectionWiki: "维基",
    tribeWikiCreate: "创建维基",
    tribeWikiEmpty: "还没有维基。",
    typeWiki: "维基",
    padsTitle: "协作板",
    padTitle: "协作板",
    modulesPadsLabel: "协作板",
    modulesPadsDescription: "用于管理协作文本编辑器的模块。",
    padCreate: "创建协作板",
    padUpdate: "更新",
    padDelete: "删除",
    padTitleLabel: "标题",
    ...
    padSearchPlaceholder: "在协作板中搜索...",

    modulesChatsLabel: "聊天",
    modulesChatsDescription: "用于发现和管理聊天的模块。",
    typeChat: "聊天",
    ...
    chatMessagesLabel: "消息",
    chatThreadsLabel: "话题",
    chatCreatedAt: "创建时间",
    chatSearchPlaceholder: "在聊天中搜索...",
    chatStatusOpen: "开放",
    ...
    activitySearchPlaceholder: "在活动记录中搜索...",
    trendingSearchPlaceholder: "在热门中搜索...",
    opinionsSearchPlaceholder: "在观点中搜索...",
    votesSearchPlaceholder: "在投票中搜索...",
    gamesSearchPlaceholder: "在游戏中搜索...",
    schoolTitle: "学校",
    pmBotWiki: "WikiBot",
    wikiBotEditedTitle: "你关注的维基页面已被编辑。",
    wikiBotRestoredTitle: "你关注的维基页面已恢复到较早的版本。",
    pmBotSchool: "EducaBot",
    schoolBotEnrolledTitle: "一名新学生报名了您的课程。",
    schoolBotInvitedTitle: "您已被邀请加入课程。",
    schoolBotAdmittedTitle: "您已被课程录取。",
    schoolBotCertificateTitle: "您已获得证书。",
    schoolBotPassedTitle: "一名学生通过了您的课程。",
    schoolBotLessonTitle: "已发布新课时。",
    invitesSchoolTitle: "学校",
    invitesSchoolHint: "输入学校代码以加入私密课程。",
    invitesSchoolCodePlaceholder: "输入课程邀请码",
    invitesSchoolJoinButton: "加入课程",
    schoolEnrollLabel: "加入课程",
    schoolExamRetryLater: "24 小时后可重试。",
    schoolApproved: "已通过",
    schoolExamPassMark: "及格分(0-10)",
    schoolExamPassed: "通过",
    schoolExamPending: "待完成",
    schoolExamFailed: "未通过",
    schoolExamAddQuestion: "添加问题",
    schoolExamCreateQuestion: "创建问题",
    schoolExamOption: "选项",
    schoolExamCorrect: "正确选项",
    schoolExamPoints: "分数",
    schoolMaterialTextPlaceholder: "本课时的备注...",
    schoolMaterials: "资料",
    schoolAddMaterial: "添加资料",
    schoolNoMaterials: "暂无资料。",
    bankYourSchoolBalance: "您的学校收入",
    schoolProgress: "进度",
    schoolProgressMark: "标记为已完成",
    schoolProgressDone: "已完成",
    schoolExams: "考试",
    schoolExamCreate: "创建考试",
    schoolExamTitlePlaceholder: "考试标题",
    schoolExamHelp: "每行一个问题:问题?; 选项 ; 正确选项* ; 选项",
    schoolExamQuestionsPlaceholder: "SSB 是什么?; 一个数据库 ; 一个 P2P 协议* ; 一个浏览器",
    schoolExamSubmit: "提交答案",
    schoolExamScore: "您的得分",
    schoolNoScoresYet: "暂无成绩。",
    schoolLessonUnit: "单元/阶段",
    schoolLessonUnitPlaceholder: "例如:阶段 1",
    schoolLessonOrder: "顺序",
    profileClearnetSchoolLabel: "学校",
    schoolStartDate: "开始日期",
    schoolSessionDate: "课次日期",
    schoolCourseChat: "课程聊天",
    agendaFilterSchool: "学校",
    agendaFilterCampaigns: "活动",
    agendaFilterLogistics: "物流",
    schoolCourseType: "课程类型",
    schoolTypeOpen: "OPEN",
    schoolTypePaid: "PAID",
    schoolTypeInvite: "INVITE-ONLY",
    schoolLessonLocked: "课时已加密——请向教师索取课程密钥。",
    schoolGrantAccess: "发送课程密钥",
    schoolKeySent: "密钥已发送",
    schoolOngoing: "进行中",
    schoolFilterApplied: "已报名",
    schoolFilterOpen: "开放",
    schoolFilterFavorites: "收藏",
    schoolPendingPayment: "待付款",
    schoolPendingStudents: "待确认报名",
    schoolViewBill: "查看账单",
    schoolPaymentNote: "报名会生成一张 ECO 账单(转账)。转账签署后,您的报名即被确认。",
    schoolCloseCourse: "关闭课程",
    schoolReopenCourse: "重新开放课程",
    schoolDescription: "在您的网络中教授和学习课程。",
    schoolFilterAll: "全部",
    schoolFilterMine: "我的",
    schoolFilterTop: "热门",
    schoolFilterRecent: "最新",
    schoolCreateButton: "创建课程",
    schoolCreateSectionTitle: "创建课程",
    schoolUpdateSectionTitle: "更新课程",
    schoolCourseTitlePlaceholder: "课程名称",
    schoolCourseDescriptionPlaceholder: "你将在这门课程中教什么?",
    schoolCourseImage: "课程图片(最大:50MB)",
    schoolTags: "标签",
    schoolTagsPlaceholder: "输入标签，用逗号分隔",
    schoolPrice: "价格(ECO)",
    schoolVisibility: "可见性",
    schoolVisibilityPublic: "公开",
    schoolVisibilityInvite: "邀请制",
    schoolStatus: "状态",
    schoolClosed: "关闭",
    schoolFree: "免费",
    schoolCreate: "创建课程",
    schoolUpdate: "更新课程",
    schoolSearchPlaceholder: "在学校中搜索...",
    schoolSortTitle: "标题",
    schoolNoCourses: "未找到课程。",
    schoolStudents: "学生",
    schoolTeacher: "教师",
    schoolCreatedAt: "创建时间",
    schoolLessons: "课时",
    schoolNoLessons: "暂无课时。",
    schoolEnrollToSee: "报名后即可查看本课程的课时。",
    schoolEnrollButton: "报名",
    schoolUnenrollButton: "退出课程",
    schoolInviteRequired: "本课程为邀请制。",
    schoolTeacherPanel: "教师面板",
    schoolStudentPanel: "学生面板",
    schoolAddLesson: "创建课时",
    schoolLessonTitlePlaceholder: "课时标题",
    schoolLessonTextPlaceholder: "描述本课时涵盖的内容...",
    schoolInviteStudents: "邀请学生",
    schoolInvitePlaceholder: "@id1, @id2...",
    schoolInviteButton: "邀请",
    schoolInvited: "已邀请",
    schoolIssueCertificate: "创建证书",
    schoolCertified: "已认证",
    ...
    schoolEditButton: "编辑",
    schoolDeleteButton: "删除",
    typeSchool: "学校",
    schoolCourseLabel: "课程",
    emergencyLabel: "紧急情况",
    wikiPageLabel: "维基",
    statsSchoolCourse: "课程",
    statsSchoolLesson: "课时",
    statsSchoolEnroll: "报名",
    statsSchoolCertificate: "学校证书",
    modulesSchoolLabel: "学校",
    modulesSchoolDescription: "知识交流模块。",
    welcomeStepUxTitle: "选择你的界面",
    welcomeStepUxText: "决定 Oasis 的外观。之后可在设置中更改。",
    welcomeStepUxAction: "使用此视图",
    chatRateLimitTitle: "消息过多",
    chatRateLimitMessage: "你已达到该房间每小时的消息上限，请稍后再试。",
    chatMessagePlaceholder: "输入您的消息...",
    chatNoMessages: "暂无消息。",
    chatTitlePlaceholder: "聊天标题",
    chatDescriptionPlaceholder: "聊天描述",
    chatTagsPlaceholder: "输入标签，用逗号分隔",
    ...
    calendarTagsPlaceholder: "输入标签，用逗号分隔",
  ...
  calendarDeleteNote: "Delete",
    ...
    calendarSearchPlaceholder: "在日历中搜索...",
    ...
    torrentTagsLabel: "标签",
    torrentTagsPlaceholder: "输入标签，用逗号分隔",
    torrentSizeLabel: "大小",
    torrentDownloadButton: "下载！",
    torrentDetailsButton: "详情",
    torrentNoFile: "没有种子文件",
    noTorrents: "未找到种子。",
    torrentSearchPlaceholder: "在种子中搜索...",
    ...
    favoritesFilterEvents: "活动",
    favoritesFilterForum: "论坛",
    favoritesFilterHousing: "住房",
    favoritesFilterJobs: "工作",
    favoritesFilterProjects: "项目",
    favoritesFilterReports: "报告",
    favoritesFilterTasks: "任务",
    favoritesFilterTransfers: "转账",
    favoritesFilterVotes: "投票",
    ...
    tribeGovNoProposals: "暂无任何提案",
    tribeGovNoLaws: "暂无任何法律",
    tribeGovNoRevocations: "暂无任何撤销",
    tribeGovNoHistorical: "暂无任何记录",
    logsTitle: "日志",
    ...
    larpNoHousesMatch: "没有匹配的家族。",
    larpSearchPlaceholder: "在L.A.R.P.中搜索...",
    larpAllHouses: "家族：",
    larpFilterRuling: "执政",
    larpFilterHouses: "家族",
    larpFilterRules: "FAQ",
    ...
    larpRulesWallText: "每个家族都有一面墙，供其成员书写。家族墙对外不公开，但执政家族的墙和 ACADEMIA 的墙人人可读。",
    ...
    indexingMessage: "Oasis 正在同步庞大的居民网络，请稍候！",
    indexingRefreshNote: "本页面每 10 秒刷新一次。",
    indexingTitle: "正在同步",
    ...
    larpRulesTestEntryText: "在 WILL 测试中，每个选项会为一个或多个家族加权；提交后系统统计得分，并自动把你录入得分最高的家族。",
    ...
    larpAcademiaJoinTitle: "L.A.R.P. 家族",
    ...
    modulesLarpDescription: "用于实景角色扮演层的模块。",
