...
module.exports = {
  zh: {
    ...
    bankChartUbiMonthlyTitle: "每月发放的 UBI",
    bankChartUbiAmount: "已支付 ECO",
    bankChartUbiCount: "发放次数",
    bankChartPoolTitle: "UBI PUB 资金池变化",
    bankChartPool: "资金池（ECO）",
    bankChartKarmaTitle: "您的业力变化",
    bankChartKarma: "业力",
