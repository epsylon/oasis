...
module.exports = {
  zh: {
    ...
    mentionsSearchPlaceholder: "搜索提及...",
    privateReminders: "提醒",
    ...
    telegramSettingsHelp: "设置你的访问令牌。它将用于在 Oasis 中管理你的 Telegram 账户。",
    ...
    favoritesSearchPlaceholder: "搜索收藏...",
